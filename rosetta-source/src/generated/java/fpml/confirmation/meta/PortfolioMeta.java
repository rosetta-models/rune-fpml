...
import fpml.confirmation.validation.PortfolioTypeFormatValidator;
import fpml.confirmation.validation.PortfolioValidator;
import fpml.confirmation.validation.exists.PortfolioOnlyExistsValidator;
...
public class PortfolioMeta implements RosettaMetaData<Portfolio> {
	...
	public List<Validator<? super Portfolio>> dataRules(ValidatorFactory factory) {
		return Arrays.asList(
			factory.<fpml.confirmation.Portfolio>create(fpml.confirmation.validation.datarule.PortfolioChoice.class)
		);
	}
