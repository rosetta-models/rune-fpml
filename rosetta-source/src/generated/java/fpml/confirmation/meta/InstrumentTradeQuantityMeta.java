...
import fpml.confirmation.validation.InstrumentTradeQuantityTypeFormatValidator;
import fpml.confirmation.validation.InstrumentTradeQuantityValidator;
import fpml.confirmation.validation.exists.InstrumentTradeQuantityOnlyExistsValidator;
...
public class InstrumentTradeQuantityMeta implements RosettaMetaData<InstrumentTradeQuantity> {
	...
	public List<Validator<? super InstrumentTradeQuantity>> dataRules(ValidatorFactory factory) {
		return Arrays.asList(
			factory.<fpml.confirmation.InstrumentTradeQuantity>create(fpml.confirmation.validation.datarule.InstrumentTradeQuantityChoice.class)
		);
	}
