...
import fpml.confirmation.validation.IndexReferenceInformationTypeFormatValidator;
import fpml.confirmation.validation.IndexReferenceInformationValidator;
import fpml.confirmation.validation.exists.IndexReferenceInformationOnlyExistsValidator;
...
public class IndexReferenceInformationMeta implements RosettaMetaData<IndexReferenceInformation> {
	...
	public List<Validator<? super IndexReferenceInformation>> dataRules(ValidatorFactory factory) {
		return Arrays.asList(
			factory.<fpml.confirmation.IndexReferenceInformation>create(fpml.confirmation.validation.datarule.IndexReferenceInformationChoice.class)
		);
	}
