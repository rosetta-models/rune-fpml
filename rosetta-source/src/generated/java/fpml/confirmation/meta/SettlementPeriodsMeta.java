...
import fpml.confirmation.validation.SettlementPeriodsTypeFormatValidator;
import fpml.confirmation.validation.SettlementPeriodsValidator;
import fpml.confirmation.validation.exists.SettlementPeriodsOnlyExistsValidator;
...
public class SettlementPeriodsMeta implements RosettaMetaData<SettlementPeriods> {
	...
	public List<Validator<? super SettlementPeriods>> dataRules(ValidatorFactory factory) {
		return Arrays.asList(
			factory.<fpml.confirmation.SettlementPeriods>create(fpml.confirmation.validation.datarule.SettlementPeriodsChoice.class)
		);
	}
