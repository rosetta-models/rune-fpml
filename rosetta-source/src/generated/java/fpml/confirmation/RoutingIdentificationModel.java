 ...
 */
@RosettaDataType(value="RoutingIdentificationModel", builder=RoutingIdentificationModel.RoutingIdentificationModelBuilderImpl.class, version="${project.version}")
