 ...
 */
@RosettaDataType(value="ElectricityProduct", builder=ElectricityProduct.ElectricityProductBuilderImpl.class, version="${project.version}")
public interface ElectricityProduct extends RosettaModelObject {
	...
	class ElectricityProductBuilderImpl implements ElectricityProduct.ElectricityProductBuilder {
		...
		@Override
		@RosettaAttribute("type")
		public ElectricityProduct.ElectricityProductBuilder setType(ElectricityProductTypeEnum type) {
