...
public interface LoanTradeSettlementTask extends AbstractLoanTask {
	 ...
	 */
	LoanTradeSettlementTaskType getType_();
	...
	default void process(RosettaPath path, Processor processor) {
		...
		processRosetta(path.newSubPath("type"), processor, LoanTradeSettlementTaskType.class, getType_());
	}
	...
	interface LoanTradeSettlementTaskBuilder extends LoanTradeSettlementTask, AbstractLoanTask.AbstractLoanTaskBuilder {
		...
		LoanTradeSettlementTaskType.LoanTradeSettlementTaskTypeBuilder getType_();
		...
		default void process(RosettaPath path, BuilderProcessor processor) {
			...
			processRosetta(path.newSubPath("type"), processor, LoanTradeSettlementTaskType.LoanTradeSettlementTaskTypeBuilder.class, getType_());
		}
	...
	class LoanTradeSettlementTaskImpl extends AbstractLoanTask.AbstractLoanTaskImpl implements LoanTradeSettlementTask {
		...
		public LoanTradeSettlementTaskType getType_() {
			return type;
		}
	...
	class LoanTradeSettlementTaskBuilderImpl extends AbstractLoanTask.AbstractLoanTaskBuilderImpl  implements LoanTradeSettlementTask.LoanTradeSettlementTaskBuilder {
		...
		@Override
		@RosettaAttribute("type")
		public LoanTradeSettlementTaskType.LoanTradeSettlementTaskTypeBuilder getType_() {
			return type;
		}
		...
		@Override
		@RosettaAttribute("type")
		public LoanTradeSettlementTask.LoanTradeSettlementTaskBuilder setType(LoanTradeSettlementTaskType type) {
