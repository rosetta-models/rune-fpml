 ...
 */
@RosettaDataType(value="LoanAllocationSettlementTask", builder=LoanAllocationSettlementTask.LoanAllocationSettlementTaskBuilderImpl.class, version="${project.version}")
public interface LoanAllocationSettlementTask extends AbstractLoanTask {
	...
	class LoanAllocationSettlementTaskBuilderImpl extends AbstractLoanTask.AbstractLoanTaskBuilderImpl  implements LoanAllocationSettlementTask.LoanAllocationSettlementTaskBuilder {
		...
		@Override
		@RosettaAttribute("type")
		public LoanAllocationSettlementTask.LoanAllocationSettlementTaskBuilder setType(LoanAllocationSettlementTaskType type) {
