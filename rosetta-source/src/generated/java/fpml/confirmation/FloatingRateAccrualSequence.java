 ...
 */
@RosettaDataType(value="FloatingRateAccrualSequence", builder=FloatingRateAccrualSequence.FloatingRateAccrualSequenceBuilderImpl.class, version="${project.version}")
