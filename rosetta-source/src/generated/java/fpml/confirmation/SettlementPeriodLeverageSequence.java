 ...
 */
@RosettaDataType(value="SettlementPeriodLeverageSequence", builder=SettlementPeriodLeverageSequence.SettlementPeriodLeverageSequenceBuilderImpl.class, version="${project.version}")
