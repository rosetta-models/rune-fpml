 ...
 */
@RosettaDataType(value="CoalAttributePercentageSequence0", builder=CoalAttributePercentageSequence0.CoalAttributePercentageSequence0BuilderImpl.class, version="${project.version}")
