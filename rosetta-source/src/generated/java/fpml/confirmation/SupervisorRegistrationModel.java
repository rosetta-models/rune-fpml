 ...
 */
@RosettaDataType(value="SupervisorRegistrationModel", builder=SupervisorRegistrationModel.SupervisorRegistrationModelBuilderImpl.class, version="${project.version}")
