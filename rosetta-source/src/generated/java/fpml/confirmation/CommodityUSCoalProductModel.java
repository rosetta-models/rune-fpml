 ...
 */
@RosettaDataType(value="CommodityUSCoalProductModel", builder=CommodityUSCoalProductModel.CommodityUSCoalProductModelBuilderImpl.class, version="${project.version}")
