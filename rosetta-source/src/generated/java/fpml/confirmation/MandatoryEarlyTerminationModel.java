 ...
 */
@RosettaDataType(value="MandatoryEarlyTerminationModel", builder=MandatoryEarlyTerminationModel.MandatoryEarlyTerminationModelBuilderImpl.class, version="${project.version}")
