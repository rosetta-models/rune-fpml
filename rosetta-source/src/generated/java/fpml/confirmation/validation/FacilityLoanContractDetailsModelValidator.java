...
public class FacilityLoanContractDetailsModelValidator implements Validator<FacilityLoanContractDetailsModel> {
	...
	public ValidationResult<FacilityLoanContractDetailsModel> validate(RosettaPath path, FacilityLoanContractDetailsModel o) {
		...
		if (!isNullOrEmpty(error)) {
			return failure("FacilityLoanContractDetailsModel", ValidationType.CARDINALITY, "FacilityLoanContractDetailsModel", path, "", error);
		}
		return success("FacilityLoanContractDetailsModel", ValidationType.CARDINALITY, "FacilityLoanContractDetailsModel", path, "");
	}
		...
		return getComparisonResults(o)
			...
			.map(res -> {
				if (!isNullOrEmpty(res.getError())) {
					return failure("FacilityLoanContractDetailsModel", ValidationType.CARDINALITY, "FacilityLoanContractDetailsModel", path, "", res.getError());
				}
				return success("FacilityLoanContractDetailsModel", ValidationType.CARDINALITY, "FacilityLoanContractDetailsModel", path, "");
			})
			.collect(toList());
