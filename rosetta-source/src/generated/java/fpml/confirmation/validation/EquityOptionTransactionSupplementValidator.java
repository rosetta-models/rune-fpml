...
public class EquityOptionTransactionSupplementValidator implements Validator<EquityOptionTransactionSupplement> {
	...
	public ValidationResult<EquityOptionTransactionSupplement> validate(RosettaPath path, EquityOptionTransactionSupplement o) {
		...
		if (!isNullOrEmpty(error)) {
			return failure("EquityOptionTransactionSupplement", ValidationType.CARDINALITY, "EquityOptionTransactionSupplement", path, "", error);
		}
		return success("EquityOptionTransactionSupplement", ValidationType.CARDINALITY, "EquityOptionTransactionSupplement", path, "");
	}
		...
		return getComparisonResults(o)
			...
			.map(res -> {
				if (!isNullOrEmpty(res.getError())) {
					return failure("EquityOptionTransactionSupplement", ValidationType.CARDINALITY, "EquityOptionTransactionSupplement", path, "", res.getError());
				}
				return success("EquityOptionTransactionSupplement", ValidationType.CARDINALITY, "EquityOptionTransactionSupplement", path, "");
			})
			.collect(toList());
