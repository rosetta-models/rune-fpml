...
public class FxTermsValidator implements Validator<FxTerms> {
	...
	@Override
	public ValidationResult<FxTerms> validate(RosettaPath path, FxTerms o) {
		...
		if (!isNullOrEmpty(error)) {
			return failure("FxTerms", ValidationType.CARDINALITY, "FxTerms", path, "", error);
		}
		return success("FxTerms", ValidationType.CARDINALITY, "FxTerms", path, "");
	}
		...
		return getComparisonResults(o)
			...
			.map(res -> {
				if (!isNullOrEmpty(res.getError())) {
					return failure("FxTerms", ValidationType.CARDINALITY, "FxTerms", path, "", res.getError());
				}
				return success("FxTerms", ValidationType.CARDINALITY, "FxTerms", path, "");
			})
			.collect(toList());
