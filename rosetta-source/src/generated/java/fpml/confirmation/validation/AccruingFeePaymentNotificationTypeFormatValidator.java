...
public class AccruingFeePaymentNotificationTypeFormatValidator implements Validator<AccruingFeePaymentNotification> {
	...
	public ValidationResult<AccruingFeePaymentNotification> validate(RosettaPath path, AccruingFeePaymentNotification o) {
		...
		if (!isNullOrEmpty(error)) {
			return failure("AccruingFeePaymentNotification", ValidationType.TYPE_FORMAT, "AccruingFeePaymentNotification", path, "", error);
		}
		return success("AccruingFeePaymentNotification", ValidationType.TYPE_FORMAT, "AccruingFeePaymentNotification", path, "");
	}
		...
		return getComparisonResults(o)
			...
			.map(res -> {
				if (!isNullOrEmpty(res.getError())) {
					return failure("AccruingFeePaymentNotification", ValidationType.TYPE_FORMAT, "AccruingFeePaymentNotification", path, "", res.getError());
				}
				return success("AccruingFeePaymentNotification", ValidationType.TYPE_FORMAT, "AccruingFeePaymentNotification", path, "");
			})
			.collect(toList());
