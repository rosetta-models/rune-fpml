...
public class OtherAgreementVersionTypeFormatValidator implements Validator<OtherAgreementVersion> {
	...
	public ValidationResult<OtherAgreementVersion> validate(RosettaPath path, OtherAgreementVersion o) {
		...
		if (!isNullOrEmpty(error)) {
			return failure("OtherAgreementVersion", ValidationType.TYPE_FORMAT, "OtherAgreementVersion", path, "", error);
		}
		return success("OtherAgreementVersion", ValidationType.TYPE_FORMAT, "OtherAgreementVersion", path, "");
	}
		...
		return getComparisonResults(o)
			...
			.map(res -> {
				if (!isNullOrEmpty(res.getError())) {
					return failure("OtherAgreementVersion", ValidationType.TYPE_FORMAT, "OtherAgreementVersion", path, "", res.getError());
				}
				return success("OtherAgreementVersion", ValidationType.TYPE_FORMAT, "OtherAgreementVersion", path, "");
			})
			.collect(toList());
