...
public class ConfirmationAcknowledgementValidator implements Validator<ConfirmationAcknowledgement> {
	...
	@Override
	public ValidationResult<ConfirmationAcknowledgement> validate(RosettaPath path, ConfirmationAcknowledgement o) {
		...
		if (!isNullOrEmpty(error)) {
			return failure("ConfirmationAcknowledgement", ValidationType.CARDINALITY, "ConfirmationAcknowledgement", path, "", error);
		}
		return success("ConfirmationAcknowledgement", ValidationType.CARDINALITY, "ConfirmationAcknowledgement", path, "");
	}
		...
		return getComparisonResults(o)
			...
			.map(res -> {
				if (!isNullOrEmpty(res.getError())) {
					return failure("ConfirmationAcknowledgement", ValidationType.CARDINALITY, "ConfirmationAcknowledgement", path, "", res.getError());
				}
				return success("ConfirmationAcknowledgement", ValidationType.CARDINALITY, "ConfirmationAcknowledgement", path, "");
			})
			.collect(toList());
