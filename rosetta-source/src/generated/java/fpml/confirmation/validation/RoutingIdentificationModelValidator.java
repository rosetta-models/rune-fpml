...
public class RoutingIdentificationModelValidator implements Validator<RoutingIdentificationModel> {
	...
	public ValidationResult<RoutingIdentificationModel> validate(RosettaPath path, RoutingIdentificationModel o) {
		...
		if (!isNullOrEmpty(error)) {
			return failure("RoutingIdentificationModel", ValidationType.CARDINALITY, "RoutingIdentificationModel", path, "", error);
		}
		return success("RoutingIdentificationModel", ValidationType.CARDINALITY, "RoutingIdentificationModel", path, "");
	}
		...
		return getComparisonResults(o)
			...
			.map(res -> {
				if (!isNullOrEmpty(res.getError())) {
					return failure("RoutingIdentificationModel", ValidationType.CARDINALITY, "RoutingIdentificationModel", path, "", res.getError());
				}
				return success("RoutingIdentificationModel", ValidationType.CARDINALITY, "RoutingIdentificationModel", path, "");
			})
			.collect(toList());
