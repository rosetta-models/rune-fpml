...
public class EquityDerivativeLongFormBaseValidator implements Validator<EquityDerivativeLongFormBase> {
	...
	public ValidationResult<EquityDerivativeLongFormBase> validate(RosettaPath path, EquityDerivativeLongFormBase o) {
		...
		if (!isNullOrEmpty(error)) {
			return failure("EquityDerivativeLongFormBase", ValidationType.CARDINALITY, "EquityDerivativeLongFormBase", path, "", error);
		}
		return success("EquityDerivativeLongFormBase", ValidationType.CARDINALITY, "EquityDerivativeLongFormBase", path, "");
	}
		...
		return getComparisonResults(o)
			...
			.map(res -> {
				if (!isNullOrEmpty(res.getError())) {
					return failure("EquityDerivativeLongFormBase", ValidationType.CARDINALITY, "EquityDerivativeLongFormBase", path, "", res.getError());
				}
				return success("EquityDerivativeLongFormBase", ValidationType.CARDINALITY, "EquityDerivativeLongFormBase", path, "");
			})
			.collect(toList());
