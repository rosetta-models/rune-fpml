...
public class WithholdingTaxReasonValidator implements Validator<WithholdingTaxReason> {
	...
	public ValidationResult<WithholdingTaxReason> validate(RosettaPath path, WithholdingTaxReason o) {
		...
		if (!isNullOrEmpty(error)) {
			return failure("WithholdingTaxReason", ValidationType.CARDINALITY, "WithholdingTaxReason", path, "", error);
		}
		return success("WithholdingTaxReason", ValidationType.CARDINALITY, "WithholdingTaxReason", path, "");
	}
		...
		return getComparisonResults(o)
			...
			.map(res -> {
				if (!isNullOrEmpty(res.getError())) {
					return failure("WithholdingTaxReason", ValidationType.CARDINALITY, "WithholdingTaxReason", path, "", res.getError());
				}
				return success("WithholdingTaxReason", ValidationType.CARDINALITY, "WithholdingTaxReason", path, "");
			})
			.collect(toList());
