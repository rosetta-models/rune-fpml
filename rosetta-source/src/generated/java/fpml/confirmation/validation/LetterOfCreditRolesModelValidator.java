...
public class LetterOfCreditRolesModelValidator implements Validator<LetterOfCreditRolesModel> {
	...
	public ValidationResult<LetterOfCreditRolesModel> validate(RosettaPath path, LetterOfCreditRolesModel o) {
		...
		if (!isNullOrEmpty(error)) {
			return failure("LetterOfCreditRolesModel", ValidationType.CARDINALITY, "LetterOfCreditRolesModel", path, "", error);
		}
		return success("LetterOfCreditRolesModel", ValidationType.CARDINALITY, "LetterOfCreditRolesModel", path, "");
	}
		...
		return getComparisonResults(o)
			...
			.map(res -> {
				if (!isNullOrEmpty(res.getError())) {
					return failure("LetterOfCreditRolesModel", ValidationType.CARDINALITY, "LetterOfCreditRolesModel", path, "", res.getError());
				}
				return success("LetterOfCreditRolesModel", ValidationType.CARDINALITY, "LetterOfCreditRolesModel", path, "");
			})
			.collect(toList());
