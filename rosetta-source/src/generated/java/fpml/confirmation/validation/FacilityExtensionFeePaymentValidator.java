...
public class FacilityExtensionFeePaymentValidator implements Validator<FacilityExtensionFeePayment> {
	...
	@Override
	public ValidationResult<FacilityExtensionFeePayment> validate(RosettaPath path, FacilityExtensionFeePayment o) {
		...
		if (!isNullOrEmpty(error)) {
			return failure("FacilityExtensionFeePayment", ValidationType.CARDINALITY, "FacilityExtensionFeePayment", path, "", error);
		}
		return success("FacilityExtensionFeePayment", ValidationType.CARDINALITY, "FacilityExtensionFeePayment", path, "");
	}
		...
		return getComparisonResults(o)
			...
			.map(res -> {
				if (!isNullOrEmpty(res.getError())) {
					return failure("FacilityExtensionFeePayment", ValidationType.CARDINALITY, "FacilityExtensionFeePayment", path, "", res.getError());
				}
				return success("FacilityExtensionFeePayment", ValidationType.CARDINALITY, "FacilityExtensionFeePayment", path, "");
			})
			.collect(toList());
