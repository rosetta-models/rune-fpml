...
public class CreditEventsValidator implements Validator<CreditEvents> {
	...
	private List<ComparisonResult> getComparisonResults(CreditEvents o) {
		return Lists.<ComparisonResult>newArrayList(
				...
				checkCardinality("failureToPay", (FailureToPayType) o.getFailureToPay() != null ? 1 : 0, 0, 1), 
				...
				checkCardinality("creditEventNotice", (CreditEventNoticeType) o.getCreditEventNotice() != null ? 1 : 0, 0, 1), 
