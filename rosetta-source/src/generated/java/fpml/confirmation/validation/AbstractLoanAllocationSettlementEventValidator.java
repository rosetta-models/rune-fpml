...
public class AbstractLoanAllocationSettlementEventValidator implements Validator<AbstractLoanAllocationSettlementEvent> {
	...
	public ValidationResult<AbstractLoanAllocationSettlementEvent> validate(RosettaPath path, AbstractLoanAllocationSettlementEvent o) {
		...
		if (!isNullOrEmpty(error)) {
			return failure("AbstractLoanAllocationSettlementEvent", ValidationType.CARDINALITY, "AbstractLoanAllocationSettlementEvent", path, "", error);
		}
		return success("AbstractLoanAllocationSettlementEvent", ValidationType.CARDINALITY, "AbstractLoanAllocationSettlementEvent", path, "");
	}
		...
		return getComparisonResults(o)
			...
			.map(res -> {
				if (!isNullOrEmpty(res.getError())) {
					return failure("AbstractLoanAllocationSettlementEvent", ValidationType.CARDINALITY, "AbstractLoanAllocationSettlementEvent", path, "", res.getError());
				}
				return success("AbstractLoanAllocationSettlementEvent", ValidationType.CARDINALITY, "AbstractLoanAllocationSettlementEvent", path, "");
			})
			.collect(toList());
