...
public class AbstractFacilityContractEventValidator implements Validator<AbstractFacilityContractEvent> {
	...
	public ValidationResult<AbstractFacilityContractEvent> validate(RosettaPath path, AbstractFacilityContractEvent o) {
		...
		if (!isNullOrEmpty(error)) {
			return failure("AbstractFacilityContractEvent", ValidationType.CARDINALITY, "AbstractFacilityContractEvent", path, "", error);
		}
		return success("AbstractFacilityContractEvent", ValidationType.CARDINALITY, "AbstractFacilityContractEvent", path, "");
	}
		...
		return getComparisonResults(o)
			...
			.map(res -> {
				if (!isNullOrEmpty(res.getError())) {
					return failure("AbstractFacilityContractEvent", ValidationType.CARDINALITY, "AbstractFacilityContractEvent", path, "", res.getError());
				}
				return success("AbstractFacilityContractEvent", ValidationType.CARDINALITY, "AbstractFacilityContractEvent", path, "");
			})
			.collect(toList());
