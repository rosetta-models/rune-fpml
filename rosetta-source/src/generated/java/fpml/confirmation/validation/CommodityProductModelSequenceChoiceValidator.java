...
public class CommodityProductModelSequenceChoiceValidator implements Validator<CommodityProductModelSequenceChoice> {
	...
	public ValidationResult<CommodityProductModelSequenceChoice> validate(RosettaPath path, CommodityProductModelSequenceChoice o) {
		...
		if (!isNullOrEmpty(error)) {
			return failure("CommodityProductModelSequenceChoice", ValidationType.CARDINALITY, "CommodityProductModelSequenceChoice", path, "", error);
		}
		return success("CommodityProductModelSequenceChoice", ValidationType.CARDINALITY, "CommodityProductModelSequenceChoice", path, "");
	}
		...
		return getComparisonResults(o)
			...
			.map(res -> {
				if (!isNullOrEmpty(res.getError())) {
					return failure("CommodityProductModelSequenceChoice", ValidationType.CARDINALITY, "CommodityProductModelSequenceChoice", path, "", res.getError());
				}
				return success("CommodityProductModelSequenceChoice", ValidationType.CARDINALITY, "CommodityProductModelSequenceChoice", path, "");
			})
			.collect(toList());
