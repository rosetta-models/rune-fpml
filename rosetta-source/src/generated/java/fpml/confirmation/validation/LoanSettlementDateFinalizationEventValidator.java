...
public class LoanSettlementDateFinalizationEventValidator implements Validator<LoanSettlementDateFinalizationEvent> {
	...
	public ValidationResult<LoanSettlementDateFinalizationEvent> validate(RosettaPath path, LoanSettlementDateFinalizationEvent o) {
		...
		if (!isNullOrEmpty(error)) {
			return failure("LoanSettlementDateFinalizationEvent", ValidationType.CARDINALITY, "LoanSettlementDateFinalizationEvent", path, "", error);
		}
		return success("LoanSettlementDateFinalizationEvent", ValidationType.CARDINALITY, "LoanSettlementDateFinalizationEvent", path, "");
	}
		...
		return getComparisonResults(o)
			...
			.map(res -> {
				if (!isNullOrEmpty(res.getError())) {
					return failure("LoanSettlementDateFinalizationEvent", ValidationType.CARDINALITY, "LoanSettlementDateFinalizationEvent", path, "", res.getError());
				}
				return success("LoanSettlementDateFinalizationEvent", ValidationType.CARDINALITY, "LoanSettlementDateFinalizationEvent", path, "");
			})
			.collect(toList());
