...
public class ImplementationSpecificationValidator implements Validator<ImplementationSpecification> {
	...
	public ValidationResult<ImplementationSpecification> validate(RosettaPath path, ImplementationSpecification o) {
		...
		if (!isNullOrEmpty(error)) {
			return failure("ImplementationSpecification", ValidationType.CARDINALITY, "ImplementationSpecification", path, "", error);
		}
		return success("ImplementationSpecification", ValidationType.CARDINALITY, "ImplementationSpecification", path, "");
	}
		...
		return getComparisonResults(o)
			...
			.map(res -> {
				if (!isNullOrEmpty(res.getError())) {
					return failure("ImplementationSpecification", ValidationType.CARDINALITY, "ImplementationSpecification", path, "", res.getError());
				}
				return success("ImplementationSpecification", ValidationType.CARDINALITY, "ImplementationSpecification", path, "");
			})
			.collect(toList());
