...
public class LoanAllocationTransferFeeDueEventValidator implements Validator<LoanAllocationTransferFeeDueEvent> {
	...
	public ValidationResult<LoanAllocationTransferFeeDueEvent> validate(RosettaPath path, LoanAllocationTransferFeeDueEvent o) {
		...
		if (!isNullOrEmpty(error)) {
			return failure("LoanAllocationTransferFeeDueEvent", ValidationType.CARDINALITY, "LoanAllocationTransferFeeDueEvent", path, "", error);
		}
		return success("LoanAllocationTransferFeeDueEvent", ValidationType.CARDINALITY, "LoanAllocationTransferFeeDueEvent", path, "");
	}
		...
		return getComparisonResults(o)
			...
			.map(res -> {
				if (!isNullOrEmpty(res.getError())) {
					return failure("LoanAllocationTransferFeeDueEvent", ValidationType.CARDINALITY, "LoanAllocationTransferFeeDueEvent", path, "", res.getError());
				}
				return success("LoanAllocationTransferFeeDueEvent", ValidationType.CARDINALITY, "LoanAllocationTransferFeeDueEvent", path, "");
			})
			.collect(toList());
