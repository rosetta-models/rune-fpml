...
public class CalculationPeriodsScheduleReferenceTypeFormatValidator implements Validator<CalculationPeriodsScheduleReference> {
	...
	public ValidationResult<CalculationPeriodsScheduleReference> validate(RosettaPath path, CalculationPeriodsScheduleReference o) {
		...
		if (!isNullOrEmpty(error)) {
			return failure("CalculationPeriodsScheduleReference", ValidationType.TYPE_FORMAT, "CalculationPeriodsScheduleReference", path, "", error);
		}
		return success("CalculationPeriodsScheduleReference", ValidationType.TYPE_FORMAT, "CalculationPeriodsScheduleReference", path, "");
	}
		...
		return getComparisonResults(o)
			...
			.map(res -> {
				if (!isNullOrEmpty(res.getError())) {
					return failure("CalculationPeriodsScheduleReference", ValidationType.TYPE_FORMAT, "CalculationPeriodsScheduleReference", path, "", res.getError());
				}
				return success("CalculationPeriodsScheduleReference", ValidationType.TYPE_FORMAT, "CalculationPeriodsScheduleReference", path, "");
			})
			.collect(toList());
