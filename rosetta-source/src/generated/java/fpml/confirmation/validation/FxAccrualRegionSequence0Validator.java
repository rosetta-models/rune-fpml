...
public class FxAccrualRegionSequence0Validator implements Validator<FxAccrualRegionSequence0> {
	...
	public ValidationResult<FxAccrualRegionSequence0> validate(RosettaPath path, FxAccrualRegionSequence0 o) {
		...
		if (!isNullOrEmpty(error)) {
			return failure("FxAccrualRegionSequence0", ValidationType.CARDINALITY, "FxAccrualRegionSequence0", path, "", error);
		}
		return success("FxAccrualRegionSequence0", ValidationType.CARDINALITY, "FxAccrualRegionSequence0", path, "");
	}
		...
		return getComparisonResults(o)
			...
			.map(res -> {
				if (!isNullOrEmpty(res.getError())) {
					return failure("FxAccrualRegionSequence0", ValidationType.CARDINALITY, "FxAccrualRegionSequence0", path, "", res.getError());
				}
				return success("FxAccrualRegionSequence0", ValidationType.CARDINALITY, "FxAccrualRegionSequence0", path, "");
			})
			.collect(toList());
