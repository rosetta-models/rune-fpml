...
public class ExchangeTradedOptionTypeFormatValidator implements Validator<ExchangeTradedOption> {
	...
	@Override
	public ValidationResult<ExchangeTradedOption> validate(RosettaPath path, ExchangeTradedOption o) {
		...
		if (!isNullOrEmpty(error)) {
			return failure("ExchangeTradedOption", ValidationType.TYPE_FORMAT, "ExchangeTradedOption", path, "", error);
		}
		return success("ExchangeTradedOption", ValidationType.TYPE_FORMAT, "ExchangeTradedOption", path, "");
	}
		...
		return getComparisonResults(o)
			...
			.map(res -> {
				if (!isNullOrEmpty(res.getError())) {
					return failure("ExchangeTradedOption", ValidationType.TYPE_FORMAT, "ExchangeTradedOption", path, "", res.getError());
				}
				return success("ExchangeTradedOption", ValidationType.TYPE_FORMAT, "ExchangeTradedOption", path, "");
			})
			.collect(toList());
