...
public class CommodityFixedInterestCalculationValidator implements Validator<CommodityFixedInterestCalculation> {
	...
	public ValidationResult<CommodityFixedInterestCalculation> validate(RosettaPath path, CommodityFixedInterestCalculation o) {
		...
		if (!isNullOrEmpty(error)) {
			return failure("CommodityFixedInterestCalculation", ValidationType.CARDINALITY, "CommodityFixedInterestCalculation", path, "", error);
		}
		return success("CommodityFixedInterestCalculation", ValidationType.CARDINALITY, "CommodityFixedInterestCalculation", path, "");
	}
		...
		return getComparisonResults(o)
			...
			.map(res -> {
				if (!isNullOrEmpty(res.getError())) {
					return failure("CommodityFixedInterestCalculation", ValidationType.CARDINALITY, "CommodityFixedInterestCalculation", path, "", res.getError());
				}
				return success("CommodityFixedInterestCalculation", ValidationType.CARDINALITY, "CommodityFixedInterestCalculation", path, "");
			})
			.collect(toList());
