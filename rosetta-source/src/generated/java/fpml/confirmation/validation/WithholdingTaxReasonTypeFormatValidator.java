...
public class WithholdingTaxReasonTypeFormatValidator implements Validator<WithholdingTaxReason> {
	...
	@Override
	public ValidationResult<WithholdingTaxReason> validate(RosettaPath path, WithholdingTaxReason o) {
		...
		if (!isNullOrEmpty(error)) {
			return failure("WithholdingTaxReason", ValidationType.TYPE_FORMAT, "WithholdingTaxReason", path, "", error);
		}
		return success("WithholdingTaxReason", ValidationType.TYPE_FORMAT, "WithholdingTaxReason", path, "");
	}
		...
		return getComparisonResults(o)
			...
			.map(res -> {
				if (!isNullOrEmpty(res.getError())) {
					return failure("WithholdingTaxReason", ValidationType.TYPE_FORMAT, "WithholdingTaxReason", path, "", res.getError());
				}
				return success("WithholdingTaxReason", ValidationType.TYPE_FORMAT, "WithholdingTaxReason", path, "");
			})
			.collect(toList());
