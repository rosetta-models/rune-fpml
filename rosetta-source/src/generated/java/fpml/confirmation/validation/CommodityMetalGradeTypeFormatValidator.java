...
public class CommodityMetalGradeTypeFormatValidator implements Validator<CommodityMetalGrade> {
	...
	public ValidationResult<CommodityMetalGrade> validate(RosettaPath path, CommodityMetalGrade o) {
		...
		if (!isNullOrEmpty(error)) {
			return failure("CommodityMetalGrade", ValidationType.TYPE_FORMAT, "CommodityMetalGrade", path, "", error);
		}
		return success("CommodityMetalGrade", ValidationType.TYPE_FORMAT, "CommodityMetalGrade", path, "");
	}
		...
		return getComparisonResults(o)
			...
			.map(res -> {
				if (!isNullOrEmpty(res.getError())) {
					return failure("CommodityMetalGrade", ValidationType.TYPE_FORMAT, "CommodityMetalGrade", path, "", res.getError());
				}
				return success("CommodityMetalGrade", ValidationType.TYPE_FORMAT, "CommodityMetalGrade", path, "");
			})
			.collect(toList());
