...
public class MandatoryCostRateChangeValidator implements Validator<MandatoryCostRateChange> {
	...
	public ValidationResult<MandatoryCostRateChange> validate(RosettaPath path, MandatoryCostRateChange o) {
		...
		if (!isNullOrEmpty(error)) {
			return failure("MandatoryCostRateChange", ValidationType.CARDINALITY, "MandatoryCostRateChange", path, "", error);
		}
		return success("MandatoryCostRateChange", ValidationType.CARDINALITY, "MandatoryCostRateChange", path, "");
	}
		...
		return getComparisonResults(o)
			...
			.map(res -> {
				if (!isNullOrEmpty(res.getError())) {
					return failure("MandatoryCostRateChange", ValidationType.CARDINALITY, "MandatoryCostRateChange", path, "", res.getError());
				}
				return success("MandatoryCostRateChange", ValidationType.CARDINALITY, "MandatoryCostRateChange", path, "");
			})
			.collect(toList());
