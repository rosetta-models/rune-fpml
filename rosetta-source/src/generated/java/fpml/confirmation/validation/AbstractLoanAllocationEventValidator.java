...
public class AbstractLoanAllocationEventValidator implements Validator<AbstractLoanAllocationEvent> {
	...
	@Override
	public ValidationResult<AbstractLoanAllocationEvent> validate(RosettaPath path, AbstractLoanAllocationEvent o) {
		...
		if (!isNullOrEmpty(error)) {
			return failure("AbstractLoanAllocationEvent", ValidationType.CARDINALITY, "AbstractLoanAllocationEvent", path, "", error);
		}
		return success("AbstractLoanAllocationEvent", ValidationType.CARDINALITY, "AbstractLoanAllocationEvent", path, "");
	}
		...
		return getComparisonResults(o)
			...
			.map(res -> {
				if (!isNullOrEmpty(res.getError())) {
					return failure("AbstractLoanAllocationEvent", ValidationType.CARDINALITY, "AbstractLoanAllocationEvent", path, "", res.getError());
				}
				return success("AbstractLoanAllocationEvent", ValidationType.CARDINALITY, "AbstractLoanAllocationEvent", path, "");
			})
			.collect(toList());
