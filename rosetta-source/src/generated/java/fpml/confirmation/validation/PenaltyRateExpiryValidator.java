...
public class PenaltyRateExpiryValidator implements Validator<PenaltyRateExpiry> {
	...
	@Override
	public ValidationResult<PenaltyRateExpiry> validate(RosettaPath path, PenaltyRateExpiry o) {
		...
		if (!isNullOrEmpty(error)) {
			return failure("PenaltyRateExpiry", ValidationType.CARDINALITY, "PenaltyRateExpiry", path, "", error);
		}
		return success("PenaltyRateExpiry", ValidationType.CARDINALITY, "PenaltyRateExpiry", path, "");
	}
		...
		return getComparisonResults(o)
			...
			.map(res -> {
				if (!isNullOrEmpty(res.getError())) {
					return failure("PenaltyRateExpiry", ValidationType.CARDINALITY, "PenaltyRateExpiry", path, "", res.getError());
				}
				return success("PenaltyRateExpiry", ValidationType.CARDINALITY, "PenaltyRateExpiry", path, "");
			})
			.collect(toList());
