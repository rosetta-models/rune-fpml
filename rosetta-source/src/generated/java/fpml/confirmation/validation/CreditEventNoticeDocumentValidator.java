...
public class CreditEventNoticeDocumentValidator implements Validator<CreditEventNoticeDocument> {
	...
	public ValidationResult<CreditEventNoticeDocument> validate(RosettaPath path, CreditEventNoticeDocument o) {
		...
		if (!isNullOrEmpty(error)) {
			return failure("CreditEventNoticeDocument", ValidationType.CARDINALITY, "CreditEventNoticeDocument", path, "", error);
		}
		return success("CreditEventNoticeDocument", ValidationType.CARDINALITY, "CreditEventNoticeDocument", path, "");
	}
		...
		return getComparisonResults(o)
			...
			.map(res -> {
				if (!isNullOrEmpty(res.getError())) {
					return failure("CreditEventNoticeDocument", ValidationType.CARDINALITY, "CreditEventNoticeDocument", path, "", res.getError());
				}
				return success("CreditEventNoticeDocument", ValidationType.CARDINALITY, "CreditEventNoticeDocument", path, "");
			})
			.collect(toList());
