...
public class FxBarrierFeatureSequenceSequenceValidator implements Validator<FxBarrierFeatureSequenceSequence> {
	...
	public ValidationResult<FxBarrierFeatureSequenceSequence> validate(RosettaPath path, FxBarrierFeatureSequenceSequence o) {
		...
		if (!isNullOrEmpty(error)) {
			return failure("FxBarrierFeatureSequenceSequence", ValidationType.CARDINALITY, "FxBarrierFeatureSequenceSequence", path, "", error);
		}
		return success("FxBarrierFeatureSequenceSequence", ValidationType.CARDINALITY, "FxBarrierFeatureSequenceSequence", path, "");
	}
		...
		return getComparisonResults(o)
			...
			.map(res -> {
				if (!isNullOrEmpty(res.getError())) {
					return failure("FxBarrierFeatureSequenceSequence", ValidationType.CARDINALITY, "FxBarrierFeatureSequenceSequence", path, "", res.getError());
				}
				return success("FxBarrierFeatureSequenceSequence", ValidationType.CARDINALITY, "FxBarrierFeatureSequenceSequence", path, "");
			})
			.collect(toList());
