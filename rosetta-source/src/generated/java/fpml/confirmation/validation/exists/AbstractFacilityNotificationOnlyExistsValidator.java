...
public class AbstractFacilityNotificationOnlyExistsValidator implements ValidatorWithArg<AbstractFacilityNotification, Set<String>> {
	...
	public <T2 extends AbstractFacilityNotification> ValidationResult<AbstractFacilityNotification> validate(RosettaPath path, T2 o, Set<String> fields) {
		...
		if (setFields.equals(fields)) {
			return success("AbstractFacilityNotification", ValidationType.ONLY_EXISTS, "AbstractFacilityNotification", path, "");
		}
		return failure("AbstractFacilityNotification", ValidationType.ONLY_EXISTS, "AbstractFacilityNotification", path, "",
