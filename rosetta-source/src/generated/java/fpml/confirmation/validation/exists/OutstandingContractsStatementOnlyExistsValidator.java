...
public class OutstandingContractsStatementOnlyExistsValidator implements ValidatorWithArg<OutstandingContractsStatement, Set<String>> {
	...
	public <T2 extends OutstandingContractsStatement> ValidationResult<OutstandingContractsStatement> validate(RosettaPath path, T2 o, Set<String> fields) {
		...
		if (setFields.equals(fields)) {
			return success("OutstandingContractsStatement", ValidationType.ONLY_EXISTS, "OutstandingContractsStatement", path, "");
		}
		return failure("OutstandingContractsStatement", ValidationType.ONLY_EXISTS, "OutstandingContractsStatement", path, "",
