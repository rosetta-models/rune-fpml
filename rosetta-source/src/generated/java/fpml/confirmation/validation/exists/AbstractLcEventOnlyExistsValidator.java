...
public class AbstractLcEventOnlyExistsValidator implements ValidatorWithArg<AbstractLcEvent, Set<String>> {
	...
	public <T2 extends AbstractLcEvent> ValidationResult<AbstractLcEvent> validate(RosettaPath path, T2 o, Set<String> fields) {
		...
		if (setFields.equals(fields)) {
			return success("AbstractLcEvent", ValidationType.ONLY_EXISTS, "AbstractLcEvent", path, "");
		}
		return failure("AbstractLcEvent", ValidationType.ONLY_EXISTS, "AbstractLcEvent", path, "",
