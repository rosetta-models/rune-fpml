...
public class FacilityTerminationOnlyExistsValidator implements ValidatorWithArg<FacilityTermination, Set<String>> {
	...
	public <T2 extends FacilityTermination> ValidationResult<FacilityTermination> validate(RosettaPath path, T2 o, Set<String> fields) {
		...
		if (setFields.equals(fields)) {
			return success("FacilityTermination", ValidationType.ONLY_EXISTS, "FacilityTermination", path, "");
		}
		return failure("FacilityTermination", ValidationType.ONLY_EXISTS, "FacilityTermination", path, "",
