...
public class LcNotificationOnlyExistsValidator implements ValidatorWithArg<LcNotification, Set<String>> {
	...
	public <T2 extends LcNotification> ValidationResult<LcNotification> validate(RosettaPath path, T2 o, Set<String> fields) {
		...
		if (setFields.equals(fields)) {
			return success("LcNotification", ValidationType.ONLY_EXISTS, "LcNotification", path, "");
		}
		return failure("LcNotification", ValidationType.ONLY_EXISTS, "LcNotification", path, "",
