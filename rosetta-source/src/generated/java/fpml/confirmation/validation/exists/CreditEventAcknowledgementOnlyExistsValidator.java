...
public class CreditEventAcknowledgementOnlyExistsValidator implements ValidatorWithArg<CreditEventAcknowledgement, Set<String>> {
	...
	public <T2 extends CreditEventAcknowledgement> ValidationResult<CreditEventAcknowledgement> validate(RosettaPath path, T2 o, Set<String> fields) {
		...
		if (setFields.equals(fields)) {
			return success("CreditEventAcknowledgement", ValidationType.ONLY_EXISTS, "CreditEventAcknowledgement", path, "");
		}
		return failure("CreditEventAcknowledgement", ValidationType.ONLY_EXISTS, "CreditEventAcknowledgement", path, "",
