...
public class ElectricityPhysicalDeliveryQuantityOnlyExistsValidator implements ValidatorWithArg<ElectricityPhysicalDeliveryQuantity, Set<String>> {
	...
	public <T2 extends ElectricityPhysicalDeliveryQuantity> ValidationResult<ElectricityPhysicalDeliveryQuantity> validate(RosettaPath path, T2 o, Set<String> fields) {
		...
		if (setFields.equals(fields)) {
			return success("ElectricityPhysicalDeliveryQuantity", ValidationType.ONLY_EXISTS, "ElectricityPhysicalDeliveryQuantity", path, "");
		}
		return failure("ElectricityPhysicalDeliveryQuantity", ValidationType.ONLY_EXISTS, "ElectricityPhysicalDeliveryQuantity", path, "",
