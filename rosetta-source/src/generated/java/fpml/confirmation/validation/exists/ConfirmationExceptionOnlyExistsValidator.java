...
public class ConfirmationExceptionOnlyExistsValidator implements ValidatorWithArg<ConfirmationException, Set<String>> {
	...
	public <T2 extends ConfirmationException> ValidationResult<ConfirmationException> validate(RosettaPath path, T2 o, Set<String> fields) {
		...
		if (setFields.equals(fields)) {
			return success("ConfirmationException", ValidationType.ONLY_EXISTS, "ConfirmationException", path, "");
		}
		return failure("ConfirmationException", ValidationType.ONLY_EXISTS, "ConfirmationException", path, "",
