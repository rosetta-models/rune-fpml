...
public class AllocationRefusedOnlyExistsValidator implements ValidatorWithArg<AllocationRefused, Set<String>> {
	...
	public <T2 extends AllocationRefused> ValidationResult<AllocationRefused> validate(RosettaPath path, T2 o, Set<String> fields) {
		...
		if (setFields.equals(fields)) {
			return success("AllocationRefused", ValidationType.ONLY_EXISTS, "AllocationRefused", path, "");
		}
		return failure("AllocationRefused", ValidationType.ONLY_EXISTS, "AllocationRefused", path, "",
