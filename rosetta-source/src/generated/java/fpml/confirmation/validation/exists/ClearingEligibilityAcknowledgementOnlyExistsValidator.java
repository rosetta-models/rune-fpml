...
public class ClearingEligibilityAcknowledgementOnlyExistsValidator implements ValidatorWithArg<ClearingEligibilityAcknowledgement, Set<String>> {
	...
	public <T2 extends ClearingEligibilityAcknowledgement> ValidationResult<ClearingEligibilityAcknowledgement> validate(RosettaPath path, T2 o, Set<String> fields) {
		...
		if (setFields.equals(fields)) {
			return success("ClearingEligibilityAcknowledgement", ValidationType.ONLY_EXISTS, "ClearingEligibilityAcknowledgement", path, "");
		}
		return failure("ClearingEligibilityAcknowledgement", ValidationType.ONLY_EXISTS, "ClearingEligibilityAcknowledgement", path, "",
