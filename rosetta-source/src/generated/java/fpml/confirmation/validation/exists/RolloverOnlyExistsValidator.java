...
public class RolloverOnlyExistsValidator implements ValidatorWithArg<Rollover, Set<String>> {
	...
	public <T2 extends Rollover> ValidationResult<Rollover> validate(RosettaPath path, T2 o, Set<String> fields) {
		Map<String, Boolean> fieldExistenceMap = ImmutableMap.<String, Boolean>builder()
				...
				.put("maturingContracts", ExistenceChecker.isSet((String) o.getMaturingContracts()))
				.put("currentContracts", ExistenceChecker.isSet((String) o.getCurrentContracts()))
				.put("rolloverChoice", ExistenceChecker.isSet((List<? extends RolloverChoice>) o.getRolloverChoice()))
				.build();
		...
		if (setFields.equals(fields)) {
			return success("Rollover", ValidationType.ONLY_EXISTS, "Rollover", path, "");
		}
		return failure("Rollover", ValidationType.ONLY_EXISTS, "Rollover", path, "",
