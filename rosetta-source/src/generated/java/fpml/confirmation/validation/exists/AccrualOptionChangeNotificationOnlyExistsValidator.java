...
public class AccrualOptionChangeNotificationOnlyExistsValidator implements ValidatorWithArg<AccrualOptionChangeNotification, Set<String>> {

	/* Casting is required to ensure types are output to ensure recompilation in Rosetta */
	@Override
	public <T2 extends AccrualOptionChangeNotification> ValidationResult<AccrualOptionChangeNotification> validate(RosettaPath path, T2 o, Set<String> fields) {
		Map<String, Boolean> fieldExistenceMap = ImmutableMap.<String, Boolean>builder()
				...
				.put("accrualOptionChangeNotificationSequence0", ExistenceChecker.isSet((AccrualOptionChangeNotificationSequence0) o.getAccrualOptionChangeNotificationSequence0()))
				.put("accruingPikOptionChange", ExistenceChecker.isSet((AccruingPikOptionChange) o.getAccruingPikOptionChange()))
				.put("accrualOptionChangeNotificationSequence1", ExistenceChecker.isSet((AccrualOptionChangeNotificationSequence1) o.getAccrualOptionChangeNotificationSequence1()))
				...
				.put("letterOfCreditDetailsModel", ExistenceChecker.isSet((List<? extends LetterOfCreditDetailsModel>) o.getLetterOfCreditDetailsModel()))
		...
		if (setFields.equals(fields)) {
			return success("AccrualOptionChangeNotification", ValidationType.ONLY_EXISTS, "AccrualOptionChangeNotification", path, "");
		}
		return failure("AccrualOptionChangeNotification", ValidationType.ONLY_EXISTS, "AccrualOptionChangeNotification", path, "",
