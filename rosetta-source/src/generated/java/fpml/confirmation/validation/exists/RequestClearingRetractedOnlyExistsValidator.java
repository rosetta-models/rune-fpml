...
public class RequestClearingRetractedOnlyExistsValidator implements ValidatorWithArg<RequestClearingRetracted, Set<String>> {
	...
	public <T2 extends RequestClearingRetracted> ValidationResult<RequestClearingRetracted> validate(RosettaPath path, T2 o, Set<String> fields) {
		...
		if (setFields.equals(fields)) {
			return success("RequestClearingRetracted", ValidationType.ONLY_EXISTS, "RequestClearingRetracted", path, "");
		}
		return failure("RequestClearingRetracted", ValidationType.ONLY_EXISTS, "RequestClearingRetracted", path, "",
