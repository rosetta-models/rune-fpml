...
public class LoanTradeSettlementTaskNotificationOnlyExistsValidator implements ValidatorWithArg<LoanTradeSettlementTaskNotification, Set<String>> {

	/* Casting is required to ensure types are output to ensure recompilation in Rosetta */
	@Override
	public <T2 extends LoanTradeSettlementTaskNotification> ValidationResult<LoanTradeSettlementTaskNotification> validate(RosettaPath path, T2 o, Set<String> fields) {
		Map<String, Boolean> fieldExistenceMap = ImmutableMap.<String, Boolean>builder()
				...
				.put("task", ExistenceChecker.isSet((List<? extends LoanTradeSettlementTask>) o.getTask()))
		...
		if (setFields.equals(fields)) {
			return success("LoanTradeSettlementTaskNotification", ValidationType.ONLY_EXISTS, "LoanTradeSettlementTaskNotification", path, "");
		}
		return failure("LoanTradeSettlementTaskNotification", ValidationType.ONLY_EXISTS, "LoanTradeSettlementTaskNotification", path, "",
