...
public class LoanAllocationTransferFeeOwedEventOnlyExistsValidator implements ValidatorWithArg<LoanAllocationTransferFeeOwedEvent, Set<String>> {

	/* Casting is required to ensure types are output to ensure recompilation in Rosetta */
	@Override
	public <T2 extends LoanAllocationTransferFeeOwedEvent> ValidationResult<LoanAllocationTransferFeeOwedEvent> validate(RosettaPath path, T2 o, Set<String> fields) {
		Map<String, Boolean> fieldExistenceMap = ImmutableMap.<String, Boolean>builder()
				...
				.put("loanTradingTransferFeeDeterminationModel", ExistenceChecker.isSet((LoanTradingTransferFeeDeterminationModel) o.getLoanTradingTransferFeeDeterminationModel()))
				.build();
		...
		if (setFields.equals(fields)) {
			return success("LoanAllocationTransferFeeOwedEvent", ValidationType.ONLY_EXISTS, "LoanAllocationTransferFeeOwedEvent", path, "");
		}
		return failure("LoanAllocationTransferFeeOwedEvent", ValidationType.ONLY_EXISTS, "LoanAllocationTransferFeeOwedEvent", path, "",
