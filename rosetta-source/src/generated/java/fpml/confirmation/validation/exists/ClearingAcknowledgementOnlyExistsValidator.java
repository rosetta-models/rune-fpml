...
public class ClearingAcknowledgementOnlyExistsValidator implements ValidatorWithArg<ClearingAcknowledgement, Set<String>> {
	...
	public <T2 extends ClearingAcknowledgement> ValidationResult<ClearingAcknowledgement> validate(RosettaPath path, T2 o, Set<String> fields) {
		...
		if (setFields.equals(fields)) {
			return success("ClearingAcknowledgement", ValidationType.ONLY_EXISTS, "ClearingAcknowledgement", path, "");
		}
		return failure("ClearingAcknowledgement", ValidationType.ONLY_EXISTS, "ClearingAcknowledgement", path, "",
