...
public class AllocationApprovedOnlyExistsValidator implements ValidatorWithArg<AllocationApproved, Set<String>> {
	...
	public <T2 extends AllocationApproved> ValidationResult<AllocationApproved> validate(RosettaPath path, T2 o, Set<String> fields) {
		...
		if (setFields.equals(fields)) {
			return success("AllocationApproved", ValidationType.ONLY_EXISTS, "AllocationApproved", path, "");
		}
		return failure("AllocationApproved", ValidationType.ONLY_EXISTS, "AllocationApproved", path, "",
