...
public class MaturityChangeOnlyExistsValidator implements ValidatorWithArg<MaturityChange, Set<String>> {
	...
	public <T2 extends MaturityChange> ValidationResult<MaturityChange> validate(RosettaPath path, T2 o, Set<String> fields) {
		...
		if (setFields.equals(fields)) {
			return success("MaturityChange", ValidationType.ONLY_EXISTS, "MaturityChange", path, "");
		}
		return failure("MaturityChange", ValidationType.ONLY_EXISTS, "MaturityChange", path, "",
