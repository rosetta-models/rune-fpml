...
public class OptionExpirationNotificationOnlyExistsValidator implements ValidatorWithArg<OptionExpirationNotification, Set<String>> {
	...
	public <T2 extends OptionExpirationNotification> ValidationResult<OptionExpirationNotification> validate(RosettaPath path, T2 o, Set<String> fields) {
		...
		if (setFields.equals(fields)) {
			return success("OptionExpirationNotification", ValidationType.ONLY_EXISTS, "OptionExpirationNotification", path, "");
		}
		return failure("OptionExpirationNotification", ValidationType.ONLY_EXISTS, "OptionExpirationNotification", path, "",
