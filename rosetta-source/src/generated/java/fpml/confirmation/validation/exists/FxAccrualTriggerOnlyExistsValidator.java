...
public class FxAccrualTriggerOnlyExistsValidator implements ValidatorWithArg<FxAccrualTrigger, Set<String>> {
	...
	public <T2 extends FxAccrualTrigger> ValidationResult<FxAccrualTrigger> validate(RosettaPath path, T2 o, Set<String> fields) {
		...
		if (setFields.equals(fields)) {
			return success("FxAccrualTrigger", ValidationType.ONLY_EXISTS, "FxAccrualTrigger", path, "");
		}
		return failure("FxAccrualTrigger", ValidationType.ONLY_EXISTS, "FxAccrualTrigger", path, "",
