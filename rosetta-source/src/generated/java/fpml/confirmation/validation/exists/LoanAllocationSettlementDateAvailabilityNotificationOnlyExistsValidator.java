...
public class LoanAllocationSettlementDateAvailabilityNotificationOnlyExistsValidator implements ValidatorWithArg<LoanAllocationSettlementDateAvailabilityNotification, Set<String>> {

	/* Casting is required to ensure types are output to ensure recompilation in Rosetta */
	@Override
	public <T2 extends LoanAllocationSettlementDateAvailabilityNotification> ValidationResult<LoanAllocationSettlementDateAvailabilityNotification> validate(RosettaPath path, T2 o, Set<String> fields) {
		Map<String, Boolean> fieldExistenceMap = ImmutableMap.<String, Boolean>builder()
				...
				.put("settlementDateAvailability", ExistenceChecker.isSet((List<? extends LoanSettlementDateAvailabilityEvent>) o.getSettlementDateAvailability()))
		...
		if (setFields.equals(fields)) {
			return success("LoanAllocationSettlementDateAvailabilityNotification", ValidationType.ONLY_EXISTS, "LoanAllocationSettlementDateAvailabilityNotification", path, "");
		}
		return failure("LoanAllocationSettlementDateAvailabilityNotification", ValidationType.ONLY_EXISTS, "LoanAllocationSettlementDateAvailabilityNotification", path, "",
