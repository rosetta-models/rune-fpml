...
public class DirectionalLegUnderlyerValuationOnlyExistsValidator implements ValidatorWithArg<DirectionalLegUnderlyerValuation, Set<String>> {
	...
	public <T2 extends DirectionalLegUnderlyerValuation> ValidationResult<DirectionalLegUnderlyerValuation> validate(RosettaPath path, T2 o, Set<String> fields) {
		...
		if (setFields.equals(fields)) {
			return success("DirectionalLegUnderlyerValuation", ValidationType.ONLY_EXISTS, "DirectionalLegUnderlyerValuation", path, "");
		}
		return failure("DirectionalLegUnderlyerValuation", ValidationType.ONLY_EXISTS, "DirectionalLegUnderlyerValuation", path, "",
