...
public class LetterOfCreditFacilityOnlyExistsValidator implements ValidatorWithArg<LetterOfCreditFacility, Set<String>> {
	...
	public <T2 extends LetterOfCreditFacility> ValidationResult<LetterOfCreditFacility> validate(RosettaPath path, T2 o, Set<String> fields) {
		...
		if (setFields.equals(fields)) {
			return success("LetterOfCreditFacility", ValidationType.ONLY_EXISTS, "LetterOfCreditFacility", path, "");
		}
		return failure("LetterOfCreditFacility", ValidationType.ONLY_EXISTS, "LetterOfCreditFacility", path, "",
