...
public class ConfirmationAcknowledgementOnlyExistsValidator implements ValidatorWithArg<ConfirmationAcknowledgement, Set<String>> {
	...
	public <T2 extends ConfirmationAcknowledgement> ValidationResult<ConfirmationAcknowledgement> validate(RosettaPath path, T2 o, Set<String> fields) {
		...
		if (setFields.equals(fields)) {
			return success("ConfirmationAcknowledgement", ValidationType.ONLY_EXISTS, "ConfirmationAcknowledgement", path, "");
		}
		return failure("ConfirmationAcknowledgement", ValidationType.ONLY_EXISTS, "ConfirmationAcknowledgement", path, "",
