...
public class LcFxRevaluationOnlyExistsValidator implements ValidatorWithArg<LcFxRevaluation, Set<String>> {
	...
	public <T2 extends LcFxRevaluation> ValidationResult<LcFxRevaluation> validate(RosettaPath path, T2 o, Set<String> fields) {
		...
		if (setFields.equals(fields)) {
			return success("LcFxRevaluation", ValidationType.ONLY_EXISTS, "LcFxRevaluation", path, "");
		}
		return failure("LcFxRevaluation", ValidationType.ONLY_EXISTS, "LcFxRevaluation", path, "",
