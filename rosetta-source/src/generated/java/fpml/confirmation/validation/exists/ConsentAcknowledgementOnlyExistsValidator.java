...
public class ConsentAcknowledgementOnlyExistsValidator implements ValidatorWithArg<ConsentAcknowledgement, Set<String>> {
	...
	public <T2 extends ConsentAcknowledgement> ValidationResult<ConsentAcknowledgement> validate(RosettaPath path, T2 o, Set<String> fields) {
		...
		if (setFields.equals(fields)) {
			return success("ConsentAcknowledgement", ValidationType.ONLY_EXISTS, "ConsentAcknowledgement", path, "");
		}
		return failure("ConsentAcknowledgement", ValidationType.ONLY_EXISTS, "ConsentAcknowledgement", path, "",
