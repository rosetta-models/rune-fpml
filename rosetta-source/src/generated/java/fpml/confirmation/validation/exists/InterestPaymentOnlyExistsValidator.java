...
public class InterestPaymentOnlyExistsValidator implements ValidatorWithArg<InterestPayment, Set<String>> {
	...
	public <T2 extends InterestPayment> ValidationResult<InterestPayment> validate(RosettaPath path, T2 o, Set<String> fields) {
		...
		if (setFields.equals(fields)) {
			return success("InterestPayment", ValidationType.ONLY_EXISTS, "InterestPayment", path, "");
		}
		return failure("InterestPayment", ValidationType.ONLY_EXISTS, "InterestPayment", path, "",
