...
public class RequestConfirmationRetractedOnlyExistsValidator implements ValidatorWithArg<RequestConfirmationRetracted, Set<String>> {
	...
	public <T2 extends RequestConfirmationRetracted> ValidationResult<RequestConfirmationRetracted> validate(RosettaPath path, T2 o, Set<String> fields) {
		...
		if (setFields.equals(fields)) {
			return success("RequestConfirmationRetracted", ValidationType.ONLY_EXISTS, "RequestConfirmationRetracted", path, "");
		}
		return failure("RequestConfirmationRetracted", ValidationType.ONLY_EXISTS, "RequestConfirmationRetracted", path, "",
