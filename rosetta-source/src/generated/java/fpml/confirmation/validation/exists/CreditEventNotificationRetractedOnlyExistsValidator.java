...
public class CreditEventNotificationRetractedOnlyExistsValidator implements ValidatorWithArg<CreditEventNotificationRetracted, Set<String>> {
	...
	public <T2 extends CreditEventNotificationRetracted> ValidationResult<CreditEventNotificationRetracted> validate(RosettaPath path, T2 o, Set<String> fields) {
		...
		if (setFields.equals(fields)) {
			return success("CreditEventNotificationRetracted", ValidationType.ONLY_EXISTS, "CreditEventNotificationRetracted", path, "");
		}
		return failure("CreditEventNotificationRetracted", ValidationType.ONLY_EXISTS, "CreditEventNotificationRetracted", path, "",
