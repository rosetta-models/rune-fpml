...
public class AbstractLoanAllocationEventOnlyExistsValidator implements ValidatorWithArg<AbstractLoanAllocationEvent, Set<String>> {
	...
	public <T2 extends AbstractLoanAllocationEvent> ValidationResult<AbstractLoanAllocationEvent> validate(RosettaPath path, T2 o, Set<String> fields) {
		...
		if (setFields.equals(fields)) {
			return success("AbstractLoanAllocationEvent", ValidationType.ONLY_EXISTS, "AbstractLoanAllocationEvent", path, "");
		}
		return failure("AbstractLoanAllocationEvent", ValidationType.ONLY_EXISTS, "AbstractLoanAllocationEvent", path, "",
