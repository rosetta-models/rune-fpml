...
public class ConsentGrantedOnlyExistsValidator implements ValidatorWithArg<ConsentGranted, Set<String>> {
	...
	public <T2 extends ConsentGranted> ValidationResult<ConsentGranted> validate(RosettaPath path, T2 o, Set<String> fields) {
		...
		if (setFields.equals(fields)) {
			return success("ConsentGranted", ValidationType.ONLY_EXISTS, "ConsentGranted", path, "");
		}
		return failure("ConsentGranted", ValidationType.ONLY_EXISTS, "ConsentGranted", path, "",
