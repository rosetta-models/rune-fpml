...
public class AbstractFacilityContractEventOnlyExistsValidator implements ValidatorWithArg<AbstractFacilityContractEvent, Set<String>> {
	...
	public <T2 extends AbstractFacilityContractEvent> ValidationResult<AbstractFacilityContractEvent> validate(RosettaPath path, T2 o, Set<String> fields) {
		...
		if (setFields.equals(fields)) {
			return success("AbstractFacilityContractEvent", ValidationType.ONLY_EXISTS, "AbstractFacilityContractEvent", path, "");
		}
		return failure("AbstractFacilityContractEvent", ValidationType.ONLY_EXISTS, "AbstractFacilityContractEvent", path, "",
