...
public class FixedRateOptionBaseOnlyExistsValidator implements ValidatorWithArg<FixedRateOptionBase, Set<String>> {

	/* Casting is required to ensure types are output to ensure recompilation in Rosetta */
	@Override
	public <T2 extends FixedRateOptionBase> ValidationResult<FixedRateOptionBase> validate(RosettaPath path, T2 o, Set<String> fields) {
		...
		if (setFields.equals(fields)) {
			return success("FixedRateOptionBase", ValidationType.ONLY_EXISTS, "FixedRateOptionBase", path, "");
		}
		return failure("FixedRateOptionBase", ValidationType.ONLY_EXISTS, "FixedRateOptionBase", path, "",
