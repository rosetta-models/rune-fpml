...
public class LoanContractAdjustmentOnlyExistsValidator implements ValidatorWithArg<LoanContractAdjustment, Set<String>> {
	...
	public <T2 extends LoanContractAdjustment> ValidationResult<LoanContractAdjustment> validate(RosettaPath path, T2 o, Set<String> fields) {
		...
		if (setFields.equals(fields)) {
			return success("LoanContractAdjustment", ValidationType.ONLY_EXISTS, "LoanContractAdjustment", path, "");
		}
		return failure("LoanContractAdjustment", ValidationType.ONLY_EXISTS, "LoanContractAdjustment", path, "",
