...
public class EventStatusExceptionOnlyExistsValidator implements ValidatorWithArg<EventStatusException, Set<String>> {
	...
	public <T2 extends EventStatusException> ValidationResult<EventStatusException> validate(RosettaPath path, T2 o, Set<String> fields) {
		...
		if (setFields.equals(fields)) {
			return success("EventStatusException", ValidationType.ONLY_EXISTS, "EventStatusException", path, "");
		}
		return failure("EventStatusException", ValidationType.ONLY_EXISTS, "EventStatusException", path, "",
