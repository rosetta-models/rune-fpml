...
public class FacilityRateChangeEventOnlyExistsValidator implements ValidatorWithArg<FacilityRateChangeEvent, Set<String>> {

	/* Casting is required to ensure types are output to ensure recompilation in Rosetta */
	@Override
	public <T2 extends FacilityRateChangeEvent> ValidationResult<FacilityRateChangeEvent> validate(RosettaPath path, T2 o, Set<String> fields) {
		...
		if (setFields.equals(fields)) {
			return success("FacilityRateChangeEvent", ValidationType.ONLY_EXISTS, "FacilityRateChangeEvent", path, "");
		}
		return failure("FacilityRateChangeEvent", ValidationType.ONLY_EXISTS, "FacilityRateChangeEvent", path, "",
