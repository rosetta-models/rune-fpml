...
public class AccruingPikPaymentOnlyExistsValidator implements ValidatorWithArg<AccruingPikPayment, Set<String>> {
	...
	public <T2 extends AccruingPikPayment> ValidationResult<AccruingPikPayment> validate(RosettaPath path, T2 o, Set<String> fields) {
		...
		if (setFields.equals(fields)) {
			return success("AccruingPikPayment", ValidationType.ONLY_EXISTS, "AccruingPikPayment", path, "");
		}
		return failure("AccruingPikPayment", ValidationType.ONLY_EXISTS, "AccruingPikPayment", path, "",
