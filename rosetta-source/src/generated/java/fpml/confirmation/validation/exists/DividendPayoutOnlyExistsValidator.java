...
public class DividendPayoutOnlyExistsValidator implements ValidatorWithArg<DividendPayout, Set<String>> {
	...
	public <T2 extends DividendPayout> ValidationResult<DividendPayout> validate(RosettaPath path, T2 o, Set<String> fields) {
		Map<String, Boolean> fieldExistenceMap = ImmutableMap.<String, Boolean>builder()
				.put("dividendPayoutSequence", ExistenceChecker.isSet((DividendPayoutSequence) o.getDividendPayoutSequence()))
		...
		if (setFields.equals(fields)) {
			return success("DividendPayout", ValidationType.ONLY_EXISTS, "DividendPayout", path, "");
		}
		return failure("DividendPayout", ValidationType.ONLY_EXISTS, "DividendPayout", path, "",
