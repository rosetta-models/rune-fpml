...
public class CollateralAllocationRejectedOnlyExistsValidator implements ValidatorWithArg<CollateralAllocationRejected, Set<String>> {
	...
	public <T2 extends CollateralAllocationRejected> ValidationResult<CollateralAllocationRejected> validate(RosettaPath path, T2 o, Set<String> fields) {
		...
		if (setFields.equals(fields)) {
			return success("CollateralAllocationRejected", ValidationType.ONLY_EXISTS, "CollateralAllocationRejected", path, "");
		}
		return failure("CollateralAllocationRejected", ValidationType.ONLY_EXISTS, "CollateralAllocationRejected", path, "",
