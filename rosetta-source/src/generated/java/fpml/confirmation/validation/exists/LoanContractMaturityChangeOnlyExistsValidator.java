...
public class LoanContractMaturityChangeOnlyExistsValidator implements ValidatorWithArg<LoanContractMaturityChange, Set<String>> {
	...
	public <T2 extends LoanContractMaturityChange> ValidationResult<LoanContractMaturityChange> validate(RosettaPath path, T2 o, Set<String> fields) {
		Map<String, Boolean> fieldExistenceMap = ImmutableMap.<String, Boolean>builder()
				...
				.put("currentMaturityDate", ExistenceChecker.isSet((Date) o.getCurrentMaturityDate()))
				.put("priorMaturityDate", ExistenceChecker.isSet((Date) o.getPriorMaturityDate()))
				.build();
		...
		if (setFields.equals(fields)) {
			return success("LoanContractMaturityChange", ValidationType.ONLY_EXISTS, "LoanContractMaturityChange", path, "");
		}
		return failure("LoanContractMaturityChange", ValidationType.ONLY_EXISTS, "LoanContractMaturityChange", path, "",
