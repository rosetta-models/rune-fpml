...
public class LoanTradingCounterpartySettlementFundingFactorsOnlyExistsValidator implements ValidatorWithArg<LoanTradingCounterpartySettlementFundingFactors, Set<String>> {
	...
	public <T2 extends LoanTradingCounterpartySettlementFundingFactors> ValidationResult<LoanTradingCounterpartySettlementFundingFactors> validate(RosettaPath path, T2 o, Set<String> fields) {
		Map<String, Boolean> fieldExistenceMap = ImmutableMap.<String, Boolean>builder()
				.put("loanTradingCounterpartySettlementFundingFactorsSequence", ExistenceChecker.isSet((LoanTradingCounterpartySettlementFundingFactorsSequence) o.getLoanTradingCounterpartySettlementFundingFactorsSequence()))
		...
		if (setFields.equals(fields)) {
			return success("LoanTradingCounterpartySettlementFundingFactors", ValidationType.ONLY_EXISTS, "LoanTradingCounterpartySettlementFundingFactors", path, "");
		}
		return failure("LoanTradingCounterpartySettlementFundingFactors", ValidationType.ONLY_EXISTS, "LoanTradingCounterpartySettlementFundingFactors", path, "",
