...
public class UnderlyerInterestLegOnlyExistsValidator implements ValidatorWithArg<UnderlyerInterestLeg, Set<String>> {
	...
	public <T2 extends UnderlyerInterestLeg> ValidationResult<UnderlyerInterestLeg> validate(RosettaPath path, T2 o, Set<String> fields) {
		...
		if (setFields.equals(fields)) {
			return success("UnderlyerInterestLeg", ValidationType.ONLY_EXISTS, "UnderlyerInterestLeg", path, "");
		}
		return failure("UnderlyerInterestLeg", ValidationType.ONLY_EXISTS, "UnderlyerInterestLeg", path, "",
