...
public class AbstractLoanTradingNotificationOnlyExistsValidator implements ValidatorWithArg<AbstractLoanTradingNotification, Set<String>> {

	/* Casting is required to ensure types are output to ensure recompilation in Rosetta */
	@Override
	public <T2 extends AbstractLoanTradingNotification> ValidationResult<AbstractLoanTradingNotification> validate(RosettaPath path, T2 o, Set<String> fields) {
		...
		if (setFields.equals(fields)) {
			return success("AbstractLoanTradingNotification", ValidationType.ONLY_EXISTS, "AbstractLoanTradingNotification", path, "");
		}
		return failure("AbstractLoanTradingNotification", ValidationType.ONLY_EXISTS, "AbstractLoanTradingNotification", path, "",
