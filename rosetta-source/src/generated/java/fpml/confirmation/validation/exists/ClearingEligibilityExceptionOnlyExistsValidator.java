...
public class ClearingEligibilityExceptionOnlyExistsValidator implements ValidatorWithArg<ClearingEligibilityException, Set<String>> {
	...
	public <T2 extends ClearingEligibilityException> ValidationResult<ClearingEligibilityException> validate(RosettaPath path, T2 o, Set<String> fields) {
		...
		if (setFields.equals(fields)) {
			return success("ClearingEligibilityException", ValidationType.ONLY_EXISTS, "ClearingEligibilityException", path, "");
		}
		return failure("ClearingEligibilityException", ValidationType.ONLY_EXISTS, "ClearingEligibilityException", path, "",
