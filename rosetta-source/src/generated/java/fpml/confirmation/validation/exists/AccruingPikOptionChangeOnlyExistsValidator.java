...
public class AccruingPikOptionChangeOnlyExistsValidator implements ValidatorWithArg<AccruingPikOptionChange, Set<String>> {

	/* Casting is required to ensure types are output to ensure recompilation in Rosetta */
	@Override
	public <T2 extends AccruingPikOptionChange> ValidationResult<AccruingPikOptionChange> validate(RosettaPath path, T2 o, Set<String> fields) {
		...
		if (setFields.equals(fields)) {
			return success("AccruingPikOptionChange", ValidationType.ONLY_EXISTS, "AccruingPikOptionChange", path, "");
		}
		return failure("AccruingPikOptionChange", ValidationType.ONLY_EXISTS, "AccruingPikOptionChange", path, "",
