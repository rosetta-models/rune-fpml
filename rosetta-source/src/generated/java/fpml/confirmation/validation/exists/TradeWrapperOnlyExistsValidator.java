...
public class TradeWrapperOnlyExistsValidator implements ValidatorWithArg<TradeWrapper, Set<String>> {
	...
	public <T2 extends TradeWrapper> ValidationResult<TradeWrapper> validate(RosettaPath path, T2 o, Set<String> fields) {
		Map<String, Boolean> fieldExistenceMap = ImmutableMap.<String, Boolean>builder()
				.put("tradeOrInfoModel", ExistenceChecker.isSet((TradeOrInfoModel) o.getTradeOrInfoModel()))
				.build();
		...
		if (setFields.equals(fields)) {
			return success("TradeWrapper", ValidationType.ONLY_EXISTS, "TradeWrapper", path, "");
		}
		return failure("TradeWrapper", ValidationType.ONLY_EXISTS, "TradeWrapper", path, "",
