...
public class CommodityEuropeanExerciseOnlyExistsValidator implements ValidatorWithArg<CommodityEuropeanExercise, Set<String>> {
	...
	public <T2 extends CommodityEuropeanExercise> ValidationResult<CommodityEuropeanExercise> validate(RosettaPath path, T2 o, Set<String> fields) {
		Map<String, Boolean> fieldExistenceMap = ImmutableMap.<String, Boolean>builder()
				...
				.put("commodityEuropeanExerciseSequence", ExistenceChecker.isSet((CommodityEuropeanExerciseSequence) o.getCommodityEuropeanExerciseSequence()))
		...
		if (setFields.equals(fields)) {
			return success("CommodityEuropeanExercise", ValidationType.ONLY_EXISTS, "CommodityEuropeanExercise", path, "");
		}
		return failure("CommodityEuropeanExercise", ValidationType.ONLY_EXISTS, "CommodityEuropeanExercise", path, "",
