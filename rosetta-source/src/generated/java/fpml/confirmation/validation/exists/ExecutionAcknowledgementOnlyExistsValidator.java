...
public class ExecutionAcknowledgementOnlyExistsValidator implements ValidatorWithArg<ExecutionAcknowledgement, Set<String>> {
	...
	public <T2 extends ExecutionAcknowledgement> ValidationResult<ExecutionAcknowledgement> validate(RosettaPath path, T2 o, Set<String> fields) {
		...
		if (setFields.equals(fields)) {
			return success("ExecutionAcknowledgement", ValidationType.ONLY_EXISTS, "ExecutionAcknowledgement", path, "");
		}
		return failure("ExecutionAcknowledgement", ValidationType.ONLY_EXISTS, "ExecutionAcknowledgement", path, "",
