...
public class LoanAllocationSettlementDateFinalizationNotificationOnlyExistsValidator implements ValidatorWithArg<LoanAllocationSettlementDateFinalizationNotification, Set<String>> {

	/* Casting is required to ensure types are output to ensure recompilation in Rosetta */
	@Override
	public <T2 extends LoanAllocationSettlementDateFinalizationNotification> ValidationResult<LoanAllocationSettlementDateFinalizationNotification> validate(RosettaPath path, T2 o, Set<String> fields) {
		Map<String, Boolean> fieldExistenceMap = ImmutableMap.<String, Boolean>builder()
				...
				.put("settlementDateFinalization", ExistenceChecker.isSet((List<? extends LoanSettlementDateFinalizationEvent>) o.getSettlementDateFinalization()))
				...
				.put("facilityDetailsModel", ExistenceChecker.isSet((List<? extends FacilityDetailsModel>) o.getFacilityDetailsModel()))
		...
		if (setFields.equals(fields)) {
			return success("LoanAllocationSettlementDateFinalizationNotification", ValidationType.ONLY_EXISTS, "LoanAllocationSettlementDateFinalizationNotification", path, "");
		}
		return failure("LoanAllocationSettlementDateFinalizationNotification", ValidationType.ONLY_EXISTS, "LoanAllocationSettlementDateFinalizationNotification", path, "",
