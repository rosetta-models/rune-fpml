...
public class AccruingFeePaymentNotificationOnlyExistsValidator implements ValidatorWithArg<AccruingFeePaymentNotification, Set<String>> {

	/* Casting is required to ensure types are output to ensure recompilation in Rosetta */
	@Override
	public <T2 extends AccruingFeePaymentNotification> ValidationResult<AccruingFeePaymentNotification> validate(RosettaPath path, T2 o, Set<String> fields) {
		...
		if (setFields.equals(fields)) {
			return success("AccruingFeePaymentNotification", ValidationType.ONLY_EXISTS, "AccruingFeePaymentNotification", path, "");
		}
		return failure("AccruingFeePaymentNotification", ValidationType.ONLY_EXISTS, "AccruingFeePaymentNotification", path, "",
