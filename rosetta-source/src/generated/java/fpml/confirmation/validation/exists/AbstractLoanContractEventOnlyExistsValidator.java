...
public class AbstractLoanContractEventOnlyExistsValidator implements ValidatorWithArg<AbstractLoanContractEvent, Set<String>> {
	...
	public <T2 extends AbstractLoanContractEvent> ValidationResult<AbstractLoanContractEvent> validate(RosettaPath path, T2 o, Set<String> fields) {
		...
		if (setFields.equals(fields)) {
			return success("AbstractLoanContractEvent", ValidationType.ONLY_EXISTS, "AbstractLoanContractEvent", path, "");
		}
		return failure("AbstractLoanContractEvent", ValidationType.ONLY_EXISTS, "AbstractLoanContractEvent", path, "",
