...
public class AbstractLoanTradeEventOnlyExistsValidator implements ValidatorWithArg<AbstractLoanTradeEvent, Set<String>> {
	...
	public <T2 extends AbstractLoanTradeEvent> ValidationResult<AbstractLoanTradeEvent> validate(RosettaPath path, T2 o, Set<String> fields) {
		...
		if (setFields.equals(fields)) {
			return success("AbstractLoanTradeEvent", ValidationType.ONLY_EXISTS, "AbstractLoanTradeEvent", path, "");
		}
		return failure("AbstractLoanTradeEvent", ValidationType.ONLY_EXISTS, "AbstractLoanTradeEvent", path, "",
