...
public class LoanNotificationExceptionOnlyExistsValidator implements ValidatorWithArg<LoanNotificationException, Set<String>> {
	...
	public <T2 extends LoanNotificationException> ValidationResult<LoanNotificationException> validate(RosettaPath path, T2 o, Set<String> fields) {
		Map<String, Boolean> fieldExistenceMap = ImmutableMap.<String, Boolean>builder()
				...
				.put("loanNotificationExceptionSequence", ExistenceChecker.isSet((LoanNotificationExceptionSequence) o.getLoanNotificationExceptionSequence()))
				.build();
		...
		if (setFields.equals(fields)) {
			return success("LoanNotificationException", ValidationType.ONLY_EXISTS, "LoanNotificationException", path, "");
		}
		return failure("LoanNotificationException", ValidationType.ONLY_EXISTS, "LoanNotificationException", path, "",
