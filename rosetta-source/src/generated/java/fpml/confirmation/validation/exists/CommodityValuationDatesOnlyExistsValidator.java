...
public class CommodityValuationDatesOnlyExistsValidator implements ValidatorWithArg<CommodityValuationDates, Set<String>> {
	...
	public <T2 extends CommodityValuationDates> ValidationResult<CommodityValuationDates> validate(RosettaPath path, T2 o, Set<String> fields) {
		Map<String, Boolean> fieldExistenceMap = ImmutableMap.<String, Boolean>builder()
				...
				.put("commodityValuationDatesSequence", ExistenceChecker.isSet((CommodityValuationDatesSequence) o.getCommodityValuationDatesSequence()))
		...
		if (setFields.equals(fields)) {
			return success("CommodityValuationDates", ValidationType.ONLY_EXISTS, "CommodityValuationDates", path, "");
		}
		return failure("CommodityValuationDates", ValidationType.ONLY_EXISTS, "CommodityValuationDates", path, "",
