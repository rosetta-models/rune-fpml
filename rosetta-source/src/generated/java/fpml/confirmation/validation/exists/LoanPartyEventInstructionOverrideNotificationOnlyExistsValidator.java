...
public class LoanPartyEventInstructionOverrideNotificationOnlyExistsValidator implements ValidatorWithArg<LoanPartyEventInstructionOverrideNotification, Set<String>> {

	/* Casting is required to ensure types are output to ensure recompilation in Rosetta */
	@Override
	public <T2 extends LoanPartyEventInstructionOverrideNotification> ValidationResult<LoanPartyEventInstructionOverrideNotification> validate(RosettaPath path, T2 o, Set<String> fields) {
		Map<String, Boolean> fieldExistenceMap = ImmutableMap.<String, Boolean>builder()
				...
				.put("override", ExistenceChecker.isSet((EventInstructionOverride) o.getOverride()))
		...
		if (setFields.equals(fields)) {
			return success("LoanPartyEventInstructionOverrideNotification", ValidationType.ONLY_EXISTS, "LoanPartyEventInstructionOverrideNotification", path, "");
		}
		return failure("LoanPartyEventInstructionOverrideNotification", ValidationType.ONLY_EXISTS, "LoanPartyEventInstructionOverrideNotification", path, "",
