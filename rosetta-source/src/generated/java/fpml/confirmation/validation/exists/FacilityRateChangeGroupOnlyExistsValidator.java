...
public class FacilityRateChangeGroupOnlyExistsValidator implements ValidatorWithArg<FacilityRateChangeGroup, Set<String>> {

	/* Casting is required to ensure types are output to ensure recompilation in Rosetta */
	@Override
	public <T2 extends FacilityRateChangeGroup> ValidationResult<FacilityRateChangeGroup> validate(RosettaPath path, T2 o, Set<String> fields) {
		...
		if (setFields.equals(fields)) {
			return success("FacilityRateChangeGroup", ValidationType.ONLY_EXISTS, "FacilityRateChangeGroup", path, "");
		}
		return failure("FacilityRateChangeGroup", ValidationType.ONLY_EXISTS, "FacilityRateChangeGroup", path, "",
