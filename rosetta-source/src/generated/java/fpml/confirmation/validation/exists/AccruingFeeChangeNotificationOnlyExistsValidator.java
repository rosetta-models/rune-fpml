...
public class AccruingFeeChangeNotificationOnlyExistsValidator implements ValidatorWithArg<AccruingFeeChangeNotification, Set<String>> {

	/* Casting is required to ensure types are output to ensure recompilation in Rosetta */
	@Override
	public <T2 extends AccruingFeeChangeNotification> ValidationResult<AccruingFeeChangeNotification> validate(RosettaPath path, T2 o, Set<String> fields) {
		Map<String, Boolean> fieldExistenceMap = ImmutableMap.<String, Boolean>builder()
				...
				.put("accruingFeeChangeGroup", ExistenceChecker.isSet((AbstractFacilityEvent) o.getAccruingFeeChangeGroup()))
		...
		if (setFields.equals(fields)) {
			return success("AccruingFeeChangeNotification", ValidationType.ONLY_EXISTS, "AccruingFeeChangeNotification", path, "");
		}
		return failure("AccruingFeeChangeNotification", ValidationType.ONLY_EXISTS, "AccruingFeeChangeNotification", path, "",
