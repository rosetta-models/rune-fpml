...
public class AccruingFeeChangeOnlyExistsValidator implements ValidatorWithArg<AccruingFeeChange, Set<String>> {
	...
	public <T2 extends AccruingFeeChange> ValidationResult<AccruingFeeChange> validate(RosettaPath path, T2 o, Set<String> fields) {
		...
		if (setFields.equals(fields)) {
			return success("AccruingFeeChange", ValidationType.ONLY_EXISTS, "AccruingFeeChange", path, "");
		}
		return failure("AccruingFeeChange", ValidationType.ONLY_EXISTS, "AccruingFeeChange", path, "",
