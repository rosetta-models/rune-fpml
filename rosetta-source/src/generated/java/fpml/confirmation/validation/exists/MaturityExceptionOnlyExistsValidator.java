...
public class MaturityExceptionOnlyExistsValidator implements ValidatorWithArg<MaturityException, Set<String>> {
	...
	public <T2 extends MaturityException> ValidationResult<MaturityException> validate(RosettaPath path, T2 o, Set<String> fields) {
		...
		if (setFields.equals(fields)) {
			return success("MaturityException", ValidationType.ONLY_EXISTS, "MaturityException", path, "");
		}
		return failure("MaturityException", ValidationType.ONLY_EXISTS, "MaturityException", path, "",
