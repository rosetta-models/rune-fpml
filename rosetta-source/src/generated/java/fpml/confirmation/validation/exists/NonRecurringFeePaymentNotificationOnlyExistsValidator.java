...
public class NonRecurringFeePaymentNotificationOnlyExistsValidator implements ValidatorWithArg<NonRecurringFeePaymentNotification, Set<String>> {

	/* Casting is required to ensure types are output to ensure recompilation in Rosetta */
	@Override
	public <T2 extends NonRecurringFeePaymentNotification> ValidationResult<NonRecurringFeePaymentNotification> validate(RosettaPath path, T2 o, Set<String> fields) {
		...
		if (setFields.equals(fields)) {
			return success("NonRecurringFeePaymentNotification", ValidationType.ONLY_EXISTS, "NonRecurringFeePaymentNotification", path, "");
		}
		return failure("NonRecurringFeePaymentNotification", ValidationType.ONLY_EXISTS, "NonRecurringFeePaymentNotification", path, "",
