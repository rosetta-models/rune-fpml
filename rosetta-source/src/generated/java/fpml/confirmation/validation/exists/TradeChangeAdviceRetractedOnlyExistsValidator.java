...
public class TradeChangeAdviceRetractedOnlyExistsValidator implements ValidatorWithArg<TradeChangeAdviceRetracted, Set<String>> {
	...
	public <T2 extends TradeChangeAdviceRetracted> ValidationResult<TradeChangeAdviceRetracted> validate(RosettaPath path, T2 o, Set<String> fields) {
		...
		if (setFields.equals(fields)) {
			return success("TradeChangeAdviceRetracted", ValidationType.ONLY_EXISTS, "TradeChangeAdviceRetracted", path, "");
		}
		return failure("TradeChangeAdviceRetracted", ValidationType.ONLY_EXISTS, "TradeChangeAdviceRetracted", path, "",
