...
public class LoanTradeTransferFeeOwedNotificationOnlyExistsValidator implements ValidatorWithArg<LoanTradeTransferFeeOwedNotification, Set<String>> {

	/* Casting is required to ensure types are output to ensure recompilation in Rosetta */
	@Override
	public <T2 extends LoanTradeTransferFeeOwedNotification> ValidationResult<LoanTradeTransferFeeOwedNotification> validate(RosettaPath path, T2 o, Set<String> fields) {
		Map<String, Boolean> fieldExistenceMap = ImmutableMap.<String, Boolean>builder()
				...
				.put("feeOwed", ExistenceChecker.isSet((LoanTradeTransferFeeOwedEvent) o.getFeeOwed()))
		...
		if (setFields.equals(fields)) {
			return success("LoanTradeTransferFeeOwedNotification", ValidationType.ONLY_EXISTS, "LoanTradeTransferFeeOwedNotification", path, "");
		}
		return failure("LoanTradeTransferFeeOwedNotification", ValidationType.ONLY_EXISTS, "LoanTradeTransferFeeOwedNotification", path, "",
