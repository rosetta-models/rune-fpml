...
public class TradeReferenceInformationUpdateExceptionOnlyExistsValidator implements ValidatorWithArg<TradeReferenceInformationUpdateException, Set<String>> {
	...
	public <T2 extends TradeReferenceInformationUpdateException> ValidationResult<TradeReferenceInformationUpdateException> validate(RosettaPath path, T2 o, Set<String> fields) {
		...
		if (setFields.equals(fields)) {
			return success("TradeReferenceInformationUpdateException", ValidationType.ONLY_EXISTS, "TradeReferenceInformationUpdateException", path, "");
		}
		return failure("TradeReferenceInformationUpdateException", ValidationType.ONLY_EXISTS, "TradeReferenceInformationUpdateException", path, "",
