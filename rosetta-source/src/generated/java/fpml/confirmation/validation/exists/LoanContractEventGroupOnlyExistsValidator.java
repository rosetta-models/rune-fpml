...
public class LoanContractEventGroupOnlyExistsValidator implements ValidatorWithArg<LoanContractEventGroup, Set<String>> {

	/* Casting is required to ensure types are output to ensure recompilation in Rosetta */
	@Override
	public <T2 extends LoanContractEventGroup> ValidationResult<LoanContractEventGroup> validate(RosettaPath path, T2 o, Set<String> fields) {
		...
		if (setFields.equals(fields)) {
			return success("LoanContractEventGroup", ValidationType.ONLY_EXISTS, "LoanContractEventGroup", path, "");
		}
		return failure("LoanContractEventGroup", ValidationType.ONLY_EXISTS, "LoanContractEventGroup", path, "",
