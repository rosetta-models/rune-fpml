...
public class PenaltyRateExpiryOnlyExistsValidator implements ValidatorWithArg<PenaltyRateExpiry, Set<String>> {
	...
	public <T2 extends PenaltyRateExpiry> ValidationResult<PenaltyRateExpiry> validate(RosettaPath path, T2 o, Set<String> fields) {
		...
		if (setFields.equals(fields)) {
			return success("PenaltyRateExpiry", ValidationType.ONLY_EXISTS, "PenaltyRateExpiry", path, "");
		}
		return failure("PenaltyRateExpiry", ValidationType.ONLY_EXISTS, "PenaltyRateExpiry", path, "",
