...
public class NotificationMessageOnlyExistsValidator implements ValidatorWithArg<NotificationMessage, Set<String>> {
	...
	public <T2 extends NotificationMessage> ValidationResult<NotificationMessage> validate(RosettaPath path, T2 o, Set<String> fields) {
		...
		if (setFields.equals(fields)) {
			return success("NotificationMessage", ValidationType.ONLY_EXISTS, "NotificationMessage", path, "");
		}
		return failure("NotificationMessage", ValidationType.ONLY_EXISTS, "NotificationMessage", path, "",
