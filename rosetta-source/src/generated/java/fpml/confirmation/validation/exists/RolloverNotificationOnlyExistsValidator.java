...
public class RolloverNotificationOnlyExistsValidator implements ValidatorWithArg<RolloverNotification, Set<String>> {

	/* Casting is required to ensure types are output to ensure recompilation in Rosetta */
	@Override
	public <T2 extends RolloverNotification> ValidationResult<RolloverNotification> validate(RosettaPath path, T2 o, Set<String> fields) {
		Map<String, Boolean> fieldExistenceMap = ImmutableMap.<String, Boolean>builder()
				...
				.put("rollover", ExistenceChecker.isSet((Rollover) o.getRollover()))
		...
		if (setFields.equals(fields)) {
			return success("RolloverNotification", ValidationType.ONLY_EXISTS, "RolloverNotification", path, "");
		}
		return failure("RolloverNotification", ValidationType.ONLY_EXISTS, "RolloverNotification", path, "",
