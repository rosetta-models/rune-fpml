...
public class AllocationAcknowledgementOnlyExistsValidator implements ValidatorWithArg<AllocationAcknowledgement, Set<String>> {
	...
	public <T2 extends AllocationAcknowledgement> ValidationResult<AllocationAcknowledgement> validate(RosettaPath path, T2 o, Set<String> fields) {
		...
		if (setFields.equals(fields)) {
			return success("AllocationAcknowledgement", ValidationType.ONLY_EXISTS, "AllocationAcknowledgement", path, "");
		}
		return failure("AllocationAcknowledgement", ValidationType.ONLY_EXISTS, "AllocationAcknowledgement", path, "",
