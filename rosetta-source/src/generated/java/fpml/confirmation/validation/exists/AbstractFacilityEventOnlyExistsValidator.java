...
public class AbstractFacilityEventOnlyExistsValidator implements ValidatorWithArg<AbstractFacilityEvent, Set<String>> {
	...
	public <T2 extends AbstractFacilityEvent> ValidationResult<AbstractFacilityEvent> validate(RosettaPath path, T2 o, Set<String> fields) {
		...
		if (setFields.equals(fields)) {
			return success("AbstractFacilityEvent", ValidationType.ONLY_EXISTS, "AbstractFacilityEvent", path, "");
		}
		return failure("AbstractFacilityEvent", ValidationType.ONLY_EXISTS, "AbstractFacilityEvent", path, "",
