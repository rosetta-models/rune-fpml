...
public class RequestClearingOnlyExistsValidator implements ValidatorWithArg<RequestClearing, Set<String>> {
	...
	public <T2 extends RequestClearing> ValidationResult<RequestClearing> validate(RosettaPath path, T2 o, Set<String> fields) {
		...
		if (setFields.equals(fields)) {
			return success("RequestClearing", ValidationType.ONLY_EXISTS, "RequestClearing", path, "");
		}
		return failure("RequestClearing", ValidationType.ONLY_EXISTS, "RequestClearing", path, "",
