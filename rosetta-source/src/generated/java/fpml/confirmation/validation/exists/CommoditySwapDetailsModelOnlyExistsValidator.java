...
public class CommoditySwapDetailsModelOnlyExistsValidator implements ValidatorWithArg<CommoditySwapDetailsModel, Set<String>> {

	/* Casting is required to ensure types are output to ensure recompilation in Rosetta */
	@Override
	public <T2 extends CommoditySwapDetailsModel> ValidationResult<CommoditySwapDetailsModel> validate(RosettaPath path, T2 o, Set<String> fields) {
		Map<String, Boolean> fieldExistenceMap = ImmutableMap.<String, Boolean>builder()
				...
				.put("commoditySwapLeg", ExistenceChecker.isSet((List<? extends CommoditySwapLeg>) o.getCommoditySwapLeg()))
		...
		if (setFields.equals(fields)) {
			return success("CommoditySwapDetailsModel", ValidationType.ONLY_EXISTS, "CommoditySwapDetailsModel", path, "");
		}
		return failure("CommoditySwapDetailsModel", ValidationType.ONLY_EXISTS, "CommoditySwapDetailsModel", path, "",
