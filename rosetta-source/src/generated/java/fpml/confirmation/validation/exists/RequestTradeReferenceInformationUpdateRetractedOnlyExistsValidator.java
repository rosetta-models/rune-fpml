...
public class RequestTradeReferenceInformationUpdateRetractedOnlyExistsValidator implements ValidatorWithArg<RequestTradeReferenceInformationUpdateRetracted, Set<String>> {
	...
	public <T2 extends RequestTradeReferenceInformationUpdateRetracted> ValidationResult<RequestTradeReferenceInformationUpdateRetracted> validate(RosettaPath path, T2 o, Set<String> fields) {
		...
		if (setFields.equals(fields)) {
			return success("RequestTradeReferenceInformationUpdateRetracted", ValidationType.ONLY_EXISTS, "RequestTradeReferenceInformationUpdateRetracted", path, "");
		}
		return failure("RequestTradeReferenceInformationUpdateRetracted", ValidationType.ONLY_EXISTS, "RequestTradeReferenceInformationUpdateRetracted", path, "",
