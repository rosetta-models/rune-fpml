...
public class DefaultRateChangeOnlyExistsValidator implements ValidatorWithArg<DefaultRateChange, Set<String>> {
	...
	public <T2 extends DefaultRateChange> ValidationResult<DefaultRateChange> validate(RosettaPath path, T2 o, Set<String> fields) {
		...
		if (setFields.equals(fields)) {
			return success("DefaultRateChange", ValidationType.ONLY_EXISTS, "DefaultRateChange", path, "");
		}
		return failure("DefaultRateChange", ValidationType.ONLY_EXISTS, "DefaultRateChange", path, "",
