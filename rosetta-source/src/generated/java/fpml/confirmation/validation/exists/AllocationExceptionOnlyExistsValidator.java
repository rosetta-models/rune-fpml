...
public class AllocationExceptionOnlyExistsValidator implements ValidatorWithArg<AllocationException, Set<String>> {
	...
	public <T2 extends AllocationException> ValidationResult<AllocationException> validate(RosettaPath path, T2 o, Set<String> fields) {
		...
		if (setFields.equals(fields)) {
			return success("AllocationException", ValidationType.ONLY_EXISTS, "AllocationException", path, "");
		}
		return failure("AllocationException", ValidationType.ONLY_EXISTS, "AllocationException", path, "",
