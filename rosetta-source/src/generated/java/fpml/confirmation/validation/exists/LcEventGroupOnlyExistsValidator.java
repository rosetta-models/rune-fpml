...
public class LcEventGroupOnlyExistsValidator implements ValidatorWithArg<LcEventGroup, Set<String>> {

	/* Casting is required to ensure types are output to ensure recompilation in Rosetta */
	@Override
	public <T2 extends LcEventGroup> ValidationResult<LcEventGroup> validate(RosettaPath path, T2 o, Set<String> fields) {
		...
		if (setFields.equals(fields)) {
			return success("LcEventGroup", ValidationType.ONLY_EXISTS, "LcEventGroup", path, "");
		}
		return failure("LcEventGroup", ValidationType.ONLY_EXISTS, "LcEventGroup", path, "",
