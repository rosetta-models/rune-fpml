...
public class AccruingPikOptionOnlyExistsValidator implements ValidatorWithArg<AccruingPikOption, Set<String>> {
	...
	public <T2 extends AccruingPikOption> ValidationResult<AccruingPikOption> validate(RosettaPath path, T2 o, Set<String> fields) {
		...
		if (setFields.equals(fields)) {
			return success("AccruingPikOption", ValidationType.ONLY_EXISTS, "AccruingPikOption", path, "");
		}
		return failure("AccruingPikOption", ValidationType.ONLY_EXISTS, "AccruingPikOption", path, "",
