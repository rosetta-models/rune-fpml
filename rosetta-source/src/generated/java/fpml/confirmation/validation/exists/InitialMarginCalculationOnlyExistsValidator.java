...
public class InitialMarginCalculationOnlyExistsValidator implements ValidatorWithArg<InitialMarginCalculation, Set<String>> {
	...
	public <T2 extends InitialMarginCalculation> ValidationResult<InitialMarginCalculation> validate(RosettaPath path, T2 o, Set<String> fields) {
		Map<String, Boolean> fieldExistenceMap = ImmutableMap.<String, Boolean>builder()
				.put("initialMarginCalculationSequence0", ExistenceChecker.isSet((InitialMarginCalculationSequence0) o.getInitialMarginCalculationSequence0()))
				.put("initialMarginCalculationSequence1", ExistenceChecker.isSet((InitialMarginCalculationSequence1) o.getInitialMarginCalculationSequence1()))
