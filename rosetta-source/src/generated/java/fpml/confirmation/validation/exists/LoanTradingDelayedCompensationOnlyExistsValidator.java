...
public class LoanTradingDelayedCompensationOnlyExistsValidator implements ValidatorWithArg<LoanTradingDelayedCompensation, Set<String>> {
	...
	public <T2 extends LoanTradingDelayedCompensation> ValidationResult<LoanTradingDelayedCompensation> validate(RosettaPath path, T2 o, Set<String> fields) {
		Map<String, Boolean> fieldExistenceMap = ImmutableMap.<String, Boolean>builder()
				...
				.put("loanTradingSettlementAccrualsModel", ExistenceChecker.isSet((LoanTradingSettlementAccrualsModel) o.getLoanTradingSettlementAccrualsModel()))
				.build();
		...
		if (setFields.equals(fields)) {
			return success("LoanTradingDelayedCompensation", ValidationType.ONLY_EXISTS, "LoanTradingDelayedCompensation", path, "");
		}
		return failure("LoanTradingDelayedCompensation", ValidationType.ONLY_EXISTS, "LoanTradingDelayedCompensation", path, "",
