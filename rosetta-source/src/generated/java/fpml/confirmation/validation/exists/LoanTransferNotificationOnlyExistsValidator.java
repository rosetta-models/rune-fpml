...
public class LoanTransferNotificationOnlyExistsValidator implements ValidatorWithArg<LoanTransferNotification, Set<String>> {

	/* Casting is required to ensure types are output to ensure recompilation in Rosetta */
	@Override
	public <T2 extends LoanTransferNotification> ValidationResult<LoanTransferNotification> validate(RosettaPath path, T2 o, Set<String> fields) {
		Map<String, Boolean> fieldExistenceMap = ImmutableMap.<String, Boolean>builder()
				...
				.put("transferEvent", ExistenceChecker.isSet((LoanTradeEvent) o.getTransferEvent()))
				.put("transfer", ExistenceChecker.isSet((LoanTransfer) o.getTransfer()))
		...
		if (setFields.equals(fields)) {
			return success("LoanTransferNotification", ValidationType.ONLY_EXISTS, "LoanTransferNotification", path, "");
		}
		return failure("LoanTransferNotification", ValidationType.ONLY_EXISTS, "LoanTransferNotification", path, "",
