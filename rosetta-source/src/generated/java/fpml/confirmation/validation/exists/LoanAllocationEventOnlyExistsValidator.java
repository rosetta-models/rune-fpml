...
public class LoanAllocationEventOnlyExistsValidator implements ValidatorWithArg<LoanAllocationEvent, Set<String>> {
	...
	public <T2 extends LoanAllocationEvent> ValidationResult<LoanAllocationEvent> validate(RosettaPath path, T2 o, Set<String> fields) {
		...
		if (setFields.equals(fields)) {
			return success("LoanAllocationEvent", ValidationType.ONLY_EXISTS, "LoanAllocationEvent", path, "");
		}
		return failure("LoanAllocationEvent", ValidationType.ONLY_EXISTS, "LoanAllocationEvent", path, "",
