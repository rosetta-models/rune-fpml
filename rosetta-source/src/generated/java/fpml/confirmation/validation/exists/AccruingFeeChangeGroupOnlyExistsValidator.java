...
public class AccruingFeeChangeGroupOnlyExistsValidator implements ValidatorWithArg<AccruingFeeChangeGroup, Set<String>> {

	/* Casting is required to ensure types are output to ensure recompilation in Rosetta */
	@Override
	public <T2 extends AccruingFeeChangeGroup> ValidationResult<AccruingFeeChangeGroup> validate(RosettaPath path, T2 o, Set<String> fields) {
		...
		if (setFields.equals(fields)) {
			return success("AccruingFeeChangeGroup", ValidationType.ONLY_EXISTS, "AccruingFeeChangeGroup", path, "");
		}
		return failure("AccruingFeeChangeGroup", ValidationType.ONLY_EXISTS, "AccruingFeeChangeGroup", path, "",
