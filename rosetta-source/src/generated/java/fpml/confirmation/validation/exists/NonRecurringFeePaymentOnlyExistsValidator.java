...
public class NonRecurringFeePaymentOnlyExistsValidator implements ValidatorWithArg<NonRecurringFeePayment, Set<String>> {

	/* Casting is required to ensure types are output to ensure recompilation in Rosetta */
	@Override
	public <T2 extends NonRecurringFeePayment> ValidationResult<NonRecurringFeePayment> validate(RosettaPath path, T2 o, Set<String> fields) {
		...
		if (setFields.equals(fields)) {
			return success("NonRecurringFeePayment", ValidationType.ONLY_EXISTS, "NonRecurringFeePayment", path, "");
		}
		return failure("NonRecurringFeePayment", ValidationType.ONLY_EXISTS, "NonRecurringFeePayment", path, "",
