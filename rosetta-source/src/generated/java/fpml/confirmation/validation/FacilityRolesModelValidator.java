...
public class FacilityRolesModelValidator implements Validator<FacilityRolesModel> {
	...
	public ValidationResult<FacilityRolesModel> validate(RosettaPath path, FacilityRolesModel o) {
		...
		if (!isNullOrEmpty(error)) {
			return failure("FacilityRolesModel", ValidationType.CARDINALITY, "FacilityRolesModel", path, "", error);
		}
		return success("FacilityRolesModel", ValidationType.CARDINALITY, "FacilityRolesModel", path, "");
	}
		...
		return getComparisonResults(o)
			...
			.map(res -> {
				if (!isNullOrEmpty(res.getError())) {
					return failure("FacilityRolesModel", ValidationType.CARDINALITY, "FacilityRolesModel", path, "", res.getError());
				}
				return success("FacilityRolesModel", ValidationType.CARDINALITY, "FacilityRolesModel", path, "");
			})
			.collect(toList());
