...
public class AbstractLoanContractEventValidator implements Validator<AbstractLoanContractEvent> {
	...
	public ValidationResult<AbstractLoanContractEvent> validate(RosettaPath path, AbstractLoanContractEvent o) {
		...
		if (!isNullOrEmpty(error)) {
			return failure("AbstractLoanContractEvent", ValidationType.CARDINALITY, "AbstractLoanContractEvent", path, "", error);
		}
		return success("AbstractLoanContractEvent", ValidationType.CARDINALITY, "AbstractLoanContractEvent", path, "");
	}
		...
		return getComparisonResults(o)
			...
			.map(res -> {
				if (!isNullOrEmpty(res.getError())) {
					return failure("AbstractLoanContractEvent", ValidationType.CARDINALITY, "AbstractLoanContractEvent", path, "", res.getError());
				}
				return success("AbstractLoanContractEvent", ValidationType.CARDINALITY, "AbstractLoanContractEvent", path, "");
			})
			.collect(toList());
