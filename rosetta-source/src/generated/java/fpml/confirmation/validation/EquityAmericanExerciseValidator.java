...
public class EquityAmericanExerciseValidator implements Validator<EquityAmericanExercise> {
	...
	public ValidationResult<EquityAmericanExercise> validate(RosettaPath path, EquityAmericanExercise o) {
		...
		if (!isNullOrEmpty(error)) {
			return failure("EquityAmericanExercise", ValidationType.CARDINALITY, "EquityAmericanExercise", path, "", error);
		}
		return success("EquityAmericanExercise", ValidationType.CARDINALITY, "EquityAmericanExercise", path, "");
	}
		...
		return getComparisonResults(o)
			...
			.map(res -> {
				if (!isNullOrEmpty(res.getError())) {
					return failure("EquityAmericanExercise", ValidationType.CARDINALITY, "EquityAmericanExercise", path, "", res.getError());
				}
				return success("EquityAmericanExercise", ValidationType.CARDINALITY, "EquityAmericanExercise", path, "");
			})
			.collect(toList());
