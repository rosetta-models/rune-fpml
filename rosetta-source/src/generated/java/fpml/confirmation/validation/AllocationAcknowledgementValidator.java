...
public class AllocationAcknowledgementValidator implements Validator<AllocationAcknowledgement> {
	...
	public ValidationResult<AllocationAcknowledgement> validate(RosettaPath path, AllocationAcknowledgement o) {
		...
		if (!isNullOrEmpty(error)) {
			return failure("AllocationAcknowledgement", ValidationType.CARDINALITY, "AllocationAcknowledgement", path, "", error);
		}
		return success("AllocationAcknowledgement", ValidationType.CARDINALITY, "AllocationAcknowledgement", path, "");
	}
		...
		return getComparisonResults(o)
			...
			.map(res -> {
				if (!isNullOrEmpty(res.getError())) {
					return failure("AllocationAcknowledgement", ValidationType.CARDINALITY, "AllocationAcknowledgement", path, "", res.getError());
				}
				return success("AllocationAcknowledgement", ValidationType.CARDINALITY, "AllocationAcknowledgement", path, "");
			})
			.collect(toList());
