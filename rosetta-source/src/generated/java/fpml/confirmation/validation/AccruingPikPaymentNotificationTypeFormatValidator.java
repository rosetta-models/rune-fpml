...
public class AccruingPikPaymentNotificationTypeFormatValidator implements Validator<AccruingPikPaymentNotification> {
	...
	public ValidationResult<AccruingPikPaymentNotification> validate(RosettaPath path, AccruingPikPaymentNotification o) {
		...
		if (!isNullOrEmpty(error)) {
			return failure("AccruingPikPaymentNotification", ValidationType.TYPE_FORMAT, "AccruingPikPaymentNotification", path, "", error);
		}
		return success("AccruingPikPaymentNotification", ValidationType.TYPE_FORMAT, "AccruingPikPaymentNotification", path, "");
	}
		...
		return getComparisonResults(o)
			...
			.map(res -> {
				if (!isNullOrEmpty(res.getError())) {
					return failure("AccruingPikPaymentNotification", ValidationType.TYPE_FORMAT, "AccruingPikPaymentNotification", path, "", res.getError());
				}
				return success("AccruingPikPaymentNotification", ValidationType.TYPE_FORMAT, "AccruingPikPaymentNotification", path, "");
			})
			.collect(toList());
