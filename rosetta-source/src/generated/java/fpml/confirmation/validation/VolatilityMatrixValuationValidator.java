...
public class VolatilityMatrixValuationValidator implements Validator<VolatilityMatrixValuation> {
	...
	@Override
	public ValidationResult<VolatilityMatrixValuation> validate(RosettaPath path, VolatilityMatrixValuation o) {
		...
		if (!isNullOrEmpty(error)) {
			return failure("VolatilityMatrixValuation", ValidationType.CARDINALITY, "VolatilityMatrixValuation", path, "", error);
		}
		return success("VolatilityMatrixValuation", ValidationType.CARDINALITY, "VolatilityMatrixValuation", path, "");
	}
		...
		return getComparisonResults(o)
			...
			.map(res -> {
				if (!isNullOrEmpty(res.getError())) {
					return failure("VolatilityMatrixValuation", ValidationType.CARDINALITY, "VolatilityMatrixValuation", path, "", res.getError());
				}
				return success("VolatilityMatrixValuation", ValidationType.CARDINALITY, "VolatilityMatrixValuation", path, "");
			})
			.collect(toList());
