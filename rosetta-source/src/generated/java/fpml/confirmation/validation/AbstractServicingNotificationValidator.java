...
public class AbstractServicingNotificationValidator implements Validator<AbstractServicingNotification> {
	...
	public ValidationResult<AbstractServicingNotification> validate(RosettaPath path, AbstractServicingNotification o) {
		...
		if (!isNullOrEmpty(error)) {
			return failure("AbstractServicingNotification", ValidationType.CARDINALITY, "AbstractServicingNotification", path, "", error);
		}
		return success("AbstractServicingNotification", ValidationType.CARDINALITY, "AbstractServicingNotification", path, "");
	}
		...
		return getComparisonResults(o)
			...
			.map(res -> {
				if (!isNullOrEmpty(res.getError())) {
					return failure("AbstractServicingNotification", ValidationType.CARDINALITY, "AbstractServicingNotification", path, "", res.getError());
				}
				return success("AbstractServicingNotification", ValidationType.CARDINALITY, "AbstractServicingNotification", path, "");
			})
			.collect(toList());
