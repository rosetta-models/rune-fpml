...
public class RevolverValidator implements Validator<Revolver> {
	...
	@Override
	public ValidationResult<Revolver> validate(RosettaPath path, Revolver o) {
		...
		if (!isNullOrEmpty(error)) {
			return failure("Revolver", ValidationType.CARDINALITY, "Revolver", path, "", error);
		}
		return success("Revolver", ValidationType.CARDINALITY, "Revolver", path, "");
	}
		...
		return getComparisonResults(o)
			...
			.map(res -> {
				if (!isNullOrEmpty(res.getError())) {
					return failure("Revolver", ValidationType.CARDINALITY, "Revolver", path, "", res.getError());
				}
				return success("Revolver", ValidationType.CARDINALITY, "Revolver", path, "");
			})
			.collect(toList());
