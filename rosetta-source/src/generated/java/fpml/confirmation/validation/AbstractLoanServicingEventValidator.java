...
public class AbstractLoanServicingEventValidator implements Validator<AbstractLoanServicingEvent> {
	...
	@Override
	public ValidationResult<AbstractLoanServicingEvent> validate(RosettaPath path, AbstractLoanServicingEvent o) {
		...
		if (!isNullOrEmpty(error)) {
			return failure("AbstractLoanServicingEvent", ValidationType.CARDINALITY, "AbstractLoanServicingEvent", path, "", error);
		}
		return success("AbstractLoanServicingEvent", ValidationType.CARDINALITY, "AbstractLoanServicingEvent", path, "");
	}
		...
		return getComparisonResults(o)
			...
			.map(res -> {
				if (!isNullOrEmpty(res.getError())) {
					return failure("AbstractLoanServicingEvent", ValidationType.CARDINALITY, "AbstractLoanServicingEvent", path, "", res.getError());
				}
				return success("AbstractLoanServicingEvent", ValidationType.CARDINALITY, "AbstractLoanServicingEvent", path, "");
			})
			.collect(toList());
