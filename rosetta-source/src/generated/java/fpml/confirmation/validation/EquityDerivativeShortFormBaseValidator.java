...
public class EquityDerivativeShortFormBaseValidator implements Validator<EquityDerivativeShortFormBase> {
	...
	public ValidationResult<EquityDerivativeShortFormBase> validate(RosettaPath path, EquityDerivativeShortFormBase o) {
		...
		if (!isNullOrEmpty(error)) {
			return failure("EquityDerivativeShortFormBase", ValidationType.CARDINALITY, "EquityDerivativeShortFormBase", path, "", error);
		}
		return success("EquityDerivativeShortFormBase", ValidationType.CARDINALITY, "EquityDerivativeShortFormBase", path, "");
	}
		...
		return getComparisonResults(o)
			...
			.map(res -> {
				if (!isNullOrEmpty(res.getError())) {
					return failure("EquityDerivativeShortFormBase", ValidationType.CARDINALITY, "EquityDerivativeShortFormBase", path, "", res.getError());
				}
				return success("EquityDerivativeShortFormBase", ValidationType.CARDINALITY, "EquityDerivativeShortFormBase", path, "");
			})
			.collect(toList());
