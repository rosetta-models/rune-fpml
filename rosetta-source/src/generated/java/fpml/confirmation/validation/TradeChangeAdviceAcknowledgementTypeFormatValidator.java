...
public class TradeChangeAdviceAcknowledgementTypeFormatValidator implements Validator<TradeChangeAdviceAcknowledgement> {
	...
	public ValidationResult<TradeChangeAdviceAcknowledgement> validate(RosettaPath path, TradeChangeAdviceAcknowledgement o) {
		...
		if (!isNullOrEmpty(error)) {
			return failure("TradeChangeAdviceAcknowledgement", ValidationType.TYPE_FORMAT, "TradeChangeAdviceAcknowledgement", path, "", error);
		}
		return success("TradeChangeAdviceAcknowledgement", ValidationType.TYPE_FORMAT, "TradeChangeAdviceAcknowledgement", path, "");
	}
		...
		return getComparisonResults(o)
			...
			.map(res -> {
				if (!isNullOrEmpty(res.getError())) {
					return failure("TradeChangeAdviceAcknowledgement", ValidationType.TYPE_FORMAT, "TradeChangeAdviceAcknowledgement", path, "", res.getError());
				}
				return success("TradeChangeAdviceAcknowledgement", ValidationType.TYPE_FORMAT, "TradeChangeAdviceAcknowledgement", path, "");
			})
			.collect(toList());
