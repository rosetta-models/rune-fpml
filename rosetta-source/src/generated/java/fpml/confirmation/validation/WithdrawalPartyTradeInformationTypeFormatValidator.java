...
public class WithdrawalPartyTradeInformationTypeFormatValidator implements Validator<WithdrawalPartyTradeInformation> {
	...
	public ValidationResult<WithdrawalPartyTradeInformation> validate(RosettaPath path, WithdrawalPartyTradeInformation o) {
		...
		if (!isNullOrEmpty(error)) {
			return failure("WithdrawalPartyTradeInformation", ValidationType.TYPE_FORMAT, "WithdrawalPartyTradeInformation", path, "", error);
		}
		return success("WithdrawalPartyTradeInformation", ValidationType.TYPE_FORMAT, "WithdrawalPartyTradeInformation", path, "");
	}
		...
		return getComparisonResults(o)
			...
			.map(res -> {
				if (!isNullOrEmpty(res.getError())) {
					return failure("WithdrawalPartyTradeInformation", ValidationType.TYPE_FORMAT, "WithdrawalPartyTradeInformation", path, "", res.getError());
				}
				return success("WithdrawalPartyTradeInformation", ValidationType.TYPE_FORMAT, "WithdrawalPartyTradeInformation", path, "");
			})
			.collect(toList());
