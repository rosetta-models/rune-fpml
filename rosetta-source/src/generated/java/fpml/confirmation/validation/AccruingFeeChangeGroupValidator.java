...
public class AccruingFeeChangeGroupValidator implements Validator<AccruingFeeChangeGroup> {
	...
	public ValidationResult<AccruingFeeChangeGroup> validate(RosettaPath path, AccruingFeeChangeGroup o) {
		...
		if (!isNullOrEmpty(error)) {
			return failure("AccruingFeeChangeGroup", ValidationType.CARDINALITY, "AccruingFeeChangeGroup", path, "", error);
		}
		return success("AccruingFeeChangeGroup", ValidationType.CARDINALITY, "AccruingFeeChangeGroup", path, "");
	}
		...
		return getComparisonResults(o)
			...
			.map(res -> {
				if (!isNullOrEmpty(res.getError())) {
					return failure("AccruingFeeChangeGroup", ValidationType.CARDINALITY, "AccruingFeeChangeGroup", path, "", res.getError());
				}
				return success("AccruingFeeChangeGroup", ValidationType.CARDINALITY, "AccruingFeeChangeGroup", path, "");
			})
			.collect(toList());
