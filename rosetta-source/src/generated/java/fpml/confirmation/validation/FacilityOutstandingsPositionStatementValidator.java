...
public class FacilityOutstandingsPositionStatementValidator implements Validator<FacilityOutstandingsPositionStatement> {
	...
	public ValidationResult<FacilityOutstandingsPositionStatement> validate(RosettaPath path, FacilityOutstandingsPositionStatement o) {
		...
		if (!isNullOrEmpty(error)) {
			return failure("FacilityOutstandingsPositionStatement", ValidationType.CARDINALITY, "FacilityOutstandingsPositionStatement", path, "", error);
		}
		return success("FacilityOutstandingsPositionStatement", ValidationType.CARDINALITY, "FacilityOutstandingsPositionStatement", path, "");
	}
		...
		return getComparisonResults(o)
			...
			.map(res -> {
				if (!isNullOrEmpty(res.getError())) {
					return failure("FacilityOutstandingsPositionStatement", ValidationType.CARDINALITY, "FacilityOutstandingsPositionStatement", path, "", res.getError());
				}
				return success("FacilityOutstandingsPositionStatement", ValidationType.CARDINALITY, "FacilityOutstandingsPositionStatement", path, "");
			})
			.collect(toList());
