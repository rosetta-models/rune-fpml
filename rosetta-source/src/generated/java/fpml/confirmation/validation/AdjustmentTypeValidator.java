...
public class AdjustmentTypeValidator implements Validator<AdjustmentType> {
	...
	public ValidationResult<AdjustmentType> validate(RosettaPath path, AdjustmentType o) {
		...
		if (!isNullOrEmpty(error)) {
			return failure("AdjustmentType", ValidationType.CARDINALITY, "AdjustmentType", path, "", error);
		}
		return success("AdjustmentType", ValidationType.CARDINALITY, "AdjustmentType", path, "");
	}
		...
		return getComparisonResults(o)
			...
			.map(res -> {
				if (!isNullOrEmpty(res.getError())) {
					return failure("AdjustmentType", ValidationType.CARDINALITY, "AdjustmentType", path, "", res.getError());
				}
				return success("AdjustmentType", ValidationType.CARDINALITY, "AdjustmentType", path, "");
			})
			.collect(toList());
