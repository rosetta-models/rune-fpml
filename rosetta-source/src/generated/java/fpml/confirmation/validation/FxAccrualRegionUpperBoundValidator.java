...
public class FxAccrualRegionUpperBoundValidator implements Validator<FxAccrualRegionUpperBound> {
	...
	public ValidationResult<FxAccrualRegionUpperBound> validate(RosettaPath path, FxAccrualRegionUpperBound o) {
		...
		if (!isNullOrEmpty(error)) {
			return failure("FxAccrualRegionUpperBound", ValidationType.CARDINALITY, "FxAccrualRegionUpperBound", path, "", error);
		}
		return success("FxAccrualRegionUpperBound", ValidationType.CARDINALITY, "FxAccrualRegionUpperBound", path, "");
	}
		...
		return getComparisonResults(o)
			...
			.map(res -> {
				if (!isNullOrEmpty(res.getError())) {
					return failure("FxAccrualRegionUpperBound", ValidationType.CARDINALITY, "FxAccrualRegionUpperBound", path, "", res.getError());
				}
				return success("FxAccrualRegionUpperBound", ValidationType.CARDINALITY, "FxAccrualRegionUpperBound", path, "");
			})
			.collect(toList());
