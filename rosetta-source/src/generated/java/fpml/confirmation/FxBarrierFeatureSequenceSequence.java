 ...
 */
@RosettaDataType(value="FxBarrierFeatureSequenceSequence", builder=FxBarrierFeatureSequenceSequence.FxBarrierFeatureSequenceSequenceBuilderImpl.class, version="${project.version}")
