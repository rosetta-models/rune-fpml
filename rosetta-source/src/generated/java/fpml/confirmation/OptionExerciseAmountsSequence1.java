 ...
 */
@RosettaDataType(value="OptionExerciseAmountsSequence1", builder=OptionExerciseAmountsSequence1.OptionExerciseAmountsSequence1BuilderImpl.class, version="${project.version}")
