 ...
 */
@RosettaDataType(value="PartyAndAccountReferencesModel", builder=PartyAndAccountReferencesModel.PartyAndAccountReferencesModelBuilderImpl.class, version="${project.version}")
