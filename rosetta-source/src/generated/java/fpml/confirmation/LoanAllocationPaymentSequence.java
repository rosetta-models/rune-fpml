 ...
 */
@RosettaDataType(value="LoanAllocationPaymentSequence", builder=LoanAllocationPaymentSequence.LoanAllocationPaymentSequenceBuilderImpl.class, version="${project.version}")
