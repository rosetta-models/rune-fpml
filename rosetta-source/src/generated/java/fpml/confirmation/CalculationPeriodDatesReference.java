 ...
 */
@RosettaDataType(value="CalculationPeriodDatesReference", builder=CalculationPeriodDatesReference.CalculationPeriodDatesReferenceBuilderImpl.class, version="${project.version}")
