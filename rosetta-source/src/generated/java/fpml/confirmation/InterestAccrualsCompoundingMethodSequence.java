 ...
 */
@RosettaDataType(value="InterestAccrualsCompoundingMethodSequence", builder=InterestAccrualsCompoundingMethodSequence.InterestAccrualsCompoundingMethodSequenceBuilderImpl.class, version="${project.version}")
