 ...
 */
@RosettaDataType(value="NoTouchLowerBarrierObservation", builder=NoTouchLowerBarrierObservation.NoTouchLowerBarrierObservationBuilderImpl.class, version="${project.version}")
