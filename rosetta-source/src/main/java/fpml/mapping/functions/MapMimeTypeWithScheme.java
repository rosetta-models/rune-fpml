...
@ImplementedBy(MapMimeTypeWithScheme.MapMimeTypeWithSchemeDefault.class)
public abstract class MapMimeTypeWithScheme implements RosettaFunction {
	...
	*/
	...
	public static class MapMimeTypeWithSchemeDefault extends MapMimeTypeWithScheme {
		@Override
