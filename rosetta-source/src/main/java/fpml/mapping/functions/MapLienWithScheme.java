...
@ImplementedBy(MapLienWithScheme.MapLienWithSchemeDefault.class)
public abstract class MapLienWithScheme implements RosettaFunction {
	...
	*/
	...
	public static class MapLienWithSchemeDefault extends MapLienWithScheme {
		@Override
