...
@ImplementedBy(MapTrancheWithScheme.MapTrancheWithSchemeDefault.class)
public abstract class MapTrancheWithScheme implements RosettaFunction {
	...
	*/
	...
	public static class MapTrancheWithSchemeDefault extends MapTrancheWithScheme {
		@Override
