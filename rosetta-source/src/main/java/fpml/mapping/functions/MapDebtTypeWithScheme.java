...
@ImplementedBy(MapDebtTypeWithScheme.MapDebtTypeWithSchemeDefault.class)
public abstract class MapDebtTypeWithScheme implements RosettaFunction {
	...
	*/
	...
	public static class MapDebtTypeWithSchemeDefault extends MapDebtTypeWithScheme {
		@Override
