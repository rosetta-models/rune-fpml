...
@ImplementedBy(MapCountryWithScheme.MapCountryWithSchemeDefault.class)
public abstract class MapCountryWithScheme implements RosettaFunction {
	...
	*/
	...
	public static class MapCountryWithSchemeDefault extends MapCountryWithScheme {
		@Override
