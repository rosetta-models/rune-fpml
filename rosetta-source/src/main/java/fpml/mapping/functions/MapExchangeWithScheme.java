...
@ImplementedBy(MapExchangeWithScheme.MapExchangeWithSchemeDefault.class)
public abstract class MapExchangeWithScheme implements RosettaFunction {
	...
	*/
	...
	public static class MapExchangeWithSchemeDefault extends MapExchangeWithScheme {
		@Override
