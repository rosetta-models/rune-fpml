...
@ImplementedBy(MapCashCollateralInterestRateWithScheme.MapCashCollateralInterestRateWithSchemeDefault.class)
public abstract class MapCashCollateralInterestRateWithScheme implements RosettaFunction {
	...
	*/
	...
	public static class MapCashCollateralInterestRateWithSchemeDefault extends MapCashCollateralInterestRateWithScheme {
		@Override
