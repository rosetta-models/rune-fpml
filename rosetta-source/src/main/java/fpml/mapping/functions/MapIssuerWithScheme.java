...
@ImplementedBy(MapIssuerWithScheme.MapIssuerWithSchemeDefault.class)
public abstract class MapIssuerWithScheme implements RosettaFunction {
	...
	*/
	...
	public static class MapIssuerWithSchemeDefault extends MapIssuerWithScheme {
		@Override
