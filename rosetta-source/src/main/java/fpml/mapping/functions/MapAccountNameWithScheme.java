...
@ImplementedBy(MapAccountNameWithScheme.MapAccountNameWithSchemeDefault.class)
public abstract class MapAccountNameWithScheme implements RosettaFunction {
	...
	*/
	...
	public static class MapAccountNameWithSchemeDefault extends MapAccountNameWithScheme {
		@Override
