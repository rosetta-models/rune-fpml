...
@ImplementedBy(MapNameWithScheme.MapNameWithSchemeDefault.class)
public abstract class MapNameWithScheme implements RosettaFunction {
	...
	*/
	...
	public static class MapNameWithSchemeDefault extends MapNameWithScheme {
		@Override
