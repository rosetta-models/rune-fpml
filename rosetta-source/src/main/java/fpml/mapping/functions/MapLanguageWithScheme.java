...
@ImplementedBy(MapLanguageWithScheme.MapLanguageWithSchemeDefault.class)
public abstract class MapLanguageWithScheme implements RosettaFunction {
	...
	*/
	...
	public static class MapLanguageWithSchemeDefault extends MapLanguageWithScheme {
		@Override
