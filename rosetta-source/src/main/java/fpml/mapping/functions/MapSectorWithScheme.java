...
@ImplementedBy(MapSectorWithScheme.MapSectorWithSchemeDefault.class)
public abstract class MapSectorWithScheme implements RosettaFunction {
	...
	*/
	...
	public static class MapSectorWithSchemeDefault extends MapSectorWithScheme {
		@Override
