...
@ImplementedBy(MapAccountNumberWithScheme.MapAccountNumberWithSchemeDefault.class)
public abstract class MapAccountNumberWithScheme implements RosettaFunction {
	...
	*/
	...
	public static class MapAccountNumberWithSchemeDefault extends MapAccountNumberWithScheme {
		@Override
