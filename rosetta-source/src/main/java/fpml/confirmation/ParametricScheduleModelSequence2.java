 ...
 */
@RosettaDataType(value="ParametricScheduleModelSequence2", builder=ParametricScheduleModelSequence2.ParametricScheduleModelSequence2BuilderImpl.class, version="0.0.0.master-SNAPSHOT")
