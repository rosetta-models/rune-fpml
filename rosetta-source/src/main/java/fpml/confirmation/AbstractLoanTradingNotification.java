 ...
 */
@RosettaDataType(value="AbstractLoanTradingNotification", builder=AbstractLoanTradingNotification.AbstractLoanTradingNotificationBuilderImpl.class, version="0.0.0.master-SNAPSHOT")
