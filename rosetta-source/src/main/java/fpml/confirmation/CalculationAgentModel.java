...
import fpml.confirmation.CalculationAgentModel.CalculationAgentModelBuilder;
import fpml.confirmation.CalculationAgentModel.CalculationAgentModelBuilderImpl;
import fpml.confirmation.CalculationAgentModel.CalculationAgentModelImpl;
import fpml.confirmation.meta.CalculationAgentModelMeta;
 ...
 */
@RosettaDataType(value="CalculationAgentModel", builder=CalculationAgentModel.CalculationAgentModelBuilderImpl.class, version="0.0.0.master-SNAPSHOT")
public interface CalculationAgentModel extends RosettaModelObject {
	...
	interface CalculationAgentModelBuilder extends CalculationAgentModel, RosettaModelObjectBuilder {
		...
		CalculationAgentModel.CalculationAgentModelBuilder setCalculationAgentBusinessCenter(BusinessCenter calculationAgentBusinessCenter);
	...
	class CalculationAgentModelBuilderImpl implements CalculationAgentModel.CalculationAgentModelBuilder {
		...
		@Override
		@RosettaAttribute("calculationAgentBusinessCenter")
		public CalculationAgentModel.CalculationAgentModelBuilder setCalculationAgentBusinessCenter(BusinessCenter calculationAgentBusinessCenter) {
