 ...
 */
@RosettaDataType(value="DividendPaymentDateSequence", builder=DividendPaymentDateSequence.DividendPaymentDateSequenceBuilderImpl.class, version="0.0.0.master-SNAPSHOT")
