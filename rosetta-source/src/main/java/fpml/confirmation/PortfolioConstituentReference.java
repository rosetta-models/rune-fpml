 ...
 */
@RosettaDataType(value="PortfolioConstituentReference", builder=PortfolioConstituentReference.PortfolioConstituentReferenceBuilderImpl.class, version="0.0.0.master-SNAPSHOT")
