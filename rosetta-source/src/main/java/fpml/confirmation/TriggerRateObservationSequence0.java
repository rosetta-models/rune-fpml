 ...
 */
@RosettaDataType(value="TriggerRateObservationSequence0", builder=TriggerRateObservationSequence0.TriggerRateObservationSequence0BuilderImpl.class, version="0.0.0.master-SNAPSHOT")
