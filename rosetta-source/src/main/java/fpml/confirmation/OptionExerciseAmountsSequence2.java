 ...
 */
@RosettaDataType(value="OptionExerciseAmountsSequence2", builder=OptionExerciseAmountsSequence2.OptionExerciseAmountsSequence2BuilderImpl.class, version="0.0.0.master-SNAPSHOT")
