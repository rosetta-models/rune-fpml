...
import fpml.confirmation.validation.BondPriceAndYieldModelTypeFormatValidator;
import fpml.confirmation.validation.BondPriceAndYieldModelValidator;
import fpml.confirmation.validation.exists.BondPriceAndYieldModelOnlyExistsValidator;
...
public class BondPriceAndYieldModelMeta implements RosettaMetaData<BondPriceAndYieldModel> {
	...
	public List<Validator<? super BondPriceAndYieldModel>> dataRules(ValidatorFactory factory) {
		return Arrays.asList(
			factory.<fpml.confirmation.BondPriceAndYieldModel>create(fpml.confirmation.validation.datarule.BondPriceAndYieldModelChoice.class)
		);
	}
