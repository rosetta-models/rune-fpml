...
import fpml.confirmation.validation.PartyProfileChoiceTypeFormatValidator;
import fpml.confirmation.validation.PartyProfileChoiceValidator;
import fpml.confirmation.validation.exists.PartyProfileChoiceOnlyExistsValidator;
...
public class PartyProfileChoiceMeta implements RosettaMetaData<PartyProfileChoice> {
	...
	public List<Validator<? super PartyProfileChoice>> dataRules(ValidatorFactory factory) {
		return Arrays.asList(
			factory.<fpml.confirmation.PartyProfileChoice>create(fpml.confirmation.validation.datarule.PartyProfileChoiceChoice.class)
		);
	}
