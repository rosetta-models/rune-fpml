...
import fpml.confirmation.validation.NoTouchUpperBarrierObservationTypeFormatValidator;
import fpml.confirmation.validation.NoTouchUpperBarrierObservationValidator;
import fpml.confirmation.validation.exists.NoTouchUpperBarrierObservationOnlyExistsValidator;
...
public class NoTouchUpperBarrierObservationMeta implements RosettaMetaData<NoTouchUpperBarrierObservation> {
	...
	public List<Validator<? super NoTouchUpperBarrierObservation>> dataRules(ValidatorFactory factory) {
		return Arrays.asList(
			factory.<fpml.confirmation.NoTouchUpperBarrierObservation>create(fpml.confirmation.validation.datarule.NoTouchUpperBarrierObservationChoice.class)
		);
	}
