...
import fpml.confirmation.validation.PhysicalSettlementPeriodTypeFormatValidator;
import fpml.confirmation.validation.PhysicalSettlementPeriodValidator;
import fpml.confirmation.validation.exists.PhysicalSettlementPeriodOnlyExistsValidator;
...
public class PhysicalSettlementPeriodMeta implements RosettaMetaData<PhysicalSettlementPeriod> {
	...
	public List<Validator<? super PhysicalSettlementPeriod>> dataRules(ValidatorFactory factory) {
		return Arrays.asList(
			factory.<fpml.confirmation.PhysicalSettlementPeriod>create(fpml.confirmation.validation.datarule.PhysicalSettlementPeriodChoice.class)
		);
	}
