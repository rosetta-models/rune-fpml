...
import fpml.confirmation.validation.PaymentDatesTypeFormatValidator;
import fpml.confirmation.validation.PaymentDatesValidator;
import fpml.confirmation.validation.exists.PaymentDatesOnlyExistsValidator;
...
public class PaymentDatesMeta implements RosettaMetaData<PaymentDates> {
	...
	public List<Validator<? super PaymentDates>> dataRules(ValidatorFactory factory) {
		return Arrays.asList(
			factory.<fpml.confirmation.PaymentDates>create(fpml.confirmation.validation.datarule.PaymentDatesChoice.class)
		);
	}
