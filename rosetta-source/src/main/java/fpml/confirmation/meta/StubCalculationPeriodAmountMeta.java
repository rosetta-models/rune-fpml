...
import fpml.confirmation.validation.StubCalculationPeriodAmountTypeFormatValidator;
import fpml.confirmation.validation.StubCalculationPeriodAmountValidator;
import fpml.confirmation.validation.exists.StubCalculationPeriodAmountOnlyExistsValidator;
...
public class StubCalculationPeriodAmountMeta implements RosettaMetaData<StubCalculationPeriodAmount> {
	...
	public List<Validator<? super StubCalculationPeriodAmount>> dataRules(ValidatorFactory factory) {
		return Arrays.asList(
			factory.<fpml.confirmation.StubCalculationPeriodAmount>create(fpml.confirmation.validation.datarule.StubCalculationPeriodAmountChoice.class)
		);
	}
