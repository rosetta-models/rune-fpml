...
public class CollateralAllocationAcknowledgementTypeFormatValidator implements Validator<CollateralAllocationAcknowledgement> {
	...
	public ValidationResult<CollateralAllocationAcknowledgement> validate(RosettaPath path, CollateralAllocationAcknowledgement o) {
		...
		if (!isNullOrEmpty(error)) {
			return failure("CollateralAllocationAcknowledgement", ValidationType.TYPE_FORMAT, "CollateralAllocationAcknowledgement", path, "", error);
		}
		return success("CollateralAllocationAcknowledgement", ValidationType.TYPE_FORMAT, "CollateralAllocationAcknowledgement", path, "");
	}
		...
		return getComparisonResults(o)
			...
			.map(res -> {
				if (!isNullOrEmpty(res.getError())) {
					return failure("CollateralAllocationAcknowledgement", ValidationType.TYPE_FORMAT, "CollateralAllocationAcknowledgement", path, "", res.getError());
				}
				return success("CollateralAllocationAcknowledgement", ValidationType.TYPE_FORMAT, "CollateralAllocationAcknowledgement", path, "");
			})
			.collect(toList());
