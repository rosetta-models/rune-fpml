...
public class CoalPhysicalLegOnlyExistsValidator implements ValidatorWithArg<CoalPhysicalLeg, Set<String>> {
	...
	public <T2 extends CoalPhysicalLeg> ValidationResult<CoalPhysicalLeg> validate(RosettaPath path, T2 o, Set<String> fields) {
		...
		if (setFields.equals(fields)) {
			return success("CoalPhysicalLeg", ValidationType.ONLY_EXISTS, "CoalPhysicalLeg", path, "");
		}
		return failure("CoalPhysicalLeg", ValidationType.ONLY_EXISTS, "CoalPhysicalLeg", path, "",
