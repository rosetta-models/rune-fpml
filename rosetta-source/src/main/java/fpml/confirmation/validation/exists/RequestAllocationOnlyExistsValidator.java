...
public class RequestAllocationOnlyExistsValidator implements ValidatorWithArg<RequestAllocation, Set<String>> {
	...
	public <T2 extends RequestAllocation> ValidationResult<RequestAllocation> validate(RosettaPath path, T2 o, Set<String> fields) {
		...
		if (setFields.equals(fields)) {
			return success("RequestAllocation", ValidationType.ONLY_EXISTS, "RequestAllocation", path, "");
		}
		return failure("RequestAllocation", ValidationType.ONLY_EXISTS, "RequestAllocation", path, "",
