...
public class CorrectableRequestMessageOnlyExistsValidator implements ValidatorWithArg<CorrectableRequestMessage, Set<String>> {
	...
	public <T2 extends CorrectableRequestMessage> ValidationResult<CorrectableRequestMessage> validate(RosettaPath path, T2 o, Set<String> fields) {
		...
		if (setFields.equals(fields)) {
			return success("CorrectableRequestMessage", ValidationType.ONLY_EXISTS, "CorrectableRequestMessage", path, "");
		}
		return failure("CorrectableRequestMessage", ValidationType.ONLY_EXISTS, "CorrectableRequestMessage", path, "",
