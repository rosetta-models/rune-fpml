...
public class FixedRateOptionChangeOnlyExistsValidator implements ValidatorWithArg<FixedRateOptionChange, Set<String>> {

	/* Casting is required to ensure types are output to ensure recompilation in Rosetta */
	@Override
	public <T2 extends FixedRateOptionChange> ValidationResult<FixedRateOptionChange> validate(RosettaPath path, T2 o, Set<String> fields) {
		...
		if (setFields.equals(fields)) {
			return success("FixedRateOptionChange", ValidationType.ONLY_EXISTS, "FixedRateOptionChange", path, "");
		}
		return failure("FixedRateOptionChange", ValidationType.ONLY_EXISTS, "FixedRateOptionChange", path, "",
