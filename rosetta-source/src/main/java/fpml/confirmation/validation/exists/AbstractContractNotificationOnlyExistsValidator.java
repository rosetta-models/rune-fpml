...
public class AbstractContractNotificationOnlyExistsValidator implements ValidatorWithArg<AbstractContractNotification, Set<String>> {
	...
	public <T2 extends AbstractContractNotification> ValidationResult<AbstractContractNotification> validate(RosettaPath path, T2 o, Set<String> fields) {
		...
		if (setFields.equals(fields)) {
			return success("AbstractContractNotification", ValidationType.ONLY_EXISTS, "AbstractContractNotification", path, "");
		}
		return failure("AbstractContractNotification", ValidationType.ONLY_EXISTS, "AbstractContractNotification", path, "",
