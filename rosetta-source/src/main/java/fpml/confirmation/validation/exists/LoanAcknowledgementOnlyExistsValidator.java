...
public class LoanAcknowledgementOnlyExistsValidator implements ValidatorWithArg<LoanAcknowledgement, Set<String>> {
	...
	public <T2 extends LoanAcknowledgement> ValidationResult<LoanAcknowledgement> validate(RosettaPath path, T2 o, Set<String> fields) {
		...
		if (setFields.equals(fields)) {
			return success("LoanAcknowledgement", ValidationType.ONLY_EXISTS, "LoanAcknowledgement", path, "");
		}
		return failure("LoanAcknowledgement", ValidationType.ONLY_EXISTS, "LoanAcknowledgement", path, "",
