...
public class ExecutionAdviceAcknowledgementOnlyExistsValidator implements ValidatorWithArg<ExecutionAdviceAcknowledgement, Set<String>> {
	...
	public <T2 extends ExecutionAdviceAcknowledgement> ValidationResult<ExecutionAdviceAcknowledgement> validate(RosettaPath path, T2 o, Set<String> fields) {
		...
		if (setFields.equals(fields)) {
			return success("ExecutionAdviceAcknowledgement", ValidationType.ONLY_EXISTS, "ExecutionAdviceAcknowledgement", path, "");
		}
		return failure("ExecutionAdviceAcknowledgement", ValidationType.ONLY_EXISTS, "ExecutionAdviceAcknowledgement", path, "",
