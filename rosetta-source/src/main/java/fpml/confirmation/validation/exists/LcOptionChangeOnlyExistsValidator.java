...
public class LcOptionChangeOnlyExistsValidator implements ValidatorWithArg<LcOptionChange, Set<String>> {

	/* Casting is required to ensure types are output to ensure recompilation in Rosetta */
	@Override
	public <T2 extends LcOptionChange> ValidationResult<LcOptionChange> validate(RosettaPath path, T2 o, Set<String> fields) {
		...
		if (setFields.equals(fields)) {
			return success("LcOptionChange", ValidationType.ONLY_EXISTS, "LcOptionChange", path, "");
		}
		return failure("LcOptionChange", ValidationType.ONLY_EXISTS, "LcOptionChange", path, "",
