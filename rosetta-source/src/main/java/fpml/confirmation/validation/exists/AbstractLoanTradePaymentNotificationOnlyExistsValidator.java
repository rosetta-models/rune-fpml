...
public class AbstractLoanTradePaymentNotificationOnlyExistsValidator implements ValidatorWithArg<AbstractLoanTradePaymentNotification, Set<String>> {

	/* Casting is required to ensure types are output to ensure recompilation in Rosetta */
	@Override
	public <T2 extends AbstractLoanTradePaymentNotification> ValidationResult<AbstractLoanTradePaymentNotification> validate(RosettaPath path, T2 o, Set<String> fields) {
		...
		if (setFields.equals(fields)) {
			return success("AbstractLoanTradePaymentNotification", ValidationType.ONLY_EXISTS, "AbstractLoanTradePaymentNotification", path, "");
		}
		return failure("AbstractLoanTradePaymentNotification", ValidationType.ONLY_EXISTS, "AbstractLoanTradePaymentNotification", path, "",
