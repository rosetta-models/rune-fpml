...
public class FxPerformanceSwapOnlyExistsValidator implements ValidatorWithArg<FxPerformanceSwap, Set<String>> {
	...
	public <T2 extends FxPerformanceSwap> ValidationResult<FxPerformanceSwap> validate(RosettaPath path, T2 o, Set<String> fields) {
		...
		if (setFields.equals(fields)) {
			return success("FxPerformanceSwap", ValidationType.ONLY_EXISTS, "FxPerformanceSwap", path, "");
		}
		return failure("FxPerformanceSwap", ValidationType.ONLY_EXISTS, "FxPerformanceSwap", path, "",
