...
public class FacilityExtensionFeePaymentOnlyExistsValidator implements ValidatorWithArg<FacilityExtensionFeePayment, Set<String>> {
	...
	public <T2 extends FacilityExtensionFeePayment> ValidationResult<FacilityExtensionFeePayment> validate(RosettaPath path, T2 o, Set<String> fields) {
		...
		if (setFields.equals(fields)) {
			return success("FacilityExtensionFeePayment", ValidationType.ONLY_EXISTS, "FacilityExtensionFeePayment", path, "");
		}
		return failure("FacilityExtensionFeePayment", ValidationType.ONLY_EXISTS, "FacilityExtensionFeePayment", path, "",
