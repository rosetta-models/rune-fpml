...
public class FloatingRateOptionChangeOnlyExistsValidator implements ValidatorWithArg<FloatingRateOptionChange, Set<String>> {

	/* Casting is required to ensure types are output to ensure recompilation in Rosetta */
	@Override
	public <T2 extends FloatingRateOptionChange> ValidationResult<FloatingRateOptionChange> validate(RosettaPath path, T2 o, Set<String> fields) {
		...
		if (setFields.equals(fields)) {
			return success("FloatingRateOptionChange", ValidationType.ONLY_EXISTS, "FloatingRateOptionChange", path, "");
		}
		return failure("FloatingRateOptionChange", ValidationType.ONLY_EXISTS, "FloatingRateOptionChange", path, "",
