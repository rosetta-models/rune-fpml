...
public class LoanAllocationSettlementTaskNotificationOnlyExistsValidator implements ValidatorWithArg<LoanAllocationSettlementTaskNotification, Set<String>> {

	/* Casting is required to ensure types are output to ensure recompilation in Rosetta */
	@Override
	public <T2 extends LoanAllocationSettlementTaskNotification> ValidationResult<LoanAllocationSettlementTaskNotification> validate(RosettaPath path, T2 o, Set<String> fields) {
		Map<String, Boolean> fieldExistenceMap = ImmutableMap.<String, Boolean>builder()
				...
				.put("task", ExistenceChecker.isSet((List<? extends LoanAllocationSettlementTask>) o.getTask()))
		...
		if (setFields.equals(fields)) {
			return success("LoanAllocationSettlementTaskNotification", ValidationType.ONLY_EXISTS, "LoanAllocationSettlementTaskNotification", path, "");
		}
		return failure("LoanAllocationSettlementTaskNotification", ValidationType.ONLY_EXISTS, "LoanAllocationSettlementTaskNotification", path, "",
