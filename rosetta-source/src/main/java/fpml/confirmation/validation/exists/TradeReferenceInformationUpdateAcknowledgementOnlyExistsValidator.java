...
public class TradeReferenceInformationUpdateAcknowledgementOnlyExistsValidator implements ValidatorWithArg<TradeReferenceInformationUpdateAcknowledgement, Set<String>> {
	...
	public <T2 extends TradeReferenceInformationUpdateAcknowledgement> ValidationResult<TradeReferenceInformationUpdateAcknowledgement> validate(RosettaPath path, T2 o, Set<String> fields) {
		...
		if (setFields.equals(fields)) {
			return success("TradeReferenceInformationUpdateAcknowledgement", ValidationType.ONLY_EXISTS, "TradeReferenceInformationUpdateAcknowledgement", path, "");
		}
		return failure("TradeReferenceInformationUpdateAcknowledgement", ValidationType.ONLY_EXISTS, "TradeReferenceInformationUpdateAcknowledgement", path, "",
