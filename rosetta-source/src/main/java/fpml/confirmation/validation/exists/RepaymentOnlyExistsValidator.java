...
public class RepaymentOnlyExistsValidator implements ValidatorWithArg<Repayment, Set<String>> {
	...
	public <T2 extends Repayment> ValidationResult<Repayment> validate(RosettaPath path, T2 o, Set<String> fields) {
		Map<String, Boolean> fieldExistenceMap = ImmutableMap.<String, Boolean>builder()
				...
				.put("repaymentTypeModel", ExistenceChecker.isSet((RepaymentTypeModel) o.getRepaymentTypeModel()))
				.build();
		...
		if (setFields.equals(fields)) {
			return success("Repayment", ValidationType.ONLY_EXISTS, "Repayment", path, "");
		}
		return failure("Repayment", ValidationType.ONLY_EXISTS, "Repayment", path, "",
