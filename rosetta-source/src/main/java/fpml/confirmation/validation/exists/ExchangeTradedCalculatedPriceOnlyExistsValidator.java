...
public class ExchangeTradedCalculatedPriceOnlyExistsValidator implements ValidatorWithArg<ExchangeTradedCalculatedPrice, Set<String>> {
	...
	public <T2 extends ExchangeTradedCalculatedPrice> ValidationResult<ExchangeTradedCalculatedPrice> validate(RosettaPath path, T2 o, Set<String> fields) {
		...
		if (setFields.equals(fields)) {
			return success("ExchangeTradedCalculatedPrice", ValidationType.ONLY_EXISTS, "ExchangeTradedCalculatedPrice", path, "");
		}
		return failure("ExchangeTradedCalculatedPrice", ValidationType.ONLY_EXISTS, "ExchangeTradedCalculatedPrice", path, "",
