...
public class GasProductOnlyExistsValidator implements ValidatorWithArg<GasProduct, Set<String>> {
	...
	public <T2 extends GasProduct> ValidationResult<GasProduct> validate(RosettaPath path, T2 o, Set<String> fields) {
		Map<String, Boolean> fieldExistenceMap = ImmutableMap.<String, Boolean>builder()
				.put("_type", ExistenceChecker.isSet((GasProductTypeEnum) o.get_type()))
		...
		if (setFields.equals(fields)) {
			return success("GasProduct", ValidationType.ONLY_EXISTS, "GasProduct", path, "");
		}
		return failure("GasProduct", ValidationType.ONLY_EXISTS, "GasProduct", path, "",
