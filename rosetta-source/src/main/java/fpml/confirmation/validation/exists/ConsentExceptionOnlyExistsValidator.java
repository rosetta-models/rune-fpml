...
public class ConsentExceptionOnlyExistsValidator implements ValidatorWithArg<ConsentException, Set<String>> {
	...
	public <T2 extends ConsentException> ValidationResult<ConsentException> validate(RosettaPath path, T2 o, Set<String> fields) {
		...
		if (setFields.equals(fields)) {
			return success("ConsentException", ValidationType.ONLY_EXISTS, "ConsentException", path, "");
		}
		return failure("ConsentException", ValidationType.ONLY_EXISTS, "ConsentException", path, "",
