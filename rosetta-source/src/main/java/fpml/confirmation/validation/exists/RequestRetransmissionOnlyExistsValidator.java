...
public class RequestRetransmissionOnlyExistsValidator implements ValidatorWithArg<RequestRetransmission, Set<String>> {
	...
	public <T2 extends RequestRetransmission> ValidationResult<RequestRetransmission> validate(RosettaPath path, T2 o, Set<String> fields) {
		Map<String, Boolean> fieldExistenceMap = ImmutableMap.<String, Boolean>builder()
				...
				.put("portfolioReferenceOrReportIdentificationModel", ExistenceChecker.isSet((PortfolioReferenceOrReportIdentificationModel) o.getPortfolioReferenceOrReportIdentificationModel()))
		...
		if (setFields.equals(fields)) {
			return success("RequestRetransmission", ValidationType.ONLY_EXISTS, "RequestRetransmission", path, "");
		}
		return failure("RequestRetransmission", ValidationType.ONLY_EXISTS, "RequestRetransmission", path, "",
