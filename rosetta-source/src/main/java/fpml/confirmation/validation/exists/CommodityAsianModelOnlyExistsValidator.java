...
public class CommodityAsianModelOnlyExistsValidator implements ValidatorWithArg<CommodityAsianModel, Set<String>> {

	/* Casting is required to ensure types are output to ensure recompilation in Rosetta */
	@Override
	public <T2 extends CommodityAsianModel> ValidationResult<CommodityAsianModel> validate(RosettaPath path, T2 o, Set<String> fields) {
		...
		if (setFields.equals(fields)) {
			return success("CommodityAsianModel", ValidationType.ONLY_EXISTS, "CommodityAsianModel", path, "");
		}
		return failure("CommodityAsianModel", ValidationType.ONLY_EXISTS, "CommodityAsianModel", path, "",
