...
public class FloatingRateOptionBaseOnlyExistsValidator implements ValidatorWithArg<FloatingRateOptionBase, Set<String>> {

	/* Casting is required to ensure types are output to ensure recompilation in Rosetta */
	@Override
	public <T2 extends FloatingRateOptionBase> ValidationResult<FloatingRateOptionBase> validate(RosettaPath path, T2 o, Set<String> fields) {
		...
		if (setFields.equals(fields)) {
			return success("FloatingRateOptionBase", ValidationType.ONLY_EXISTS, "FloatingRateOptionBase", path, "");
		}
		return failure("FloatingRateOptionBase", ValidationType.ONLY_EXISTS, "FloatingRateOptionBase", path, "",
