...
public class TradePackageOnlyExistsValidator implements ValidatorWithArg<TradePackage, Set<String>> {
	...
	public <T2 extends TradePackage> ValidationResult<TradePackage> validate(RosettaPath path, T2 o, Set<String> fields) {
		Map<String, Boolean> fieldExistenceMap = ImmutableMap.<String, Boolean>builder()
				...
				.put("tradeReferenceInformationModel", ExistenceChecker.isSet((List<? extends TradeReferenceInformationModel>) o.getTradeReferenceInformationModel()))
		...
		if (setFields.equals(fields)) {
			return success("TradePackage", ValidationType.ONLY_EXISTS, "TradePackage", path, "");
		}
		return failure("TradePackage", ValidationType.ONLY_EXISTS, "TradePackage", path, "",
