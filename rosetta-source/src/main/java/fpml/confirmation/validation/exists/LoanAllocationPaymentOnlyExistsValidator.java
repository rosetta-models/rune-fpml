...
public class LoanAllocationPaymentOnlyExistsValidator implements ValidatorWithArg<LoanAllocationPayment, Set<String>> {
	...
	public <T2 extends LoanAllocationPayment> ValidationResult<LoanAllocationPayment> validate(RosettaPath path, T2 o, Set<String> fields) {
		Map<String, Boolean> fieldExistenceMap = ImmutableMap.<String, Boolean>builder()
				...
				.put("loanAllocationPaymentSequence", ExistenceChecker.isSet((List<? extends LoanAllocationPaymentSequence>) o.getLoanAllocationPaymentSequence()))
				.build();
		...
		if (setFields.equals(fields)) {
			return success("LoanAllocationPayment", ValidationType.ONLY_EXISTS, "LoanAllocationPayment", path, "");
		}
		return failure("LoanAllocationPayment", ValidationType.ONLY_EXISTS, "LoanAllocationPayment", path, "",
