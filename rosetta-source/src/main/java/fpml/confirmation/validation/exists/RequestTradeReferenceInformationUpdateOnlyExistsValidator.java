...
public class RequestTradeReferenceInformationUpdateOnlyExistsValidator implements ValidatorWithArg<RequestTradeReferenceInformationUpdate, Set<String>> {
	...
	public <T2 extends RequestTradeReferenceInformationUpdate> ValidationResult<RequestTradeReferenceInformationUpdate> validate(RosettaPath path, T2 o, Set<String> fields) {
		...
		if (setFields.equals(fields)) {
			return success("RequestTradeReferenceInformationUpdate", ValidationType.ONLY_EXISTS, "RequestTradeReferenceInformationUpdate", path, "");
		}
		return failure("RequestTradeReferenceInformationUpdate", ValidationType.ONLY_EXISTS, "RequestTradeReferenceInformationUpdate", path, "",
