...
public class FloatingStrikePriceOnlyExistsValidator implements ValidatorWithArg<FloatingStrikePrice, Set<String>> {
	...
	public <T2 extends FloatingStrikePrice> ValidationResult<FloatingStrikePrice> validate(RosettaPath path, T2 o, Set<String> fields) {
		...
		if (setFields.equals(fields)) {
			return success("FloatingStrikePrice", ValidationType.ONLY_EXISTS, "FloatingStrikePrice", path, "");
		}
		return failure("FloatingStrikePrice", ValidationType.ONLY_EXISTS, "FloatingStrikePrice", path, "",
