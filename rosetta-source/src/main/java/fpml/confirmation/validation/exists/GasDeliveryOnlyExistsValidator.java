...
public class GasDeliveryOnlyExistsValidator implements ValidatorWithArg<GasDelivery, Set<String>> {
	...
	public <T2 extends GasDelivery> ValidationResult<GasDelivery> validate(RosettaPath path, T2 o, Set<String> fields) {
		Map<String, Boolean> fieldExistenceMap = ImmutableMap.<String, Boolean>builder()
				.put("commodityDeliveryPointsModel", ExistenceChecker.isSet((CommodityDeliveryPointsModel) o.getCommodityDeliveryPointsModel()))
				...
				.put("gasDeliverySequence", ExistenceChecker.isSet((GasDeliverySequence) o.getGasDeliverySequence()))
				.build();
		...
		if (setFields.equals(fields)) {
			return success("GasDelivery", ValidationType.ONLY_EXISTS, "GasDelivery", path, "");
		}
		return failure("GasDelivery", ValidationType.ONLY_EXISTS, "GasDelivery", path, "",
