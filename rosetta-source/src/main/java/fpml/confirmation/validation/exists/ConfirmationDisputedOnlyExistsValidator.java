...
public class ConfirmationDisputedOnlyExistsValidator implements ValidatorWithArg<ConfirmationDisputed, Set<String>> {
	...
	public <T2 extends ConfirmationDisputed> ValidationResult<ConfirmationDisputed> validate(RosettaPath path, T2 o, Set<String> fields) {
		...
		if (setFields.equals(fields)) {
			return success("ConfirmationDisputed", ValidationType.ONLY_EXISTS, "ConfirmationDisputed", path, "");
		}
		return failure("ConfirmationDisputed", ValidationType.ONLY_EXISTS, "ConfirmationDisputed", path, "",
