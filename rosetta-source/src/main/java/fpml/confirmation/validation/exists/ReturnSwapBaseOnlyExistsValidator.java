...
public class ReturnSwapBaseOnlyExistsValidator implements ValidatorWithArg<ReturnSwapBase, Set<String>> {
	...
	public <T2 extends ReturnSwapBase> ValidationResult<ReturnSwapBase> validate(RosettaPath path, T2 o, Set<String> fields) {
		...
		if (setFields.equals(fields)) {
			return success("ReturnSwapBase", ValidationType.ONLY_EXISTS, "ReturnSwapBase", path, "");
		}
		return failure("ReturnSwapBase", ValidationType.ONLY_EXISTS, "ReturnSwapBase", path, "",
