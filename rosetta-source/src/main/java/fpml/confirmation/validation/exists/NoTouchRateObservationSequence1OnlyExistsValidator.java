...
public class NoTouchRateObservationSequence1OnlyExistsValidator implements ValidatorWithArg<NoTouchRateObservationSequence1, Set<String>> {

	/* Casting is required to ensure types are output to ensure recompilation in Rosetta */
	@Override
	public <T2 extends NoTouchRateObservationSequence1> ValidationResult<NoTouchRateObservationSequence1> validate(RosettaPath path, T2 o, Set<String> fields) {
		...
		if (setFields.equals(fields)) {
			return success("NoTouchRateObservationSequence1", ValidationType.ONLY_EXISTS, "NoTouchRateObservationSequence1", path, "");
		}
		return failure("NoTouchRateObservationSequence1", ValidationType.ONLY_EXISTS, "NoTouchRateObservationSequence1", path, "",
