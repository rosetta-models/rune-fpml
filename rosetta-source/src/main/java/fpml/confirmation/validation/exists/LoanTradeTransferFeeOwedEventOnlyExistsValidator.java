...
public class LoanTradeTransferFeeOwedEventOnlyExistsValidator implements ValidatorWithArg<LoanTradeTransferFeeOwedEvent, Set<String>> {

	/* Casting is required to ensure types are output to ensure recompilation in Rosetta */
	@Override
	public <T2 extends LoanTradeTransferFeeOwedEvent> ValidationResult<LoanTradeTransferFeeOwedEvent> validate(RosettaPath path, T2 o, Set<String> fields) {
		...
		if (setFields.equals(fields)) {
			return success("LoanTradeTransferFeeOwedEvent", ValidationType.ONLY_EXISTS, "LoanTradeTransferFeeOwedEvent", path, "");
		}
		return failure("LoanTradeTransferFeeOwedEvent", ValidationType.ONLY_EXISTS, "LoanTradeTransferFeeOwedEvent", path, "",
