...
public class AmendmentFeePaymentOnlyExistsValidator implements ValidatorWithArg<AmendmentFeePayment, Set<String>> {
	...
	public <T2 extends AmendmentFeePayment> ValidationResult<AmendmentFeePayment> validate(RosettaPath path, T2 o, Set<String> fields) {
		...
		if (setFields.equals(fields)) {
			return success("AmendmentFeePayment", ValidationType.ONLY_EXISTS, "AmendmentFeePayment", path, "");
		}
		return failure("AmendmentFeePayment", ValidationType.ONLY_EXISTS, "AmendmentFeePayment", path, "",
