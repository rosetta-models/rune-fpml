...
public class AbstractFacilityOnlyExistsValidator implements ValidatorWithArg<AbstractFacility, Set<String>> {
	...
	public <T2 extends AbstractFacility> ValidationResult<AbstractFacility> validate(RosettaPath path, T2 o, Set<String> fields) {
		...
		if (setFields.equals(fields)) {
			return success("AbstractFacility", ValidationType.ONLY_EXISTS, "AbstractFacility", path, "");
		}
		return failure("AbstractFacility", ValidationType.ONLY_EXISTS, "AbstractFacility", path, "",
