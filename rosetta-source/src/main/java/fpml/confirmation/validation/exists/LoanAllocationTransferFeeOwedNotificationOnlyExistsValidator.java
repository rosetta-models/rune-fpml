...
public class LoanAllocationTransferFeeOwedNotificationOnlyExistsValidator implements ValidatorWithArg<LoanAllocationTransferFeeOwedNotification, Set<String>> {

	/* Casting is required to ensure types are output to ensure recompilation in Rosetta */
	@Override
	public <T2 extends LoanAllocationTransferFeeOwedNotification> ValidationResult<LoanAllocationTransferFeeOwedNotification> validate(RosettaPath path, T2 o, Set<String> fields) {
		Map<String, Boolean> fieldExistenceMap = ImmutableMap.<String, Boolean>builder()
				...
				.put("feeOwed", ExistenceChecker.isSet((List<? extends LoanAllocationTransferFeeOwedEvent>) o.getFeeOwed()))
		...
		if (setFields.equals(fields)) {
			return success("LoanAllocationTransferFeeOwedNotification", ValidationType.ONLY_EXISTS, "LoanAllocationTransferFeeOwedNotification", path, "");
		}
		return failure("LoanAllocationTransferFeeOwedNotification", ValidationType.ONLY_EXISTS, "LoanAllocationTransferFeeOwedNotification", path, "",
