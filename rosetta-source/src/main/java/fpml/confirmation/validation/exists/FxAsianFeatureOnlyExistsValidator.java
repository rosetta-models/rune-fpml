...
public class FxAsianFeatureOnlyExistsValidator implements ValidatorWithArg<FxAsianFeature, Set<String>> {
	...
	public <T2 extends FxAsianFeature> ValidationResult<FxAsianFeature> validate(RosettaPath path, T2 o, Set<String> fields) {
		Map<String, Boolean> fieldExistenceMap = ImmutableMap.<String, Boolean>builder()
				...
				.put("fxAsianFeatureSequence", ExistenceChecker.isSet((FxAsianFeatureSequence) o.getFxAsianFeatureSequence()))
		...
		if (setFields.equals(fields)) {
			return success("FxAsianFeature", ValidationType.ONLY_EXISTS, "FxAsianFeature", path, "");
		}
		return failure("FxAsianFeature", ValidationType.ONLY_EXISTS, "FxAsianFeature", path, "",
