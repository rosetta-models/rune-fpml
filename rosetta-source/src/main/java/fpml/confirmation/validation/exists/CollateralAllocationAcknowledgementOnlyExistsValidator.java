...
public class CollateralAllocationAcknowledgementOnlyExistsValidator implements ValidatorWithArg<CollateralAllocationAcknowledgement, Set<String>> {
	...
	public <T2 extends CollateralAllocationAcknowledgement> ValidationResult<CollateralAllocationAcknowledgement> validate(RosettaPath path, T2 o, Set<String> fields) {
		...
		if (setFields.equals(fields)) {
			return success("CollateralAllocationAcknowledgement", ValidationType.ONLY_EXISTS, "CollateralAllocationAcknowledgement", path, "");
		}
		return failure("CollateralAllocationAcknowledgement", ValidationType.ONLY_EXISTS, "CollateralAllocationAcknowledgement", path, "",
