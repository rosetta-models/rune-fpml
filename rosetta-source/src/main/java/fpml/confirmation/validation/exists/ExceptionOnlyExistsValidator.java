...
public class ExceptionOnlyExistsValidator implements ValidatorWithArg<Exception, Set<String>> {

	/* Casting is required to ensure types are output to ensure recompilation in Rosetta */
	@Override
	public <T2 extends Exception> ValidationResult<Exception> validate(RosettaPath path, T2 o, Set<String> fields) {
		...
		if (setFields.equals(fields)) {
			return success("Exception", ValidationType.ONLY_EXISTS, "Exception", path, "");
		}
		return failure("Exception", ValidationType.ONLY_EXISTS, "Exception", path, "",
