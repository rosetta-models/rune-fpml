...
public class DirectionalLegOnlyExistsValidator implements ValidatorWithArg<DirectionalLeg, Set<String>> {
	...
	public <T2 extends DirectionalLeg> ValidationResult<DirectionalLeg> validate(RosettaPath path, T2 o, Set<String> fields) {
		...
		if (setFields.equals(fields)) {
			return success("DirectionalLeg", ValidationType.ONLY_EXISTS, "DirectionalLeg", path, "");
		}
		return failure("DirectionalLeg", ValidationType.ONLY_EXISTS, "DirectionalLeg", path, "",
