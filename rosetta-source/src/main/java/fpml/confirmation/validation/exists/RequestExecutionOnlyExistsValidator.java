...
public class RequestExecutionOnlyExistsValidator implements ValidatorWithArg<RequestExecution, Set<String>> {
	...
	public <T2 extends RequestExecution> ValidationResult<RequestExecution> validate(RosettaPath path, T2 o, Set<String> fields) {
		...
		if (setFields.equals(fields)) {
			return success("RequestExecution", ValidationType.ONLY_EXISTS, "RequestExecution", path, "");
		}
		return failure("RequestExecution", ValidationType.ONLY_EXISTS, "RequestExecution", path, "",
