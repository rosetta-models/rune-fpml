...
public class DelayedDrawOnlyExistsValidator implements ValidatorWithArg<DelayedDraw, Set<String>> {
	...
	public <T2 extends DelayedDraw> ValidationResult<DelayedDraw> validate(RosettaPath path, T2 o, Set<String> fields) {
		Map<String, Boolean> fieldExistenceMap = ImmutableMap.<String, Boolean>builder()
				...
				.put("mustDrawByDate", ExistenceChecker.isSet((Date) o.getMustDrawByDate()))
				.build();
		...
		if (setFields.equals(fields)) {
			return success("DelayedDraw", ValidationType.ONLY_EXISTS, "DelayedDraw", path, "");
		}
		return failure("DelayedDraw", ValidationType.ONLY_EXISTS, "DelayedDraw", path, "",
