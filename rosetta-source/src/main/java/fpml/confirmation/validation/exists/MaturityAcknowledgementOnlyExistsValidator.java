...
public class MaturityAcknowledgementOnlyExistsValidator implements ValidatorWithArg<MaturityAcknowledgement, Set<String>> {
	...
	public <T2 extends MaturityAcknowledgement> ValidationResult<MaturityAcknowledgement> validate(RosettaPath path, T2 o, Set<String> fields) {
		...
		if (setFields.equals(fields)) {
			return success("MaturityAcknowledgement", ValidationType.ONLY_EXISTS, "MaturityAcknowledgement", path, "");
		}
		return failure("MaturityAcknowledgement", ValidationType.ONLY_EXISTS, "MaturityAcknowledgement", path, "",
