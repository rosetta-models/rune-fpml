...
public class LoanAllocationTransferFeeDueNotificationOnlyExistsValidator implements ValidatorWithArg<LoanAllocationTransferFeeDueNotification, Set<String>> {

	/* Casting is required to ensure types are output to ensure recompilation in Rosetta */
	@Override
	public <T2 extends LoanAllocationTransferFeeDueNotification> ValidationResult<LoanAllocationTransferFeeDueNotification> validate(RosettaPath path, T2 o, Set<String> fields) {
		Map<String, Boolean> fieldExistenceMap = ImmutableMap.<String, Boolean>builder()
				...
				.put("feeDue", ExistenceChecker.isSet((List<? extends LoanAllocationTransferFeeDueEvent>) o.getFeeDue()))
		...
		if (setFields.equals(fields)) {
			return success("LoanAllocationTransferFeeDueNotification", ValidationType.ONLY_EXISTS, "LoanAllocationTransferFeeDueNotification", path, "");
		}
		return failure("LoanAllocationTransferFeeDueNotification", ValidationType.ONLY_EXISTS, "LoanAllocationTransferFeeDueNotification", path, "",
