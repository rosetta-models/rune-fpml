...
public class BuyerSellerModelOnlyExistsValidator implements ValidatorWithArg<BuyerSellerModel, Set<String>> {

	/* Casting is required to ensure types are output to ensure recompilation in Rosetta */
	@Override
	public <T2 extends BuyerSellerModel> ValidationResult<BuyerSellerModel> validate(RosettaPath path, T2 o, Set<String> fields) {
		...
		if (setFields.equals(fields)) {
			return success("BuyerSellerModel", ValidationType.ONLY_EXISTS, "BuyerSellerModel", path, "");
		}
		return failure("BuyerSellerModel", ValidationType.ONLY_EXISTS, "BuyerSellerModel", path, "",
