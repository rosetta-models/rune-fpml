...
public class FundingFeePaymentOnlyExistsValidator implements ValidatorWithArg<FundingFeePayment, Set<String>> {
	...
	public <T2 extends FundingFeePayment> ValidationResult<FundingFeePayment> validate(RosettaPath path, T2 o, Set<String> fields) {
		...
		if (setFields.equals(fields)) {
			return success("FundingFeePayment", ValidationType.ONLY_EXISTS, "FundingFeePayment", path, "");
		}
		return failure("FundingFeePayment", ValidationType.ONLY_EXISTS, "FundingFeePayment", path, "",
