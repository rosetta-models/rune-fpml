...
public class RequestCollateralAllocationOnlyExistsValidator implements ValidatorWithArg<RequestCollateralAllocation, Set<String>> {
	...
	public <T2 extends RequestCollateralAllocation> ValidationResult<RequestCollateralAllocation> validate(RosettaPath path, T2 o, Set<String> fields) {
		...
		if (setFields.equals(fields)) {
			return success("RequestCollateralAllocation", ValidationType.ONLY_EXISTS, "RequestCollateralAllocation", path, "");
		}
		return failure("RequestCollateralAllocation", ValidationType.ONLY_EXISTS, "RequestCollateralAllocation", path, "",
