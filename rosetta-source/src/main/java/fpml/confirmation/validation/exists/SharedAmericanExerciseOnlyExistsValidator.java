...
public class SharedAmericanExerciseOnlyExistsValidator implements ValidatorWithArg<SharedAmericanExercise, Set<String>> {
	...
	public <T2 extends SharedAmericanExercise> ValidationResult<SharedAmericanExercise> validate(RosettaPath path, T2 o, Set<String> fields) {
		...
		if (setFields.equals(fields)) {
			return success("SharedAmericanExercise", ValidationType.ONLY_EXISTS, "SharedAmericanExercise", path, "");
		}
		return failure("SharedAmericanExercise", ValidationType.ONLY_EXISTS, "SharedAmericanExercise", path, "",
