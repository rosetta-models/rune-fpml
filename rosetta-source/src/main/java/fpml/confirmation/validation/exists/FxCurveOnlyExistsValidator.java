...
public class FxCurveOnlyExistsValidator implements ValidatorWithArg<FxCurve, Set<String>> {
	...
	public <T2 extends FxCurve> ValidationResult<FxCurve> validate(RosettaPath path, T2 o, Set<String> fields) {
		Map<String, Boolean> fieldExistenceMap = ImmutableMap.<String, Boolean>builder()
				...
				.put("fxCurveCharacteristicsModel", ExistenceChecker.isSet((FxCurveCharacteristicsModel) o.getFxCurveCharacteristicsModel()))
				.build();
		...
		if (setFields.equals(fields)) {
			return success("FxCurve", ValidationType.ONLY_EXISTS, "FxCurve", path, "");
		}
		return failure("FxCurve", ValidationType.ONLY_EXISTS, "FxCurve", path, "",
