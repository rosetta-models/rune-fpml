...
public class AccruingPikPaymentNotificationOnlyExistsValidator implements ValidatorWithArg<AccruingPikPaymentNotification, Set<String>> {

	/* Casting is required to ensure types are output to ensure recompilation in Rosetta */
	@Override
	public <T2 extends AccruingPikPaymentNotification> ValidationResult<AccruingPikPaymentNotification> validate(RosettaPath path, T2 o, Set<String> fields) {
		...
		if (setFields.equals(fields)) {
			return success("AccruingPikPaymentNotification", ValidationType.ONLY_EXISTS, "AccruingPikPaymentNotification", path, "");
		}
		return failure("AccruingPikPaymentNotification", ValidationType.ONLY_EXISTS, "AccruingPikPaymentNotification", path, "",
