...
public class LoanTradeTransferFeeDueNotificationOnlyExistsValidator implements ValidatorWithArg<LoanTradeTransferFeeDueNotification, Set<String>> {

	/* Casting is required to ensure types are output to ensure recompilation in Rosetta */
	@Override
	public <T2 extends LoanTradeTransferFeeDueNotification> ValidationResult<LoanTradeTransferFeeDueNotification> validate(RosettaPath path, T2 o, Set<String> fields) {
		Map<String, Boolean> fieldExistenceMap = ImmutableMap.<String, Boolean>builder()
				...
				.put("feeDue", ExistenceChecker.isSet((List<? extends LoanTradeTransferFeeDueEvent>) o.getFeeDue()))
				.put("tradeSummary", ExistenceChecker.isSet((List<? extends LoanTradeSummary>) o.getTradeSummary()))
		...
		if (setFields.equals(fields)) {
			return success("LoanTradeTransferFeeDueNotification", ValidationType.ONLY_EXISTS, "LoanTradeTransferFeeDueNotification", path, "");
		}
		return failure("LoanTradeTransferFeeDueNotification", ValidationType.ONLY_EXISTS, "LoanTradeTransferFeeDueNotification", path, "",
