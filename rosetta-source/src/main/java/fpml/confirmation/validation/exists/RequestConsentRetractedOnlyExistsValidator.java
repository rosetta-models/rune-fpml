...
public class RequestConsentRetractedOnlyExistsValidator implements ValidatorWithArg<RequestConsentRetracted, Set<String>> {
	...
	public <T2 extends RequestConsentRetracted> ValidationResult<RequestConsentRetracted> validate(RosettaPath path, T2 o, Set<String> fields) {
		...
		if (setFields.equals(fields)) {
			return success("RequestConsentRetracted", ValidationType.ONLY_EXISTS, "RequestConsentRetracted", path, "");
		}
		return failure("RequestConsentRetracted", ValidationType.ONLY_EXISTS, "RequestConsentRetracted", path, "",
