...
public class VerificationStatusExceptionOnlyExistsValidator implements ValidatorWithArg<VerificationStatusException, Set<String>> {
	...
	public <T2 extends VerificationStatusException> ValidationResult<VerificationStatusException> validate(RosettaPath path, T2 o, Set<String> fields) {
		...
		if (setFields.equals(fields)) {
			return success("VerificationStatusException", ValidationType.ONLY_EXISTS, "VerificationStatusException", path, "");
		}
		return failure("VerificationStatusException", ValidationType.ONLY_EXISTS, "VerificationStatusException", path, "",
