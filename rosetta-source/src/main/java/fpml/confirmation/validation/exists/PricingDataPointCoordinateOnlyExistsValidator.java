...
public class PricingDataPointCoordinateOnlyExistsValidator implements ValidatorWithArg<PricingDataPointCoordinate, Set<String>> {
	...
	public <T2 extends PricingDataPointCoordinate> ValidationResult<PricingDataPointCoordinate> validate(RosettaPath path, T2 o, Set<String> fields) {
		Map<String, Boolean> fieldExistenceMap = ImmutableMap.<String, Boolean>builder()
				.put("pricingStructureIndexModel", ExistenceChecker.isSet((List<? extends PricingStructureIndexModel>) o.getPricingStructureIndexModel()))
		...
		if (setFields.equals(fields)) {
			return success("PricingDataPointCoordinate", ValidationType.ONLY_EXISTS, "PricingDataPointCoordinate", path, "");
		}
		return failure("PricingDataPointCoordinate", ValidationType.ONLY_EXISTS, "PricingDataPointCoordinate", path, "",
