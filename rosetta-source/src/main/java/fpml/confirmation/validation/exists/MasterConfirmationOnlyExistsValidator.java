...
public class MasterConfirmationOnlyExistsValidator implements ValidatorWithArg<MasterConfirmation, Set<String>> {
	...
	public <T2 extends MasterConfirmation> ValidationResult<MasterConfirmation> validate(RosettaPath path, T2 o, Set<String> fields) {
		Map<String, Boolean> fieldExistenceMap = ImmutableMap.<String, Boolean>builder()
				...
				.put("masterConfirmationAnnexDate", ExistenceChecker.isSet((Date) o.getMasterConfirmationAnnexDate()))
		...
		if (setFields.equals(fields)) {
			return success("MasterConfirmation", ValidationType.ONLY_EXISTS, "MasterConfirmation", path, "");
		}
		return failure("MasterConfirmation", ValidationType.ONLY_EXISTS, "MasterConfirmation", path, "",
