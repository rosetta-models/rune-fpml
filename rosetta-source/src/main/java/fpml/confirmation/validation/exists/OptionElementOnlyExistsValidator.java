...
public class OptionElementOnlyExistsValidator implements ValidatorWithArg<OptionElement, Set<String>> {

	/* Casting is required to ensure types are output to ensure recompilation in Rosetta */
	@Override
	public <T2 extends OptionElement> ValidationResult<OptionElement> validate(RosettaPath path, T2 o, Set<String> fields) {
		...
		if (setFields.equals(fields)) {
			return success("OptionElement", ValidationType.ONLY_EXISTS, "OptionElement", path, "");
		}
		return failure("OptionElement", ValidationType.ONLY_EXISTS, "OptionElement", path, "",
