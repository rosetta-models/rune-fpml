...
public class LoanTransferFeeOnlyExistsValidator implements ValidatorWithArg<LoanTransferFee, Set<String>> {
	...
	public <T2 extends LoanTransferFee> ValidationResult<LoanTransferFee> validate(RosettaPath path, T2 o, Set<String> fields) {
		Map<String, Boolean> fieldExistenceMap = ImmutableMap.<String, Boolean>builder()
				...
				.put("loanTransferFeeSequence", ExistenceChecker.isSet((LoanTransferFeeSequence) o.getLoanTransferFeeSequence()))
		...
		if (setFields.equals(fields)) {
			return success("LoanTransferFee", ValidationType.ONLY_EXISTS, "LoanTransferFee", path, "");
		}
		return failure("LoanTransferFee", ValidationType.ONLY_EXISTS, "LoanTransferFee", path, "",
