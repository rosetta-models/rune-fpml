...
public class VerificationStatusAcknowledgementOnlyExistsValidator implements ValidatorWithArg<VerificationStatusAcknowledgement, Set<String>> {
	...
	public <T2 extends VerificationStatusAcknowledgement> ValidationResult<VerificationStatusAcknowledgement> validate(RosettaPath path, T2 o, Set<String> fields) {
		...
		if (setFields.equals(fields)) {
			return success("VerificationStatusAcknowledgement", ValidationType.ONLY_EXISTS, "VerificationStatusAcknowledgement", path, "");
		}
		return failure("VerificationStatusAcknowledgement", ValidationType.ONLY_EXISTS, "VerificationStatusAcknowledgement", path, "",
