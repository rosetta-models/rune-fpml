...
public class VarianceOptionTransactionSupplementOnlyExistsValidator implements ValidatorWithArg<VarianceOptionTransactionSupplement, Set<String>> {
	...
	public <T2 extends VarianceOptionTransactionSupplement> ValidationResult<VarianceOptionTransactionSupplement> validate(RosettaPath path, T2 o, Set<String> fields) {
		...
		if (setFields.equals(fields)) {
			return success("VarianceOptionTransactionSupplement", ValidationType.ONLY_EXISTS, "VarianceOptionTransactionSupplement", path, "");
		}
		return failure("VarianceOptionTransactionSupplement", ValidationType.ONLY_EXISTS, "VarianceOptionTransactionSupplement", path, "",
