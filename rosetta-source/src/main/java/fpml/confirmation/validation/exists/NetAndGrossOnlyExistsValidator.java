...
public class NetAndGrossOnlyExistsValidator implements ValidatorWithArg<NetAndGross, Set<String>> {
	...
	public <T2 extends NetAndGross> ValidationResult<NetAndGross> validate(RosettaPath path, T2 o, Set<String> fields) {
		Map<String, Boolean> fieldExistenceMap = ImmutableMap.<String, Boolean>builder()
				.put("netAndOrGrossModel", ExistenceChecker.isSet((NetAndOrGrossModel) o.getNetAndOrGrossModel()))
				.build();
		...
		if (setFields.equals(fields)) {
			return success("NetAndGross", ValidationType.ONLY_EXISTS, "NetAndGross", path, "");
		}
		return failure("NetAndGross", ValidationType.ONLY_EXISTS, "NetAndGross", path, "",
