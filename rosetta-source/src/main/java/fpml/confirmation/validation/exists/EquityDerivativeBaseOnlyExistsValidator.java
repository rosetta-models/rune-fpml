...
public class EquityDerivativeBaseOnlyExistsValidator implements ValidatorWithArg<EquityDerivativeBase, Set<String>> {
	...
	public <T2 extends EquityDerivativeBase> ValidationResult<EquityDerivativeBase> validate(RosettaPath path, T2 o, Set<String> fields) {
		...
		if (setFields.equals(fields)) {
			return success("EquityDerivativeBase", ValidationType.ONLY_EXISTS, "EquityDerivativeBase", path, "");
		}
		return failure("EquityDerivativeBase", ValidationType.ONLY_EXISTS, "EquityDerivativeBase", path, "",
