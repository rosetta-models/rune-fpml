...
public class UnderlyingAssetTypeOnlyExistsValidator implements ValidatorWithArg<UnderlyingAssetType, Set<String>> {

	/* Casting is required to ensure types are output to ensure recompilation in Rosetta */
	@Override
	public <T2 extends UnderlyingAssetType> ValidationResult<UnderlyingAssetType> validate(RosettaPath path, T2 o, Set<String> fields) {
		...
		if (setFields.equals(fields)) {
			return success("UnderlyingAssetType", ValidationType.ONLY_EXISTS, "UnderlyingAssetType", path, "");
		}
		return failure("UnderlyingAssetType", ValidationType.ONLY_EXISTS, "UnderlyingAssetType", path, "",
