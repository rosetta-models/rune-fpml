...
public class PrepaymentNotificationOnlyExistsValidator implements ValidatorWithArg<PrepaymentNotification, Set<String>> {

	/* Casting is required to ensure types are output to ensure recompilation in Rosetta */
	@Override
	public <T2 extends PrepaymentNotification> ValidationResult<PrepaymentNotification> validate(RosettaPath path, T2 o, Set<String> fields) {
		Map<String, Boolean> fieldExistenceMap = ImmutableMap.<String, Boolean>builder()
				...
				.put("prepayment", ExistenceChecker.isSet((LoanPrepayment) o.getPrepayment()))
		...
		if (setFields.equals(fields)) {
			return success("PrepaymentNotification", ValidationType.ONLY_EXISTS, "PrepaymentNotification", path, "");
		}
		return failure("PrepaymentNotification", ValidationType.ONLY_EXISTS, "PrepaymentNotification", path, "",
