...
public class LoanAllocationConfirmationNotificationOnlyExistsValidator implements ValidatorWithArg<LoanAllocationConfirmationNotification, Set<String>> {

	/* Casting is required to ensure types are output to ensure recompilation in Rosetta */
	@Override
	public <T2 extends LoanAllocationConfirmationNotification> ValidationResult<LoanAllocationConfirmationNotification> validate(RosettaPath path, T2 o, Set<String> fields) {
		Map<String, Boolean> fieldExistenceMap = ImmutableMap.<String, Boolean>builder()
				...
				.put("confirmation", ExistenceChecker.isSet((LoanAllocationEvent) o.getConfirmation()))
				.put("allocationIdentifier", ExistenceChecker.isSet((List<? extends LoanAllocationIdentifier>) o.getAllocationIdentifier()))
		...
		if (setFields.equals(fields)) {
			return success("LoanAllocationConfirmationNotification", ValidationType.ONLY_EXISTS, "LoanAllocationConfirmationNotification", path, "");
		}
		return failure("LoanAllocationConfirmationNotification", ValidationType.ONLY_EXISTS, "LoanAllocationConfirmationNotification", path, "",
