...
public class AbstractLoanTradeOnlyExistsValidator implements ValidatorWithArg<AbstractLoanTrade, Set<String>> {

	/* Casting is required to ensure types are output to ensure recompilation in Rosetta */
	@Override
	public <T2 extends AbstractLoanTrade> ValidationResult<AbstractLoanTrade> validate(RosettaPath path, T2 o, Set<String> fields) {
		Map<String, Boolean> fieldExistenceMap = ImmutableMap.<String, Boolean>builder()
				...
				.put("_type", ExistenceChecker.isSet((LoanTradingTypeEnum) o.get_type()))
		...
		if (setFields.equals(fields)) {
			return success("AbstractLoanTrade", ValidationType.ONLY_EXISTS, "AbstractLoanTrade", path, "");
		}
		return failure("AbstractLoanTrade", ValidationType.ONLY_EXISTS, "AbstractLoanTrade", path, "",
