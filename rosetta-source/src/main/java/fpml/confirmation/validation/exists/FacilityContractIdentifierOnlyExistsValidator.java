...
public class FacilityContractIdentifierOnlyExistsValidator implements ValidatorWithArg<FacilityContractIdentifier, Set<String>> {

	/* Casting is required to ensure types are output to ensure recompilation in Rosetta */
	@Override
	public <T2 extends FacilityContractIdentifier> ValidationResult<FacilityContractIdentifier> validate(RosettaPath path, T2 o, Set<String> fields) {
		...
		if (setFields.equals(fields)) {
			return success("FacilityContractIdentifier", ValidationType.ONLY_EXISTS, "FacilityContractIdentifier", path, "");
		}
		return failure("FacilityContractIdentifier", ValidationType.ONLY_EXISTS, "FacilityContractIdentifier", path, "",
