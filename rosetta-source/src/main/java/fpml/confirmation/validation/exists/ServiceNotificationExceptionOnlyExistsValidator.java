...
public class ServiceNotificationExceptionOnlyExistsValidator implements ValidatorWithArg<ServiceNotificationException, Set<String>> {
	...
	public <T2 extends ServiceNotificationException> ValidationResult<ServiceNotificationException> validate(RosettaPath path, T2 o, Set<String> fields) {
		...
		if (setFields.equals(fields)) {
			return success("ServiceNotificationException", ValidationType.ONLY_EXISTS, "ServiceNotificationException", path, "");
		}
		return failure("ServiceNotificationException", ValidationType.ONLY_EXISTS, "ServiceNotificationException", path, "",
