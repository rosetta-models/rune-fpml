...
public class LoanTradeNotificationOnlyExistsValidator implements ValidatorWithArg<LoanTradeNotification, Set<String>> {
	...
	public <T2 extends LoanTradeNotification> ValidationResult<LoanTradeNotification> validate(RosettaPath path, T2 o, Set<String> fields) {
		Map<String, Boolean> fieldExistenceMap = ImmutableMap.<String, Boolean>builder()
				...
				.put("tradeEvent", ExistenceChecker.isSet((LoanTradeEvent) o.getTradeEvent()))
				.put("trade", ExistenceChecker.isSet((LoanTrade) o.getTrade()))
		...
		if (setFields.equals(fields)) {
			return success("LoanTradeNotification", ValidationType.ONLY_EXISTS, "LoanTradeNotification", path, "");
		}
		return failure("LoanTradeNotification", ValidationType.ONLY_EXISTS, "LoanTradeNotification", path, "",
