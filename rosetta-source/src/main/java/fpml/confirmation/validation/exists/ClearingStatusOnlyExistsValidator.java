...
public class ClearingStatusOnlyExistsValidator implements ValidatorWithArg<ClearingStatus, Set<String>> {
	...
	public <T2 extends ClearingStatus> ValidationResult<ClearingStatus> validate(RosettaPath path, T2 o, Set<String> fields) {
		...
		if (setFields.equals(fields)) {
			return success("ClearingStatus", ValidationType.ONLY_EXISTS, "ClearingStatus", path, "");
		}
		return failure("ClearingStatus", ValidationType.ONLY_EXISTS, "ClearingStatus", path, "",
