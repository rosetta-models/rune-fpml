...
public class LoanTradeConfirmationNotificationOnlyExistsValidator implements ValidatorWithArg<LoanTradeConfirmationNotification, Set<String>> {

	/* Casting is required to ensure types are output to ensure recompilation in Rosetta */
	@Override
	public <T2 extends LoanTradeConfirmationNotification> ValidationResult<LoanTradeConfirmationNotification> validate(RosettaPath path, T2 o, Set<String> fields) {
		Map<String, Boolean> fieldExistenceMap = ImmutableMap.<String, Boolean>builder()
				...
				.put("confirmation", ExistenceChecker.isSet((LoanTradeEvent) o.getConfirmation()))
		...
		if (setFields.equals(fields)) {
			return success("LoanTradeConfirmationNotification", ValidationType.ONLY_EXISTS, "LoanTradeConfirmationNotification", path, "");
		}
		return failure("LoanTradeConfirmationNotification", ValidationType.ONLY_EXISTS, "LoanTradeConfirmationNotification", path, "",
