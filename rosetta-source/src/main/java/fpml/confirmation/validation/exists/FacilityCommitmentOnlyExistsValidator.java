...
public class FacilityCommitmentOnlyExistsValidator implements ValidatorWithArg<FacilityCommitment, Set<String>> {
	...
	public <T2 extends FacilityCommitment> ValidationResult<FacilityCommitment> validate(RosettaPath path, T2 o, Set<String> fields) {
		Map<String, Boolean> fieldExistenceMap = ImmutableMap.<String, Boolean>builder()
				...
				.put("facilityCommitmentSequence", ExistenceChecker.isSet((FacilityCommitmentSequence) o.getFacilityCommitmentSequence()))
				.build();
		...
		if (setFields.equals(fields)) {
			return success("FacilityCommitment", ValidationType.ONLY_EXISTS, "FacilityCommitment", path, "");
		}
		return failure("FacilityCommitment", ValidationType.ONLY_EXISTS, "FacilityCommitment", path, "",
