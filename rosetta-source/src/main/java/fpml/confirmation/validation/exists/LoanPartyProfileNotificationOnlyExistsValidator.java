...
public class LoanPartyProfileNotificationOnlyExistsValidator implements ValidatorWithArg<LoanPartyProfileNotification, Set<String>> {

	/* Casting is required to ensure types are output to ensure recompilation in Rosetta */
	@Override
	public <T2 extends LoanPartyProfileNotification> ValidationResult<LoanPartyProfileNotification> validate(RosettaPath path, T2 o, Set<String> fields) {
		...
		if (setFields.equals(fields)) {
			return success("LoanPartyProfileNotification", ValidationType.ONLY_EXISTS, "LoanPartyProfileNotification", path, "");
		}
		return failure("LoanPartyProfileNotification", ValidationType.ONLY_EXISTS, "LoanPartyProfileNotification", path, "",
