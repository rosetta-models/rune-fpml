...
public class AbstractLoanStatementOnlyExistsValidator implements ValidatorWithArg<AbstractLoanStatement, Set<String>> {
	...
	public <T2 extends AbstractLoanStatement> ValidationResult<AbstractLoanStatement> validate(RosettaPath path, T2 o, Set<String> fields) {
		...
		if (setFields.equals(fields)) {
			return success("AbstractLoanStatement", ValidationType.ONLY_EXISTS, "AbstractLoanStatement", path, "");
		}
		return failure("AbstractLoanStatement", ValidationType.ONLY_EXISTS, "AbstractLoanStatement", path, "",
