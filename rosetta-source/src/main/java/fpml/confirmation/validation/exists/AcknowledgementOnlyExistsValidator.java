...
public class AcknowledgementOnlyExistsValidator implements ValidatorWithArg<Acknowledgement, Set<String>> {
	...
	public <T2 extends Acknowledgement> ValidationResult<Acknowledgement> validate(RosettaPath path, T2 o, Set<String> fields) {
		...
		if (setFields.equals(fields)) {
			return success("Acknowledgement", ValidationType.ONLY_EXISTS, "Acknowledgement", path, "");
		}
		return failure("Acknowledgement", ValidationType.ONLY_EXISTS, "Acknowledgement", path, "",
