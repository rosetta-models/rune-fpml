...
public class LoanAllocationNotificationOnlyExistsValidator implements ValidatorWithArg<LoanAllocationNotification, Set<String>> {
	...
	public <T2 extends LoanAllocationNotification> ValidationResult<LoanAllocationNotification> validate(RosettaPath path, T2 o, Set<String> fields) {
		Map<String, Boolean> fieldExistenceMap = ImmutableMap.<String, Boolean>builder()
				...
				.put("allocationEvent", ExistenceChecker.isSet((LoanAllocationEvent) o.getAllocationEvent()))
				.put("allocation", ExistenceChecker.isSet((List<? extends LoanAllocation>) o.getAllocation()))
		...
		if (setFields.equals(fields)) {
			return success("LoanAllocationNotification", ValidationType.ONLY_EXISTS, "LoanAllocationNotification", path, "");
		}
		return failure("LoanAllocationNotification", ValidationType.ONLY_EXISTS, "LoanAllocationNotification", path, "",
