...
public class LoanInterestPaymentOnlyExistsValidator implements ValidatorWithArg<LoanInterestPayment, Set<String>> {
	...
	public <T2 extends LoanInterestPayment> ValidationResult<LoanInterestPayment> validate(RosettaPath path, T2 o, Set<String> fields) {
		Map<String, Boolean> fieldExistenceMap = ImmutableMap.<String, Boolean>builder()
				...
				.put("loanInterestPaymentSequence", ExistenceChecker.isSet((LoanInterestPaymentSequence) o.getLoanInterestPaymentSequence()))
				.build();
		...
		if (setFields.equals(fields)) {
			return success("LoanInterestPayment", ValidationType.ONLY_EXISTS, "LoanInterestPayment", path, "");
		}
		return failure("LoanInterestPayment", ValidationType.ONLY_EXISTS, "LoanInterestPayment", path, "",
