...
public class FacilityRateChangeNotificationOnlyExistsValidator implements ValidatorWithArg<FacilityRateChangeNotification, Set<String>> {

	/* Casting is required to ensure types are output to ensure recompilation in Rosetta */
	@Override
	public <T2 extends FacilityRateChangeNotification> ValidationResult<FacilityRateChangeNotification> validate(RosettaPath path, T2 o, Set<String> fields) {
		Map<String, Boolean> fieldExistenceMap = ImmutableMap.<String, Boolean>builder()
				...
				.put("facilityRateChangeGroup", ExistenceChecker.isSet((AbstractFacilityContractEvent) o.getFacilityRateChangeGroup()))
		...
		if (setFields.equals(fields)) {
			return success("FacilityRateChangeNotification", ValidationType.ONLY_EXISTS, "FacilityRateChangeNotification", path, "");
		}
		return failure("FacilityRateChangeNotification", ValidationType.ONLY_EXISTS, "FacilityRateChangeNotification", path, "",
