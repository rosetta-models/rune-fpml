...
public class EventProposedMatchOnlyExistsValidator implements ValidatorWithArg<EventProposedMatch, Set<String>> {
	...
	public <T2 extends EventProposedMatch> ValidationResult<EventProposedMatch> validate(RosettaPath path, T2 o, Set<String> fields) {
		Map<String, Boolean> fieldExistenceMap = ImmutableMap.<String, Boolean>builder()
				...
				.put("proposedMatchModel", ExistenceChecker.isSet((ProposedMatchModel) o.getProposedMatchModel()))
				.build();
		...
		if (setFields.equals(fields)) {
			return success("EventProposedMatch", ValidationType.ONLY_EXISTS, "EventProposedMatch", path, "");
		}
		return failure("EventProposedMatch", ValidationType.ONLY_EXISTS, "EventProposedMatch", path, "",
