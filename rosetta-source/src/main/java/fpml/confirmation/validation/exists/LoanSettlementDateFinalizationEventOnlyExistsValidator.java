...
public class LoanSettlementDateFinalizationEventOnlyExistsValidator implements ValidatorWithArg<LoanSettlementDateFinalizationEvent, Set<String>> {

	/* Casting is required to ensure types are output to ensure recompilation in Rosetta */
	@Override
	public <T2 extends LoanSettlementDateFinalizationEvent> ValidationResult<LoanSettlementDateFinalizationEvent> validate(RosettaPath path, T2 o, Set<String> fields) {
		...
		if (setFields.equals(fields)) {
			return success("LoanSettlementDateFinalizationEvent", ValidationType.ONLY_EXISTS, "LoanSettlementDateFinalizationEvent", path, "");
		}
		return failure("LoanSettlementDateFinalizationEvent", ValidationType.ONLY_EXISTS, "LoanSettlementDateFinalizationEvent", path, "",
