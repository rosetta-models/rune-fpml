...
public class AbstractLoanAllocationPaymentNotificationOnlyExistsValidator implements ValidatorWithArg<AbstractLoanAllocationPaymentNotification, Set<String>> {

	/* Casting is required to ensure types are output to ensure recompilation in Rosetta */
	@Override
	public <T2 extends AbstractLoanAllocationPaymentNotification> ValidationResult<AbstractLoanAllocationPaymentNotification> validate(RosettaPath path, T2 o, Set<String> fields) {
		...
		if (setFields.equals(fields)) {
			return success("AbstractLoanAllocationPaymentNotification", ValidationType.ONLY_EXISTS, "AbstractLoanAllocationPaymentNotification", path, "");
		}
		return failure("AbstractLoanAllocationPaymentNotification", ValidationType.ONLY_EXISTS, "AbstractLoanAllocationPaymentNotification", path, "",
