...
public class NonCorrectableRequestMessageOnlyExistsValidator implements ValidatorWithArg<NonCorrectableRequestMessage, Set<String>> {
	...
	public <T2 extends NonCorrectableRequestMessage> ValidationResult<NonCorrectableRequestMessage> validate(RosettaPath path, T2 o, Set<String> fields) {
		...
		if (setFields.equals(fields)) {
			return success("NonCorrectableRequestMessage", ValidationType.ONLY_EXISTS, "NonCorrectableRequestMessage", path, "");
		}
		return failure("NonCorrectableRequestMessage", ValidationType.ONLY_EXISTS, "NonCorrectableRequestMessage", path, "",
