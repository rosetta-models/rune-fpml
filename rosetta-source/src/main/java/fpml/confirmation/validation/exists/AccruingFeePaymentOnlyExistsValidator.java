...
public class AccruingFeePaymentOnlyExistsValidator implements ValidatorWithArg<AccruingFeePayment, Set<String>> {
	...
	public <T2 extends AccruingFeePayment> ValidationResult<AccruingFeePayment> validate(RosettaPath path, T2 o, Set<String> fields) {
		Map<String, Boolean> fieldExistenceMap = ImmutableMap.<String, Boolean>builder()
				...
				.put("accruingFeePaymentSequence", ExistenceChecker.isSet((AccruingFeePaymentSequence) o.getAccruingFeePaymentSequence()))
				.build();
		...
		if (setFields.equals(fields)) {
			return success("AccruingFeePayment", ValidationType.ONLY_EXISTS, "AccruingFeePayment", path, "");
		}
		return failure("AccruingFeePayment", ValidationType.ONLY_EXISTS, "AccruingFeePayment", path, "",
