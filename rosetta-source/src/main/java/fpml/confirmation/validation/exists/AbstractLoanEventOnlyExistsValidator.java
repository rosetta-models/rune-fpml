...
public class AbstractLoanEventOnlyExistsValidator implements ValidatorWithArg<AbstractLoanEvent, Set<String>> {
	...
	public <T2 extends AbstractLoanEvent> ValidationResult<AbstractLoanEvent> validate(RosettaPath path, T2 o, Set<String> fields) {
		...
		if (setFields.equals(fields)) {
			return success("AbstractLoanEvent", ValidationType.ONLY_EXISTS, "AbstractLoanEvent", path, "");
		}
		return failure("AbstractLoanEvent", ValidationType.ONLY_EXISTS, "AbstractLoanEvent", path, "",
