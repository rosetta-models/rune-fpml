...
public class FxExpiryDateOrScheduleModelValidator implements Validator<FxExpiryDateOrScheduleModel> {
	...
	public ValidationResult<FxExpiryDateOrScheduleModel> validate(RosettaPath path, FxExpiryDateOrScheduleModel o) {
		...
		if (!isNullOrEmpty(error)) {
			return failure("FxExpiryDateOrScheduleModel", ValidationType.CARDINALITY, "FxExpiryDateOrScheduleModel", path, "", error);
		}
		return success("FxExpiryDateOrScheduleModel", ValidationType.CARDINALITY, "FxExpiryDateOrScheduleModel", path, "");
	}
		...
		return getComparisonResults(o)
			...
			.map(res -> {
				if (!isNullOrEmpty(res.getError())) {
					return failure("FxExpiryDateOrScheduleModel", ValidationType.CARDINALITY, "FxExpiryDateOrScheduleModel", path, "", res.getError());
				}
				return success("FxExpiryDateOrScheduleModel", ValidationType.CARDINALITY, "FxExpiryDateOrScheduleModel", path, "");
			})
			.collect(toList());
