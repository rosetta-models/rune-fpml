...
public class LoanAllocationNoSettlePeriodValidator implements Validator<LoanAllocationNoSettlePeriod> {
	...
	public ValidationResult<LoanAllocationNoSettlePeriod> validate(RosettaPath path, LoanAllocationNoSettlePeriod o) {
		...
		if (!isNullOrEmpty(error)) {
			return failure("LoanAllocationNoSettlePeriod", ValidationType.CARDINALITY, "LoanAllocationNoSettlePeriod", path, "", error);
		}
		return success("LoanAllocationNoSettlePeriod", ValidationType.CARDINALITY, "LoanAllocationNoSettlePeriod", path, "");
	}
		...
		return getComparisonResults(o)
			...
			.map(res -> {
				if (!isNullOrEmpty(res.getError())) {
					return failure("LoanAllocationNoSettlePeriod", ValidationType.CARDINALITY, "LoanAllocationNoSettlePeriod", path, "", res.getError());
				}
				return success("LoanAllocationNoSettlePeriod", ValidationType.CARDINALITY, "LoanAllocationNoSettlePeriod", path, "");
			})
			.collect(toList());
