...
public class StrikeOrStrikeReferenceModelValidator implements Validator<StrikeOrStrikeReferenceModel> {
	...
	public ValidationResult<StrikeOrStrikeReferenceModel> validate(RosettaPath path, StrikeOrStrikeReferenceModel o) {
		...
		if (!isNullOrEmpty(error)) {
			return failure("StrikeOrStrikeReferenceModel", ValidationType.CARDINALITY, "StrikeOrStrikeReferenceModel", path, "", error);
		}
		return success("StrikeOrStrikeReferenceModel", ValidationType.CARDINALITY, "StrikeOrStrikeReferenceModel", path, "");
	}
		...
		return getComparisonResults(o)
			...
			.map(res -> {
				if (!isNullOrEmpty(res.getError())) {
					return failure("StrikeOrStrikeReferenceModel", ValidationType.CARDINALITY, "StrikeOrStrikeReferenceModel", path, "", res.getError());
				}
				return success("StrikeOrStrikeReferenceModel", ValidationType.CARDINALITY, "StrikeOrStrikeReferenceModel", path, "");
			})
			.collect(toList());
