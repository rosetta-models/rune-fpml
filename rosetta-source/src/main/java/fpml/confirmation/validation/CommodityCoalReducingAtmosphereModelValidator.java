...
public class CommodityCoalReducingAtmosphereModelValidator implements Validator<CommodityCoalReducingAtmosphereModel> {
	...
	public ValidationResult<CommodityCoalReducingAtmosphereModel> validate(RosettaPath path, CommodityCoalReducingAtmosphereModel o) {
		...
		if (!isNullOrEmpty(error)) {
			return failure("CommodityCoalReducingAtmosphereModel", ValidationType.CARDINALITY, "CommodityCoalReducingAtmosphereModel", path, "", error);
		}
		return success("CommodityCoalReducingAtmosphereModel", ValidationType.CARDINALITY, "CommodityCoalReducingAtmosphereModel", path, "");
	}
		...
		return getComparisonResults(o)
			...
			.map(res -> {
				if (!isNullOrEmpty(res.getError())) {
					return failure("CommodityCoalReducingAtmosphereModel", ValidationType.CARDINALITY, "CommodityCoalReducingAtmosphereModel", path, "", res.getError());
				}
				return success("CommodityCoalReducingAtmosphereModel", ValidationType.CARDINALITY, "CommodityCoalReducingAtmosphereModel", path, "");
			})
			.collect(toList());
