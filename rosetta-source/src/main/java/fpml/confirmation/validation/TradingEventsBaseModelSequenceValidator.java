...
public class TradingEventsBaseModelSequenceValidator implements Validator<TradingEventsBaseModelSequence> {
	...
	public ValidationResult<TradingEventsBaseModelSequence> validate(RosettaPath path, TradingEventsBaseModelSequence o) {
		...
		if (!isNullOrEmpty(error)) {
			return failure("TradingEventsBaseModelSequence", ValidationType.CARDINALITY, "TradingEventsBaseModelSequence", path, "", error);
		}
		return success("TradingEventsBaseModelSequence", ValidationType.CARDINALITY, "TradingEventsBaseModelSequence", path, "");
	}
		...
		return getComparisonResults(o)
			...
			.map(res -> {
				if (!isNullOrEmpty(res.getError())) {
					return failure("TradingEventsBaseModelSequence", ValidationType.CARDINALITY, "TradingEventsBaseModelSequence", path, "", res.getError());
				}
				return success("TradingEventsBaseModelSequence", ValidationType.CARDINALITY, "TradingEventsBaseModelSequence", path, "");
			})
			.collect(toList());
