...
public class FloatingRateAccrualSequenceSequenceValidator implements Validator<FloatingRateAccrualSequenceSequence> {
	...
	public ValidationResult<FloatingRateAccrualSequenceSequence> validate(RosettaPath path, FloatingRateAccrualSequenceSequence o) {
		...
		if (!isNullOrEmpty(error)) {
			return failure("FloatingRateAccrualSequenceSequence", ValidationType.CARDINALITY, "FloatingRateAccrualSequenceSequence", path, "", error);
		}
		return success("FloatingRateAccrualSequenceSequence", ValidationType.CARDINALITY, "FloatingRateAccrualSequenceSequence", path, "");
	}
		...
		return getComparisonResults(o)
			...
			.map(res -> {
				if (!isNullOrEmpty(res.getError())) {
					return failure("FloatingRateAccrualSequenceSequence", ValidationType.CARDINALITY, "FloatingRateAccrualSequenceSequence", path, "", res.getError());
				}
				return success("FloatingRateAccrualSequenceSequence", ValidationType.CARDINALITY, "FloatingRateAccrualSequenceSequence", path, "");
			})
			.collect(toList());
