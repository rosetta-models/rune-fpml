...
public class DateRelativeToCalculationPeriodDatesValidator implements Validator<DateRelativeToCalculationPeriodDates> {
	...
	private List<ComparisonResult> getComparisonResults(DateRelativeToCalculationPeriodDates o) {
		return Lists.<ComparisonResult>newArrayList(
				checkCardinality("calculationPeriodDatesReference", (List<? extends CalculationPeriodDatesReference>) o.getCalculationPeriodDatesReference() == null ? 0 : ((List<? extends CalculationPeriodDatesReference>) o.getCalculationPeriodDatesReference()).size(), 1, 0)
			);
	}
