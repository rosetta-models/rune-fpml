...
public class SettlementPeriodFixingDatesSequenceValidator implements Validator<SettlementPeriodFixingDatesSequence> {
	...
	public ValidationResult<SettlementPeriodFixingDatesSequence> validate(RosettaPath path, SettlementPeriodFixingDatesSequence o) {
		...
		if (!isNullOrEmpty(error)) {
			return failure("SettlementPeriodFixingDatesSequence", ValidationType.CARDINALITY, "SettlementPeriodFixingDatesSequence", path, "", error);
		}
		return success("SettlementPeriodFixingDatesSequence", ValidationType.CARDINALITY, "SettlementPeriodFixingDatesSequence", path, "");
	}
		...
		return getComparisonResults(o)
			...
			.map(res -> {
				if (!isNullOrEmpty(res.getError())) {
					return failure("SettlementPeriodFixingDatesSequence", ValidationType.CARDINALITY, "SettlementPeriodFixingDatesSequence", path, "", res.getError());
				}
				return success("SettlementPeriodFixingDatesSequence", ValidationType.CARDINALITY, "SettlementPeriodFixingDatesSequence", path, "");
			})
			.collect(toList());
