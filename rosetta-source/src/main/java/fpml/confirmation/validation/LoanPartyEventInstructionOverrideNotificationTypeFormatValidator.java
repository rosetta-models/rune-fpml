...
public class LoanPartyEventInstructionOverrideNotificationTypeFormatValidator implements Validator<LoanPartyEventInstructionOverrideNotification> {
	...
	public ValidationResult<LoanPartyEventInstructionOverrideNotification> validate(RosettaPath path, LoanPartyEventInstructionOverrideNotification o) {
		...
		if (!isNullOrEmpty(error)) {
			return failure("LoanPartyEventInstructionOverrideNotification", ValidationType.TYPE_FORMAT, "LoanPartyEventInstructionOverrideNotification", path, "", error);
		}
		return success("LoanPartyEventInstructionOverrideNotification", ValidationType.TYPE_FORMAT, "LoanPartyEventInstructionOverrideNotification", path, "");
	}
		...
		return getComparisonResults(o)
			...
			.map(res -> {
				if (!isNullOrEmpty(res.getError())) {
					return failure("LoanPartyEventInstructionOverrideNotification", ValidationType.TYPE_FORMAT, "LoanPartyEventInstructionOverrideNotification", path, "", res.getError());
				}
				return success("LoanPartyEventInstructionOverrideNotification", ValidationType.TYPE_FORMAT, "LoanPartyEventInstructionOverrideNotification", path, "");
			})
			.collect(toList());
