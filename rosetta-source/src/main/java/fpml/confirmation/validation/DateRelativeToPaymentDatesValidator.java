...
public class DateRelativeToPaymentDatesValidator implements Validator<DateRelativeToPaymentDates> {
	...
	private List<ComparisonResult> getComparisonResults(DateRelativeToPaymentDates o) {
		return Lists.<ComparisonResult>newArrayList(
				checkCardinality("paymentDatesReference", (List<? extends PaymentDatesReference>) o.getPaymentDatesReference() == null ? 0 : ((List<? extends PaymentDatesReference>) o.getPaymentDatesReference()).size(), 1, 0)
			);
	}
