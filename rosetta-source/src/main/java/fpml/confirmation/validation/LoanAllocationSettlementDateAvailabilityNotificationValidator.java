...
public class LoanAllocationSettlementDateAvailabilityNotificationValidator implements Validator<LoanAllocationSettlementDateAvailabilityNotification> {

	private List<ComparisonResult> getComparisonResults(LoanAllocationSettlementDateAvailabilityNotification o) {
		return Lists.<ComparisonResult>newArrayList(
				...
				checkCardinality("settlementDateAvailability", (List<? extends LoanSettlementDateAvailabilityEvent>) o.getSettlementDateAvailability() == null ? 0 : ((List<? extends LoanSettlementDateAvailabilityEvent>) o.getSettlementDateAvailability()).size(), 1, 0), 
	...
	@Override
	public ValidationResult<LoanAllocationSettlementDateAvailabilityNotification> validate(RosettaPath path, LoanAllocationSettlementDateAvailabilityNotification o) {
		...
		if (!isNullOrEmpty(error)) {
			return failure("LoanAllocationSettlementDateAvailabilityNotification", ValidationType.CARDINALITY, "LoanAllocationSettlementDateAvailabilityNotification", path, "", error);
		}
		return success("LoanAllocationSettlementDateAvailabilityNotification", ValidationType.CARDINALITY, "LoanAllocationSettlementDateAvailabilityNotification", path, "");
	}

	@Override
	public List<ValidationResult<?>> getValidationResults(RosettaPath path, LoanAllocationSettlementDateAvailabilityNotification o) {
		return getComparisonResults(o)
			.stream()
			.map(res -> {
				if (!isNullOrEmpty(res.getError())) {
					return failure("LoanAllocationSettlementDateAvailabilityNotification", ValidationType.CARDINALITY, "LoanAllocationSettlementDateAvailabilityNotification", path, "", res.getError());
				}
				return success("LoanAllocationSettlementDateAvailabilityNotification", ValidationType.CARDINALITY, "LoanAllocationSettlementDateAvailabilityNotification", path, "");
			})
			.collect(toList());
