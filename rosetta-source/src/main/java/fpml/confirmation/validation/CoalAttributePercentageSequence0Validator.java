...
public class CoalAttributePercentageSequence0Validator implements Validator<CoalAttributePercentageSequence0> {
	...
	public ValidationResult<CoalAttributePercentageSequence0> validate(RosettaPath path, CoalAttributePercentageSequence0 o) {
		...
		if (!isNullOrEmpty(error)) {
			return failure("CoalAttributePercentageSequence0", ValidationType.CARDINALITY, "CoalAttributePercentageSequence0", path, "", error);
		}
		return success("CoalAttributePercentageSequence0", ValidationType.CARDINALITY, "CoalAttributePercentageSequence0", path, "");
	}
		...
		return getComparisonResults(o)
			...
			.map(res -> {
				if (!isNullOrEmpty(res.getError())) {
					return failure("CoalAttributePercentageSequence0", ValidationType.CARDINALITY, "CoalAttributePercentageSequence0", path, "", res.getError());
				}
				return success("CoalAttributePercentageSequence0", ValidationType.CARDINALITY, "CoalAttributePercentageSequence0", path, "");
			})
			.collect(toList());
