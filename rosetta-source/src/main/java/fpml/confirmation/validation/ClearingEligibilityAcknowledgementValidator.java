...
public class ClearingEligibilityAcknowledgementValidator implements Validator<ClearingEligibilityAcknowledgement> {
	...
	public ValidationResult<ClearingEligibilityAcknowledgement> validate(RosettaPath path, ClearingEligibilityAcknowledgement o) {
		...
		if (!isNullOrEmpty(error)) {
			return failure("ClearingEligibilityAcknowledgement", ValidationType.CARDINALITY, "ClearingEligibilityAcknowledgement", path, "", error);
		}
		return success("ClearingEligibilityAcknowledgement", ValidationType.CARDINALITY, "ClearingEligibilityAcknowledgement", path, "");
	}
		...
		return getComparisonResults(o)
			...
			.map(res -> {
				if (!isNullOrEmpty(res.getError())) {
					return failure("ClearingEligibilityAcknowledgement", ValidationType.CARDINALITY, "ClearingEligibilityAcknowledgement", path, "", res.getError());
				}
				return success("ClearingEligibilityAcknowledgement", ValidationType.CARDINALITY, "ClearingEligibilityAcknowledgement", path, "");
			})
			.collect(toList());
