...
public class LetterOfCreditFacilityValidator implements Validator<LetterOfCreditFacility> {
	...
	@Override
	public ValidationResult<LetterOfCreditFacility> validate(RosettaPath path, LetterOfCreditFacility o) {
		...
		if (!isNullOrEmpty(error)) {
			return failure("LetterOfCreditFacility", ValidationType.CARDINALITY, "LetterOfCreditFacility", path, "", error);
		}
		return success("LetterOfCreditFacility", ValidationType.CARDINALITY, "LetterOfCreditFacility", path, "");
	}
		...
		return getComparisonResults(o)
			...
			.map(res -> {
				if (!isNullOrEmpty(res.getError())) {
					return failure("LetterOfCreditFacility", ValidationType.CARDINALITY, "LetterOfCreditFacility", path, "", res.getError());
				}
				return success("LetterOfCreditFacility", ValidationType.CARDINALITY, "LetterOfCreditFacility", path, "");
			})
			.collect(toList());
