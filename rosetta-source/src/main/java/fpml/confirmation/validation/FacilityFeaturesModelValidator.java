...
public class FacilityFeaturesModelValidator implements Validator<FacilityFeaturesModel> {
	...
	public ValidationResult<FacilityFeaturesModel> validate(RosettaPath path, FacilityFeaturesModel o) {
		...
		if (!isNullOrEmpty(error)) {
			return failure("FacilityFeaturesModel", ValidationType.CARDINALITY, "FacilityFeaturesModel", path, "", error);
		}
		return success("FacilityFeaturesModel", ValidationType.CARDINALITY, "FacilityFeaturesModel", path, "");
	}
		...
		return getComparisonResults(o)
			...
			.map(res -> {
				if (!isNullOrEmpty(res.getError())) {
					return failure("FacilityFeaturesModel", ValidationType.CARDINALITY, "FacilityFeaturesModel", path, "", res.getError());
				}
				return success("FacilityFeaturesModel", ValidationType.CARDINALITY, "FacilityFeaturesModel", path, "");
			})
			.collect(toList());
