...
public class AccruingPikOptionChangeValidator implements Validator<AccruingPikOptionChange> {
	...
	private List<ComparisonResult> getComparisonResults(AccruingPikOptionChange o) {
		return Lists.<ComparisonResult>newArrayList(
				...
				checkCardinality("accruingPikOption", (AccruingPikOption) o.getAccruingPikOption() != null ? 1 : 0, 1, 1)
			);
	}
	...
	public ValidationResult<AccruingPikOptionChange> validate(RosettaPath path, AccruingPikOptionChange o) {
		...
		if (!isNullOrEmpty(error)) {
			return failure("AccruingPikOptionChange", ValidationType.CARDINALITY, "AccruingPikOptionChange", path, "", error);
		}
		return success("AccruingPikOptionChange", ValidationType.CARDINALITY, "AccruingPikOptionChange", path, "");
	}
		...
		return getComparisonResults(o)
			...
			.map(res -> {
				if (!isNullOrEmpty(res.getError())) {
					return failure("AccruingPikOptionChange", ValidationType.CARDINALITY, "AccruingPikOptionChange", path, "", res.getError());
				}
				return success("AccruingPikOptionChange", ValidationType.CARDINALITY, "AccruingPikOptionChange", path, "");
			})
			.collect(toList());
