...
public class LoanTradeConfirmationNotificationTypeFormatValidator implements Validator<LoanTradeConfirmationNotification> {
	...
	public ValidationResult<LoanTradeConfirmationNotification> validate(RosettaPath path, LoanTradeConfirmationNotification o) {
		...
		if (!isNullOrEmpty(error)) {
			return failure("LoanTradeConfirmationNotification", ValidationType.TYPE_FORMAT, "LoanTradeConfirmationNotification", path, "", error);
		}
		return success("LoanTradeConfirmationNotification", ValidationType.TYPE_FORMAT, "LoanTradeConfirmationNotification", path, "");
	}
		...
		return getComparisonResults(o)
			...
			.map(res -> {
				if (!isNullOrEmpty(res.getError())) {
					return failure("LoanTradeConfirmationNotification", ValidationType.TYPE_FORMAT, "LoanTradeConfirmationNotification", path, "", res.getError());
				}
				return success("LoanTradeConfirmationNotification", ValidationType.TYPE_FORMAT, "LoanTradeConfirmationNotification", path, "");
			})
			.collect(toList());
