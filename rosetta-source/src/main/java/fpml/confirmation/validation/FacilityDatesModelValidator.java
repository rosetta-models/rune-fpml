...
public class FacilityDatesModelValidator implements Validator<FacilityDatesModel> {
	...
	public ValidationResult<FacilityDatesModel> validate(RosettaPath path, FacilityDatesModel o) {
		...
		if (!isNullOrEmpty(error)) {
			return failure("FacilityDatesModel", ValidationType.CARDINALITY, "FacilityDatesModel", path, "", error);
		}
		return success("FacilityDatesModel", ValidationType.CARDINALITY, "FacilityDatesModel", path, "");
	}
		...
		return getComparisonResults(o)
			...
			.map(res -> {
				if (!isNullOrEmpty(res.getError())) {
					return failure("FacilityDatesModel", ValidationType.CARDINALITY, "FacilityDatesModel", path, "", res.getError());
				}
				return success("FacilityDatesModel", ValidationType.CARDINALITY, "FacilityDatesModel", path, "");
			})
			.collect(toList());
