...
public class CommodityStrikePriceModelValidator implements Validator<CommodityStrikePriceModel> {
	...
	public ValidationResult<CommodityStrikePriceModel> validate(RosettaPath path, CommodityStrikePriceModel o) {
		...
		if (!isNullOrEmpty(error)) {
			return failure("CommodityStrikePriceModel", ValidationType.CARDINALITY, "CommodityStrikePriceModel", path, "", error);
		}
		return success("CommodityStrikePriceModel", ValidationType.CARDINALITY, "CommodityStrikePriceModel", path, "");
	}
		...
		return getComparisonResults(o)
			...
			.map(res -> {
				if (!isNullOrEmpty(res.getError())) {
					return failure("CommodityStrikePriceModel", ValidationType.CARDINALITY, "CommodityStrikePriceModel", path, "", res.getError());
				}
				return success("CommodityStrikePriceModel", ValidationType.CARDINALITY, "CommodityStrikePriceModel", path, "");
			})
			.collect(toList());
