...
public class AccruingFeeChangeNotificationTypeFormatValidator implements Validator<AccruingFeeChangeNotification> {
	...
	public ValidationResult<AccruingFeeChangeNotification> validate(RosettaPath path, AccruingFeeChangeNotification o) {
		...
		if (!isNullOrEmpty(error)) {
			return failure("AccruingFeeChangeNotification", ValidationType.TYPE_FORMAT, "AccruingFeeChangeNotification", path, "", error);
		}
		return success("AccruingFeeChangeNotification", ValidationType.TYPE_FORMAT, "AccruingFeeChangeNotification", path, "");
	}
		...
		return getComparisonResults(o)
			...
			.map(res -> {
				if (!isNullOrEmpty(res.getError())) {
					return failure("AccruingFeeChangeNotification", ValidationType.TYPE_FORMAT, "AccruingFeeChangeNotification", path, "", res.getError());
				}
				return success("AccruingFeeChangeNotification", ValidationType.TYPE_FORMAT, "AccruingFeeChangeNotification", path, "");
			})
			.collect(toList());
