...
public class NonCorrectableRequestMessageValidator implements Validator<NonCorrectableRequestMessage> {
	...
	public ValidationResult<NonCorrectableRequestMessage> validate(RosettaPath path, NonCorrectableRequestMessage o) {
		...
		if (!isNullOrEmpty(error)) {
			return failure("NonCorrectableRequestMessage", ValidationType.CARDINALITY, "NonCorrectableRequestMessage", path, "", error);
		}
		return success("NonCorrectableRequestMessage", ValidationType.CARDINALITY, "NonCorrectableRequestMessage", path, "");
	}
		...
		return getComparisonResults(o)
			...
			.map(res -> {
				if (!isNullOrEmpty(res.getError())) {
					return failure("NonCorrectableRequestMessage", ValidationType.CARDINALITY, "NonCorrectableRequestMessage", path, "", res.getError());
				}
				return success("NonCorrectableRequestMessage", ValidationType.CARDINALITY, "NonCorrectableRequestMessage", path, "");
			})
			.collect(toList());
