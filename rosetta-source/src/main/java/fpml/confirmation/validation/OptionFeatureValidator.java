...
public class OptionFeatureValidator implements Validator<OptionFeature> {
	...
	private List<ComparisonResult> getComparisonResults(OptionFeature o) {
		return Lists.<ComparisonResult>newArrayList(
				checkCardinality("optionBaseFeatureModel", (OptionBaseFeatureModel) o.getOptionBaseFeatureModel() != null ? 1 : 0, 1, 1), 
				checkCardinality("optionFeatureModel", (OptionFeatureModel) o.getOptionFeatureModel() != null ? 1 : 0, 1, 1)
			);
	}
