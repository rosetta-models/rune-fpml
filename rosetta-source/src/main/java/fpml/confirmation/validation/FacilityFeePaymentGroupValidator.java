...
public class FacilityFeePaymentGroupValidator implements Validator<FacilityFeePaymentGroup> {
	...
	public ValidationResult<FacilityFeePaymentGroup> validate(RosettaPath path, FacilityFeePaymentGroup o) {
		...
		if (!isNullOrEmpty(error)) {
			return failure("FacilityFeePaymentGroup", ValidationType.CARDINALITY, "FacilityFeePaymentGroup", path, "", error);
		}
		return success("FacilityFeePaymentGroup", ValidationType.CARDINALITY, "FacilityFeePaymentGroup", path, "");
	}
		...
		return getComparisonResults(o)
			...
			.map(res -> {
				if (!isNullOrEmpty(res.getError())) {
					return failure("FacilityFeePaymentGroup", ValidationType.CARDINALITY, "FacilityFeePaymentGroup", path, "", res.getError());
				}
				return success("FacilityFeePaymentGroup", ValidationType.CARDINALITY, "FacilityFeePaymentGroup", path, "");
			})
			.collect(toList());
