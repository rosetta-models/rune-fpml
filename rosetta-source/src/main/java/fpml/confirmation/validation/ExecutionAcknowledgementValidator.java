...
public class ExecutionAcknowledgementValidator implements Validator<ExecutionAcknowledgement> {
	...
	@Override
	public ValidationResult<ExecutionAcknowledgement> validate(RosettaPath path, ExecutionAcknowledgement o) {
		...
		if (!isNullOrEmpty(error)) {
			return failure("ExecutionAcknowledgement", ValidationType.CARDINALITY, "ExecutionAcknowledgement", path, "", error);
		}
		return success("ExecutionAcknowledgement", ValidationType.CARDINALITY, "ExecutionAcknowledgement", path, "");
	}
		...
		return getComparisonResults(o)
			...
			.map(res -> {
				if (!isNullOrEmpty(res.getError())) {
					return failure("ExecutionAcknowledgement", ValidationType.CARDINALITY, "ExecutionAcknowledgement", path, "", res.getError());
				}
				return success("ExecutionAcknowledgement", ValidationType.CARDINALITY, "ExecutionAcknowledgement", path, "");
			})
			.collect(toList());
