...
public class MaturityAcknowledgementValidator implements Validator<MaturityAcknowledgement> {
	...
	@Override
	public ValidationResult<MaturityAcknowledgement> validate(RosettaPath path, MaturityAcknowledgement o) {
		...
		if (!isNullOrEmpty(error)) {
			return failure("MaturityAcknowledgement", ValidationType.CARDINALITY, "MaturityAcknowledgement", path, "", error);
		}
		return success("MaturityAcknowledgement", ValidationType.CARDINALITY, "MaturityAcknowledgement", path, "");
	}
		...
		return getComparisonResults(o)
			...
			.map(res -> {
				if (!isNullOrEmpty(res.getError())) {
					return failure("MaturityAcknowledgement", ValidationType.CARDINALITY, "MaturityAcknowledgement", path, "", res.getError());
				}
				return success("MaturityAcknowledgement", ValidationType.CARDINALITY, "MaturityAcknowledgement", path, "");
			})
			.collect(toList());
