 ...
 */
@RosettaDataRule("MultipleExerciseChoice")
@ImplementedBy(MultipleExerciseChoice.Default.class)
public interface MultipleExerciseChoice extends Validator<MultipleExercise> {
	
	String NAME = "MultipleExerciseChoice";
	...
	class Default implements MultipleExerciseChoice {
	...
	class NoOp implements MultipleExerciseChoice {
