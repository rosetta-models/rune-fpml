...
public class LoanTransferSettlementNotificationTypeFormatValidator implements Validator<LoanTransferSettlementNotification> {
	...
	public ValidationResult<LoanTransferSettlementNotification> validate(RosettaPath path, LoanTransferSettlementNotification o) {
		...
		if (!isNullOrEmpty(error)) {
			return failure("LoanTransferSettlementNotification", ValidationType.TYPE_FORMAT, "LoanTransferSettlementNotification", path, "", error);
		}
		return success("LoanTransferSettlementNotification", ValidationType.TYPE_FORMAT, "LoanTransferSettlementNotification", path, "");
	}
		...
		return getComparisonResults(o)
			...
			.map(res -> {
				if (!isNullOrEmpty(res.getError())) {
					return failure("LoanTransferSettlementNotification", ValidationType.TYPE_FORMAT, "LoanTransferSettlementNotification", path, "", res.getError());
				}
				return success("LoanTransferSettlementNotification", ValidationType.TYPE_FORMAT, "LoanTransferSettlementNotification", path, "");
			})
			.collect(toList());
