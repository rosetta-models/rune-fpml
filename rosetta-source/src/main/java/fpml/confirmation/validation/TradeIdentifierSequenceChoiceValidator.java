...
public class TradeIdentifierSequenceChoiceValidator implements Validator<TradeIdentifierSequenceChoice> {
	...
	public ValidationResult<TradeIdentifierSequenceChoice> validate(RosettaPath path, TradeIdentifierSequenceChoice o) {
		...
		if (!isNullOrEmpty(error)) {
			return failure("TradeIdentifierSequenceChoice", ValidationType.CARDINALITY, "TradeIdentifierSequenceChoice", path, "", error);
		}
		return success("TradeIdentifierSequenceChoice", ValidationType.CARDINALITY, "TradeIdentifierSequenceChoice", path, "");
	}
		...
		return getComparisonResults(o)
			...
			.map(res -> {
				if (!isNullOrEmpty(res.getError())) {
					return failure("TradeIdentifierSequenceChoice", ValidationType.CARDINALITY, "TradeIdentifierSequenceChoice", path, "", res.getError());
				}
				return success("TradeIdentifierSequenceChoice", ValidationType.CARDINALITY, "TradeIdentifierSequenceChoice", path, "");
			})
			.collect(toList());
