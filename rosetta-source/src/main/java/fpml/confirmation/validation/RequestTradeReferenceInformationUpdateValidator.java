...
public class RequestTradeReferenceInformationUpdateValidator implements Validator<RequestTradeReferenceInformationUpdate> {
	...
	public ValidationResult<RequestTradeReferenceInformationUpdate> validate(RosettaPath path, RequestTradeReferenceInformationUpdate o) {
		...
		if (!isNullOrEmpty(error)) {
			return failure("RequestTradeReferenceInformationUpdate", ValidationType.CARDINALITY, "RequestTradeReferenceInformationUpdate", path, "", error);
		}
		return success("RequestTradeReferenceInformationUpdate", ValidationType.CARDINALITY, "RequestTradeReferenceInformationUpdate", path, "");
	}
		...
		return getComparisonResults(o)
			...
			.map(res -> {
				if (!isNullOrEmpty(res.getError())) {
					return failure("RequestTradeReferenceInformationUpdate", ValidationType.CARDINALITY, "RequestTradeReferenceInformationUpdate", path, "", res.getError());
				}
				return success("RequestTradeReferenceInformationUpdate", ValidationType.CARDINALITY, "RequestTradeReferenceInformationUpdate", path, "");
			})
			.collect(toList());
