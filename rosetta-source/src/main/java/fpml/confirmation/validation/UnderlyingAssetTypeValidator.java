...
public class UnderlyingAssetTypeValidator implements Validator<UnderlyingAssetType> {
	...
	public ValidationResult<UnderlyingAssetType> validate(RosettaPath path, UnderlyingAssetType o) {
		...
		if (!isNullOrEmpty(error)) {
			return failure("UnderlyingAssetType", ValidationType.CARDINALITY, "UnderlyingAssetType", path, "", error);
		}
		return success("UnderlyingAssetType", ValidationType.CARDINALITY, "UnderlyingAssetType", path, "");
	}
		...
		return getComparisonResults(o)
			...
			.map(res -> {
				if (!isNullOrEmpty(res.getError())) {
					return failure("UnderlyingAssetType", ValidationType.CARDINALITY, "UnderlyingAssetType", path, "", res.getError());
				}
				return success("UnderlyingAssetType", ValidationType.CARDINALITY, "UnderlyingAssetType", path, "");
			})
			.collect(toList());
