...
public class CommodityFixedPriceModelChoiceValidator implements Validator<CommodityFixedPriceModelChoice> {
	...
	public ValidationResult<CommodityFixedPriceModelChoice> validate(RosettaPath path, CommodityFixedPriceModelChoice o) {
		...
		if (!isNullOrEmpty(error)) {
			return failure("CommodityFixedPriceModelChoice", ValidationType.CARDINALITY, "CommodityFixedPriceModelChoice", path, "", error);
		}
		return success("CommodityFixedPriceModelChoice", ValidationType.CARDINALITY, "CommodityFixedPriceModelChoice", path, "");
	}
		...
		return getComparisonResults(o)
			...
			.map(res -> {
				if (!isNullOrEmpty(res.getError())) {
					return failure("CommodityFixedPriceModelChoice", ValidationType.CARDINALITY, "CommodityFixedPriceModelChoice", path, "", res.getError());
				}
				return success("CommodityFixedPriceModelChoice", ValidationType.CARDINALITY, "CommodityFixedPriceModelChoice", path, "");
			})
			.collect(toList());
