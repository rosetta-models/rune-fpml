 ...
 */
@RosettaDataType(value="OptionExerciseAmountsSequence0", builder=OptionExerciseAmountsSequence0.OptionExerciseAmountsSequence0BuilderImpl.class, version="0.0.0.master-SNAPSHOT")
