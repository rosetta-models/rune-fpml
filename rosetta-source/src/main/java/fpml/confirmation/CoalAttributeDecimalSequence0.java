 ...
 */
@RosettaDataType(value="CoalAttributeDecimalSequence0", builder=CoalAttributeDecimalSequence0.CoalAttributeDecimalSequence0BuilderImpl.class, version="0.0.0.master-SNAPSHOT")
