 ...
 */
@RosettaDataType(value="PartyTradeInformationSequence", builder=PartyTradeInformationSequence.PartyTradeInformationSequenceBuilderImpl.class, version="0.0.0.master-SNAPSHOT")
