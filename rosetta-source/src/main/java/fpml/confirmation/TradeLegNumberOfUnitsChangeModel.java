 ...
 */
@RosettaDataType(value="TradeLegNumberOfUnitsChangeModel", builder=TradeLegNumberOfUnitsChangeModel.TradeLegNumberOfUnitsChangeModelBuilderImpl.class, version="0.0.0.master-SNAPSHOT")
