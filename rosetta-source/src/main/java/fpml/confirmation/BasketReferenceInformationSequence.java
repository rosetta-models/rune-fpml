 ...
 */
@RosettaDataType(value="BasketReferenceInformationSequence", builder=BasketReferenceInformationSequence.BasketReferenceInformationSequenceBuilderImpl.class, version="0.0.0.master-SNAPSHOT")
