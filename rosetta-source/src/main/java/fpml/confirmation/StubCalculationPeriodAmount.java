...
import fpml.confirmation.StubCalculationPeriodAmount.StubCalculationPeriodAmountBuilder;
import fpml.confirmation.StubCalculationPeriodAmount.StubCalculationPeriodAmountBuilderImpl;
import fpml.confirmation.StubCalculationPeriodAmount.StubCalculationPeriodAmountImpl;
import fpml.confirmation.StubCalculationPeriodAmountSequence;
import fpml.confirmation.StubValue;
import fpml.confirmation.meta.StubCalculationPeriodAmountMeta;
...
public interface StubCalculationPeriodAmount extends RosettaModelObject {
	...
	StubCalculationPeriodAmountSequence getStubCalculationPeriodAmountSequence();
	/**
	...
	default void process(RosettaPath path, Processor processor) {
		...
		processRosetta(path.newSubPath("stubCalculationPeriodAmountSequence"), processor, StubCalculationPeriodAmountSequence.class, getStubCalculationPeriodAmountSequence());
	...
	interface StubCalculationPeriodAmountBuilder extends StubCalculationPeriodAmount, RosettaModelObjectBuilder {
		...
		StubCalculationPeriodAmountSequence.StubCalculationPeriodAmountSequenceBuilder getOrCreateStubCalculationPeriodAmountSequence();
		StubCalculationPeriodAmountSequence.StubCalculationPeriodAmountSequenceBuilder getStubCalculationPeriodAmountSequence();
		...
		StubCalculationPeriodAmount.StubCalculationPeriodAmountBuilder setStubCalculationPeriodAmountSequence(StubCalculationPeriodAmountSequence stubCalculationPeriodAmountSequence);
		...
		default void process(RosettaPath path, BuilderProcessor processor) {
			...
			processRosetta(path.newSubPath("stubCalculationPeriodAmountSequence"), processor, StubCalculationPeriodAmountSequence.StubCalculationPeriodAmountSequenceBuilder.class, getStubCalculationPeriodAmountSequence());
	...
	class StubCalculationPeriodAmountImpl implements StubCalculationPeriodAmount {
		...
		private final StubCalculationPeriodAmountSequence stubCalculationPeriodAmountSequence;
		...
		protected StubCalculationPeriodAmountImpl(StubCalculationPeriodAmount.StubCalculationPeriodAmountBuilder builder) {
			...
			this.stubCalculationPeriodAmountSequence = ofNullable(builder.getStubCalculationPeriodAmountSequence()).map(f->f.build()).orElse(null);
		...
		@Override
		@RosettaAttribute("stubCalculationPeriodAmountSequence")
		public StubCalculationPeriodAmountSequence getStubCalculationPeriodAmountSequence() {
		...
		protected void setBuilderFields(StubCalculationPeriodAmount.StubCalculationPeriodAmountBuilder builder) {
			...
			ofNullable(getStubCalculationPeriodAmountSequence()).ifPresent(builder::setStubCalculationPeriodAmountSequence);
		...
		public boolean equals(Object o) {
			...
			if (!Objects.equals(stubCalculationPeriodAmountSequence, _that.getStubCalculationPeriodAmountSequence())) return false;
		...
		public int hashCode() {
			...
			_result = 31 * _result + (stubCalculationPeriodAmountSequence != null ? stubCalculationPeriodAmountSequence.hashCode() : 0);
		...
		public String toString() {
			return "StubCalculationPeriodAmount {" +
				...
				"stubCalculationPeriodAmountSequence=" + this.stubCalculationPeriodAmountSequence + ", " +
	...
	class StubCalculationPeriodAmountBuilderImpl implements StubCalculationPeriodAmount.StubCalculationPeriodAmountBuilder {
		...
		protected StubCalculationPeriodAmountSequence.StubCalculationPeriodAmountSequenceBuilder stubCalculationPeriodAmountSequence;
		...
		@Override
		@RosettaAttribute("stubCalculationPeriodAmountSequence")
		public StubCalculationPeriodAmountSequence.StubCalculationPeriodAmountSequenceBuilder getStubCalculationPeriodAmountSequence() {
			return stubCalculationPeriodAmountSequence;
		}
		
		@Override
		public StubCalculationPeriodAmountSequence.StubCalculationPeriodAmountSequenceBuilder getOrCreateStubCalculationPeriodAmountSequence() {
			StubCalculationPeriodAmountSequence.StubCalculationPeriodAmountSequenceBuilder result;
			if (stubCalculationPeriodAmountSequence!=null) {
				result = stubCalculationPeriodAmountSequence;
			}
			else {
				result = stubCalculationPeriodAmountSequence = StubCalculationPeriodAmountSequence.builder();
			}
		...
		@Override
		@RosettaAttribute("calculationPeriodDatesReference")
		public StubCalculationPeriodAmount.StubCalculationPeriodAmountBuilder setCalculationPeriodDatesReference(CalculationPeriodDatesReference calculationPeriodDatesReference) {
			this.calculationPeriodDatesReference = calculationPeriodDatesReference==null?null:calculationPeriodDatesReference.toBuilder();
			return this;
		}
		@Override
		@RosettaAttribute("stubCalculationPeriodAmountSequence")
		public StubCalculationPeriodAmount.StubCalculationPeriodAmountBuilder setStubCalculationPeriodAmountSequence(StubCalculationPeriodAmountSequence stubCalculationPeriodAmountSequence) {
			this.stubCalculationPeriodAmountSequence = stubCalculationPeriodAmountSequence==null?null:stubCalculationPeriodAmountSequence.toBuilder();
			return this;
		}
		@Override
		@RosettaAttribute("finalStub")
		...
		public StubCalculationPeriodAmount.StubCalculationPeriodAmountBuilder prune() {
			...
			if (stubCalculationPeriodAmountSequence!=null && !stubCalculationPeriodAmountSequence.prune().hasData()) stubCalculationPeriodAmountSequence = null;
		...
		public boolean hasData() {
			...
			if (getStubCalculationPeriodAmountSequence()!=null && getStubCalculationPeriodAmountSequence().hasData()) return true;
		...
		public StubCalculationPeriodAmount.StubCalculationPeriodAmountBuilder merge(RosettaModelObjectBuilder other, BuilderMerger merger) {
			...
			merger.mergeRosetta(getStubCalculationPeriodAmountSequence(), o.getStubCalculationPeriodAmountSequence(), this::setStubCalculationPeriodAmountSequence);
