 ...
 */
@RosettaDataType(value="TradeLegNotionalChangeModel", builder=TradeLegNotionalChangeModel.TradeLegNotionalChangeModelBuilderImpl.class, version="0.0.0.master-SNAPSHOT")
