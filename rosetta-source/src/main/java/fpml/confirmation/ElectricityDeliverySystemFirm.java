 ...
 */
@RosettaDataType(value="ElectricityDeliverySystemFirm", builder=ElectricityDeliverySystemFirm.ElectricityDeliverySystemFirmBuilderImpl.class, version="0.0.0.master-SNAPSHOT")
