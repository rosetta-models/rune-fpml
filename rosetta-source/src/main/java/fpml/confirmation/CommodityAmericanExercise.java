 ...
 */
@RosettaDataType(value="CommodityAmericanExercise", builder=CommodityAmericanExercise.CommodityAmericanExerciseBuilderImpl.class, version="0.0.0.master-SNAPSHOT")
