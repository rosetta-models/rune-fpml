 ...
 */
@RosettaDataType(value="NoTouchUpperBarrierObservation", builder=NoTouchUpperBarrierObservation.NoTouchUpperBarrierObservationBuilderImpl.class, version="0.0.0.master-SNAPSHOT")
