 ...
 */
@RosettaDataType(value="DividendConditionsSequence", builder=DividendConditionsSequence.DividendConditionsSequenceBuilderImpl.class, version="0.0.0.master-SNAPSHOT")
