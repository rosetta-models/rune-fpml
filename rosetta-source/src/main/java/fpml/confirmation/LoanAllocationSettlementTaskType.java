 ...
 */
@RosettaDataType(value="LoanAllocationSettlementTaskType", builder=LoanAllocationSettlementTaskType.LoanAllocationSettlementTaskTypeBuilderImpl.class, version="0.0.0.master-SNAPSHOT")
