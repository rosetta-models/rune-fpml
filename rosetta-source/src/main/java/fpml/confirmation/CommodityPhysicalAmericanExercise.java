 ...
 */
@RosettaDataType(value="CommodityPhysicalAmericanExercise", builder=CommodityPhysicalAmericanExercise.CommodityPhysicalAmericanExerciseBuilderImpl.class, version="${project.version}")
