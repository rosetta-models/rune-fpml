 ...
 */
@RosettaDataType(value="FxAccrualRegionSequence0", builder=FxAccrualRegionSequence0.FxAccrualRegionSequence0BuilderImpl.class, version="0.0.0.master-SNAPSHOT")
