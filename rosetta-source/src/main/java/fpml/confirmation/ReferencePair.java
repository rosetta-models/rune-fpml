...
import fpml.confirmation.ReferencePair.ReferencePairBuilder;
import fpml.confirmation.ReferencePair.ReferencePairBuilderImpl;
import fpml.confirmation.ReferencePair.ReferencePairImpl;
import fpml.confirmation.meta.ReferencePairMeta;
...
public interface ReferencePair extends RosettaModelObject {
	...
	class ReferencePairBuilderImpl implements ReferencePair.ReferencePairBuilder {
		...
		@Override
		@RosettaAttribute("entityType")
		public ReferencePair.ReferencePairBuilder setEntityType(EntityType entityType) {
