 ...
 */
@RosettaDataType(value="TradingEventsBaseModelSequence", builder=TradingEventsBaseModelSequence.TradingEventsBaseModelSequenceBuilderImpl.class, version="0.0.0.master-SNAPSHOT")
