 ...
 */
@RosettaDataType(value="ReferenceObligationChoice", builder=ReferenceObligationChoice.ReferenceObligationChoiceBuilderImpl.class, version="0.0.0.master-SNAPSHOT")
