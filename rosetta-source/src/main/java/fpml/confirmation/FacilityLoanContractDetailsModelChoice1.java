 ...
 */
@RosettaDataType(value="FacilityLoanContractDetailsModelChoice1", builder=FacilityLoanContractDetailsModelChoice1.FacilityLoanContractDetailsModelChoice1BuilderImpl.class, version="0.0.0.master-SNAPSHOT")
