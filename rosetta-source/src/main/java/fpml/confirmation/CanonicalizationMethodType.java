 ...
 */
@RosettaDataType(value="CanonicalizationMethodType", builder=CanonicalizationMethodType.CanonicalizationMethodTypeBuilderImpl.class, version="0.0.0.master-SNAPSHOT")
