 ...
 */
@RosettaDataType(value="FxAccrualPayoffRegionReference", builder=FxAccrualPayoffRegionReference.FxAccrualPayoffRegionReferenceBuilderImpl.class, version="0.0.0.master-SNAPSHOT")
