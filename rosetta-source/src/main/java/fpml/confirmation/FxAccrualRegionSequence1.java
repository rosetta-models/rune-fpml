 ...
 */
@RosettaDataType(value="FxAccrualRegionSequence1", builder=FxAccrualRegionSequence1.FxAccrualRegionSequence1BuilderImpl.class, version="0.0.0.master-SNAPSHOT")
