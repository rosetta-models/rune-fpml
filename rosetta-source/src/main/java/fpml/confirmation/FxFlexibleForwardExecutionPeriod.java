 ...
 */
@RosettaDataType(value="FxFlexibleForwardExecutionPeriod", builder=FxFlexibleForwardExecutionPeriod.FxFlexibleForwardExecutionPeriodBuilderImpl.class, version="0.0.0.master-SNAPSHOT")
