 ...
 */
@RosettaDataType(value="FxSettlementPeriodBarrier", builder=FxSettlementPeriodBarrier.FxSettlementPeriodBarrierBuilderImpl.class, version="0.0.0.master-SNAPSHOT")
