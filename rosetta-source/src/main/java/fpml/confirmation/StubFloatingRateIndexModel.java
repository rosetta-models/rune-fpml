 ...
 */
@RosettaDataType(value="StubFloatingRateIndexModel", builder=StubFloatingRateIndexModel.StubFloatingRateIndexModelBuilderImpl.class, version="${project.version}")
