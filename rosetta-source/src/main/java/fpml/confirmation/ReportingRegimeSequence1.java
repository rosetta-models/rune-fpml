 ...
 */
@RosettaDataType(value="ReportingRegimeSequence1", builder=ReportingRegimeSequence1.ReportingRegimeSequence1BuilderImpl.class, version="0.0.0.master-SNAPSHOT")
