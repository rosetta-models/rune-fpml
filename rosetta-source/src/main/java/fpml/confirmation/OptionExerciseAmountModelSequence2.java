 ...
 */
@RosettaDataType(value="OptionExerciseAmountModelSequence2", builder=OptionExerciseAmountModelSequence2.OptionExerciseAmountModelSequence2BuilderImpl.class, version="0.0.0.master-SNAPSHOT")
