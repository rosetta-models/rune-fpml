 ...
 */
@RosettaDataType(value="StubCalculationPeriodSequence", builder=StubCalculationPeriodSequence.StubCalculationPeriodSequenceBuilderImpl.class, version="0.0.0.master-SNAPSHOT")
