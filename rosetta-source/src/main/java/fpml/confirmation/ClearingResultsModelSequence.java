 ...
 */
@RosettaDataType(value="ClearingResultsModelSequence", builder=ClearingResultsModelSequence.ClearingResultsModelSequenceBuilderImpl.class, version="0.0.0.master-SNAPSHOT")
