 ...
 */
@RosettaDataType(value="FxTargetPhysicalSettlement", builder=FxTargetPhysicalSettlement.FxTargetPhysicalSettlementBuilderImpl.class, version="0.0.0.master-SNAPSHOT")
