 ...
 */
@RosettaDataType(value="NoTouchLowerBarrierObservationSequence0", builder=NoTouchLowerBarrierObservationSequence0.NoTouchLowerBarrierObservationSequence0BuilderImpl.class, version="0.0.0.master-SNAPSHOT")
