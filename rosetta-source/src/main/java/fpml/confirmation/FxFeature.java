...
import fpml.confirmation.FxFeature.FxFeatureBuilder;
import fpml.confirmation.FxFeature.FxFeatureBuilderImpl;
import fpml.confirmation.FxFeature.FxFeatureImpl;
import fpml.confirmation.IdentifiedCurrency;
import fpml.confirmation.Quanto;
import fpml.confirmation.meta.FxFeatureMeta;
 ...
 */
@RosettaDataType(value="FxFeature", builder=FxFeature.FxFeatureBuilderImpl.class, version="0.0.0.master-SNAPSHOT")
public interface FxFeature extends RosettaModelObject {
	...
	class FxFeatureBuilderImpl implements FxFeature.FxFeatureBuilder {
		...
		@Override
		@RosettaAttribute("referenceCurrency")
		public FxFeature.FxFeatureBuilder setReferenceCurrency(IdentifiedCurrency referenceCurrency) {
