...
import fpml.confirmation.ResetDates.ResetDatesBuilder;
import fpml.confirmation.ResetDates.ResetDatesBuilderImpl;
import fpml.confirmation.ResetDates.ResetDatesImpl;
import fpml.confirmation.ResetFrequency;
import fpml.confirmation.ResetRelativeToEnum;
import fpml.confirmation.meta.ResetDatesMeta;
...
public interface ResetDates extends RosettaModelObject {
	...
	class ResetDatesBuilderImpl implements ResetDates.ResetDatesBuilder {
		...
		@Override
		@RosettaAttribute("calculationPeriodDatesReference")
		public ResetDates.ResetDatesBuilder setCalculationPeriodDatesReference(CalculationPeriodDatesReference calculationPeriodDatesReference) {
		...
		@Override
		@RosettaAttribute("initialFixingDate")
		public ResetDates.ResetDatesBuilder setInitialFixingDate(RelativeDateOffset initialFixingDate) {
		...
		@Override
		@RosettaAttribute("id")
		public ResetDates.ResetDatesBuilder setId(String id) {
