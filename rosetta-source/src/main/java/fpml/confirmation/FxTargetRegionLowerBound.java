 ...
 */
@RosettaDataType(value="FxTargetRegionLowerBound", builder=FxTargetRegionLowerBound.FxTargetRegionLowerBoundBuilderImpl.class, version="0.0.0.master-SNAPSHOT")
