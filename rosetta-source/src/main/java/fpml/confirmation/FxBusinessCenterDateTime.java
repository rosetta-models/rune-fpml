 ...
 */
@RosettaDataType(value="FxBusinessCenterDateTime", builder=FxBusinessCenterDateTime.FxBusinessCenterDateTimeBuilderImpl.class, version="0.0.0.master-SNAPSHOT")
