 ...
 */
@RosettaDataType(value="ParametricScheduleModelSequence0", builder=ParametricScheduleModelSequence0.ParametricScheduleModelSequence0BuilderImpl.class, version="${project.version}")
