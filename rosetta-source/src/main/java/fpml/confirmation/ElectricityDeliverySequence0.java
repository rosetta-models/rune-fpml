 ...
 */
@RosettaDataType(value="ElectricityDeliverySequence0", builder=ElectricityDeliverySequence0.ElectricityDeliverySequence0BuilderImpl.class, version="${project.version}")
