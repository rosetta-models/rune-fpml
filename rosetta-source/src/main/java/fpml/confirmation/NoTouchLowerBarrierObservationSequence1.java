 ...
 */
@RosettaDataType(value="NoTouchLowerBarrierObservationSequence1", builder=NoTouchLowerBarrierObservationSequence1.NoTouchLowerBarrierObservationSequence1BuilderImpl.class, version="0.0.0.master-SNAPSHOT")
