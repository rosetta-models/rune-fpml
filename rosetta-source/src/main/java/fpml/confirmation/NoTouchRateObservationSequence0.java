 ...
 */
@RosettaDataType(value="NoTouchRateObservationSequence0", builder=NoTouchRateObservationSequence0.NoTouchRateObservationSequence0BuilderImpl.class, version="0.0.0.master-SNAPSHOT")
