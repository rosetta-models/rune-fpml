 ...
 */
@RosettaDataType(value="FxTargetKnockoutForwardChoice", builder=FxTargetKnockoutForwardChoice.FxTargetKnockoutForwardChoiceBuilderImpl.class, version="0.0.0.master-SNAPSHOT")
