 ...
 */
@RosettaDataType(value="FxAccrualRegionUpperBound", builder=FxAccrualRegionUpperBound.FxAccrualRegionUpperBoundBuilderImpl.class, version="0.0.0.master-SNAPSHOT")
