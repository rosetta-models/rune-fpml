 ...
 */
@RosettaDataType(value="OptionalEarlyTerminationModel", builder=OptionalEarlyTerminationModel.OptionalEarlyTerminationModelBuilderImpl.class, version="0.0.0.master-SNAPSHOT")
