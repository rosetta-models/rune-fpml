 ...
 */
@RosettaDataType(value="FxComplexBarrierBaseSequence0", builder=FxComplexBarrierBaseSequence0.FxComplexBarrierBaseSequence0BuilderImpl.class, version="0.0.0.master-SNAPSHOT")
