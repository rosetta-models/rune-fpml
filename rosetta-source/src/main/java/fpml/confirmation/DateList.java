...
import fpml.confirmation.DateList.DateListBuilder;
import fpml.confirmation.DateList.DateListBuilderImpl;
import fpml.confirmation.DateList.DateListImpl;
import fpml.confirmation.meta.DateListMeta;
 ...
 */
@RosettaDataType(value="DateList", builder=DateList.DateListBuilderImpl.class, version="0.0.0.master-SNAPSHOT")
public interface DateList extends RosettaModelObject {
	...
	interface DateListBuilder extends DateList, RosettaModelObjectBuilder {
		...
		DateList.DateListBuilder addDate(List<Date> date2);
		DateList.DateListBuilder setDate(List<Date> date3);
