 ...
 */
@RosettaDataType(value="FxTargetRegionBoundModelSequence", builder=FxTargetRegionBoundModelSequence.FxTargetRegionBoundModelSequenceBuilderImpl.class, version="0.0.0.master-SNAPSHOT")
