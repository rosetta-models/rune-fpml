 ...
 */
@RosettaDataType(value="DSAKeyValueTypeSequence0", builder=DSAKeyValueTypeSequence0.DSAKeyValueTypeSequence0BuilderImpl.class, version="0.0.0.master-SNAPSHOT")
