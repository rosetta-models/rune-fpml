 ...
 */
@RosettaDataType(value="FxFixingScheduleSimpleSequence", builder=FxFixingScheduleSimpleSequence.FxFixingScheduleSimpleSequenceBuilderImpl.class, version="${project.version}")
