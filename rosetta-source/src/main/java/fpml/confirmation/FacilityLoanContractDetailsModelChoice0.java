 ...
 */
@RosettaDataType(value="FacilityLoanContractDetailsModelChoice0", builder=FacilityLoanContractDetailsModelChoice0.FacilityLoanContractDetailsModelChoice0BuilderImpl.class, version="0.0.0.master-SNAPSHOT")
