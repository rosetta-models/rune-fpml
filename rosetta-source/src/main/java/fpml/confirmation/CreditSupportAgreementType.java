 ...
 */
@RosettaDataType(value="CreditSupportAgreementType", builder=CreditSupportAgreementType.CreditSupportAgreementTypeBuilderImpl.class, version="0.0.0.master-SNAPSHOT")
