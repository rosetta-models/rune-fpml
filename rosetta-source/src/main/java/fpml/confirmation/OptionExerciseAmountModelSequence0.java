 ...
 */
@RosettaDataType(value="OptionExerciseAmountModelSequence0", builder=OptionExerciseAmountModelSequence0.OptionExerciseAmountModelSequence0BuilderImpl.class, version="0.0.0.master-SNAPSHOT")
