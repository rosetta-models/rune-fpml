 ...
 */
@RosettaDataType(value="NovationAmountsOldModelSequence1", builder=NovationAmountsOldModelSequence1.NovationAmountsOldModelSequence1BuilderImpl.class, version="0.0.0.master-SNAPSHOT")
