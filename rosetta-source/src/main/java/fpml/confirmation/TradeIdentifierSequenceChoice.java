 ...
 */
@RosettaDataType(value="TradeIdentifierSequenceChoice", builder=TradeIdentifierSequenceChoice.TradeIdentifierSequenceChoiceBuilderImpl.class, version="0.0.0.master-SNAPSHOT")
