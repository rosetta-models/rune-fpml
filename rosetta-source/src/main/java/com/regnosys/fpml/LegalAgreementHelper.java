...
public class LegalAgreementHelper {
    ...
    public Optional<LegalAgreement.LegalAgreementBuilder> getMasterAgreement(fpml.confirmation.MasterAgreement fpmlMasterAgreement) {
    ...
    public Optional<LegalAgreement.LegalAgreementBuilder> getMasterConfirmation(fpml.confirmation.MasterConfirmation fpmlMasterConfirmation) {
    ...
    public Optional<LegalAgreement.LegalAgreementBuilder> getCreditSupportAgreement(CreditSupportAgreement creditSupportAgreement) {
    ...
    public Optional<LegalAgreement.LegalAgreementBuilder> getConfirmation(Documentation documentation) {
        LegalAgreement.LegalAgreementBuilder builder = LegalAgreement.builder();
    ...
    private Optional<ContractualDefinitionsEnum> valueToContractualDefinitionsEnum(String value) {
        ...
        return Optional.ofNullable(switch (value) {
            case "ISDA1991" -> ContractualDefinitionsEnum.ISDA_1991_INTEREST_RATE;
            ...
            case "ISDA1997GovernmentBond" -> ContractualDefinitionsEnum.ISDA_1997_GOVERNMENT_BOND_OPTION;
    ...
    private Optional<CreditSupportAgreementTypeEnum> valueToCreditSupportAgreementTypeEnum(String value) {
        ...
        return Optional.ofNullable(switch (value) {
            ...
            case "ISDA1995CreditSupportDeedEnglishLaw" -> CreditSupportAgreementTypeEnum.CREDIT_SUPPORT_DEED;
            case "CreditSupportAnnex" -> CreditSupportAgreementTypeEnum.CREDIT_SUPPORT_ANNEX;
            case "ISDA1994CreditSupportAnnexNewYorkLaw" -> CreditSupportAgreementTypeEnum.CREDIT_SUPPORT_ANNEX;
            case "ISDA1995CreditSupportAnnexEnglishLaw" -> CreditSupportAgreementTypeEnum.CREDIT_SUPPORT_ANNEX;
            case "ISDA1995CreditSupportAnnexJapaneseLaw" -> CreditSupportAgreementTypeEnum.CREDIT_SUPPORT_ANNEX;
