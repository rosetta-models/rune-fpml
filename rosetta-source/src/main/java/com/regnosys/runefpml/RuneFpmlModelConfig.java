...
public class RuneFpmlModelConfig {
    ...
    // FPML_CONFIRMATION
    public static final ImmutableMap<Class<?>, String> FPML_CONFIRMATION_TYPE_TO_SCHEMA_MAP =
            ImmutableMap.<Class<?>, String>builder()
                    .put(Document.class, FPML_CONFIRMATION_SCHEMA_PATH)
                    .build();
    public static final ImmutableMap<Class<?>, String> FPML_CONFIRMATION_TYPE_TO_XML_CONFIG_MAP =
            ImmutableMap.<Class<?>, String>builder()
                    .put(Document.class, FPML_CONFIRMATION_XML_CONFIG_PATH)
                    .build();
    
    // FPML_RECORDKEEPING
    public static final ImmutableMap<Class<?>, String> FPML_RECORDKEEPING_TYPE_TO_SCHEMA_MAP =
            ImmutableMap.<Class<?>, String>builder()
                    .put(Document.class, FPML_RECORDKEEPING_SCHEMA_PATH)
                    .build();
    public static final ImmutableMap<Class<?>, String> FPML_RECORDKEEPING_TYPE_TO_XML_CONFIG_MAP =
            ImmutableMap.<Class<?>, String>builder()
                    .put(Document.class, FPML_RECORDKEEPING_XML_CONFIG_PATH)
                    .build();
}
