 ...
 */
@RosettaDataType(value="AdjustableOrAdjustedOrRelativeDate", builder=AdjustableOrAdjustedOrRelativeDate.AdjustableOrAdjustedOrRelativeDateBuilderImpl.class, version="6.0.0-dev.76")
