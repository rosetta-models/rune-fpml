 ...
 */
@RosettaDataType(value="Cash", builder=Cash.CashBuilderImpl.class, version="6.0.0-dev.76")
public interface Cash extends AssetBase {
	...
	interface CashBuilder extends Cash, AssetBase.AssetBaseBuilder {
		Cash.CashBuilder addIdentifier(AssetIdentifier identifier0);
		Cash.CashBuilder addIdentifier(AssetIdentifier identifier1, int _idx);
		Cash.CashBuilder addIdentifier(List<? extends AssetIdentifier> identifier2);
		Cash.CashBuilder setIdentifier(List<? extends AssetIdentifier> identifier3);
		Cash.CashBuilder addTaxonomy(Taxonomy taxonomy0);
		Cash.CashBuilder addTaxonomy(Taxonomy taxonomy1, int _idx);
		Cash.CashBuilder addTaxonomy(List<? extends Taxonomy> taxonomy2);
		Cash.CashBuilder setTaxonomy(List<? extends Taxonomy> taxonomy3);
		Cash.CashBuilder setIsExchangeListed(Boolean isExchangeListed);
		Cash.CashBuilder setExchange(LegalEntity exchange);
		Cash.CashBuilder addRelatedExchange(LegalEntity relatedExchange0);
		Cash.CashBuilder addRelatedExchange(LegalEntity relatedExchange1, int _idx);
		Cash.CashBuilder addRelatedExchange(List<? extends LegalEntity> relatedExchange2);
		Cash.CashBuilder setRelatedExchange(List<? extends LegalEntity> relatedExchange3);
	...
	class CashBuilderImpl extends AssetBase.AssetBaseBuilderImpl  implements Cash.CashBuilder {
		...
		public Cash.CashBuilder addIdentifier(AssetIdentifier identifier) {
			if (identifier!=null) this.identifier.add(identifier.toBuilder());
			return this;
		}
		
		@Override
		public Cash.CashBuilder addIdentifier(AssetIdentifier identifier, int _idx) {
		...
		public Cash.CashBuilder addTaxonomy(Taxonomy taxonomy) {
			if (taxonomy!=null) this.taxonomy.add(taxonomy.toBuilder());
			return this;
		}
		
		@Override
		public Cash.CashBuilder addTaxonomy(Taxonomy taxonomy, int _idx) {
		...
		public Cash.CashBuilder setIsExchangeListed(Boolean isExchangeListed) {
			this.isExchangeListed = isExchangeListed==null?null:isExchangeListed;
			return this;
		}
		@Override
		@RosettaAttribute("exchange")
		public Cash.CashBuilder setExchange(LegalEntity exchange) {
			this.exchange = exchange==null?null:exchange.toBuilder();
			return this;
		}
		@Override
		@RosettaAttribute("relatedExchange")
		public Cash.CashBuilder addRelatedExchange(LegalEntity relatedExchange) {
			if (relatedExchange!=null) this.relatedExchange.add(relatedExchange.toBuilder());
			return this;
		}
		
		@Override
		public Cash.CashBuilder addRelatedExchange(LegalEntity relatedExchange, int _idx) {
