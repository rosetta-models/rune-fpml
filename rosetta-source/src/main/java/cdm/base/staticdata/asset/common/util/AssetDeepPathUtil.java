...
public class AssetDeepPathUtil {
	...
	public Boolean chooseIsExchangeListed(Asset asset) {
		...
		final MapperS<Commodity> commodity = MapperS.of(asset).<FieldWithMetaCommodity>map("getCommodity", _asset -> _asset.getCommodity()).<Commodity>map("getValue", _f->_f.getValue());
