 ...
 */
@RosettaDataType(value="AssetIdentifier", builder=AssetIdentifier.AssetIdentifierBuilderImpl.class, version="6.0.0-dev.76")
public interface AssetIdentifier extends RosettaModelObject {
	...
	interface AssetIdentifierBuilder extends AssetIdentifier, RosettaModelObjectBuilder {
		...
		AssetIdentifier.AssetIdentifierBuilder setIdentifier(FieldWithMetaString identifier0);
		AssetIdentifier.AssetIdentifierBuilder setIdentifierValue(String identifier1);
	...
	class AssetIdentifierBuilderImpl implements AssetIdentifier.AssetIdentifierBuilder {
		...
		public AssetIdentifierBuilderImpl() {
		}
		...
		@Override
		@RosettaAttribute("identifier")
		public AssetIdentifier.AssetIdentifierBuilder setIdentifier(FieldWithMetaString identifier) {
			this.identifier = identifier==null?null:identifier.toBuilder();
			return this;
		}
		@Override
		public AssetIdentifier.AssetIdentifierBuilder setIdentifierValue(String identifier) {
			this.getOrCreateIdentifier().setValue(identifier);
			return this;
		}
		@Override
		@RosettaAttribute("identifierType")
		public AssetIdentifier.AssetIdentifierBuilder setIdentifierType(AssetIdTypeEnum identifierType) {
