 ...
 */
@RosettaDataType(value="SpecialPurposeVehicleIssuerType", builder=SpecialPurposeVehicleIssuerType.SpecialPurposeVehicleIssuerTypeBuilderImpl.class, version="6.0.0-dev.76")
