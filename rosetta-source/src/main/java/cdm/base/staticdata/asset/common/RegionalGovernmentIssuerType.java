 ...
 */
@RosettaDataType(value="RegionalGovernmentIssuerType", builder=RegionalGovernmentIssuerType.RegionalGovernmentIssuerTypeBuilderImpl.class, version="6.0.0-dev.76")
