 ...
 */
@RosettaDataType(value="InstrumentBase", builder=InstrumentBase.InstrumentBaseBuilderImpl.class, version="6.0.0-dev.76")
public interface InstrumentBase extends AssetBase {
	...
	interface InstrumentBaseBuilder extends InstrumentBase, AssetBase.AssetBaseBuilder {
		InstrumentBase.InstrumentBaseBuilder addIdentifier(AssetIdentifier identifier0);
		InstrumentBase.InstrumentBaseBuilder addIdentifier(AssetIdentifier identifier1, int _idx);
		InstrumentBase.InstrumentBaseBuilder addIdentifier(List<? extends AssetIdentifier> identifier2);
		InstrumentBase.InstrumentBaseBuilder setIdentifier(List<? extends AssetIdentifier> identifier3);
		InstrumentBase.InstrumentBaseBuilder addTaxonomy(Taxonomy taxonomy0);
		InstrumentBase.InstrumentBaseBuilder addTaxonomy(Taxonomy taxonomy1, int _idx);
		InstrumentBase.InstrumentBaseBuilder addTaxonomy(List<? extends Taxonomy> taxonomy2);
		InstrumentBase.InstrumentBaseBuilder setTaxonomy(List<? extends Taxonomy> taxonomy3);
		...
		InstrumentBase.InstrumentBaseBuilder addRelatedExchange(LegalEntity relatedExchange0);
		InstrumentBase.InstrumentBaseBuilder addRelatedExchange(LegalEntity relatedExchange1, int _idx);
		InstrumentBase.InstrumentBaseBuilder addRelatedExchange(List<? extends LegalEntity> relatedExchange2);
		InstrumentBase.InstrumentBaseBuilder setRelatedExchange(List<? extends LegalEntity> relatedExchange3);
	...
	class InstrumentBaseBuilderImpl extends AssetBase.AssetBaseBuilderImpl  implements InstrumentBase.InstrumentBaseBuilder {
		...
		public InstrumentBaseBuilderImpl() {
		}
	
		@Override
		@RosettaAttribute("identifier")
		public InstrumentBase.InstrumentBaseBuilder addIdentifier(AssetIdentifier identifier) {
			if (identifier!=null) this.identifier.add(identifier.toBuilder());
			return this;
		}
		
		@Override
		public InstrumentBase.InstrumentBaseBuilder addIdentifier(AssetIdentifier identifier, int _idx) {
		...
		public InstrumentBase.InstrumentBaseBuilder addTaxonomy(Taxonomy taxonomy) {
			if (taxonomy!=null) this.taxonomy.add(taxonomy.toBuilder());
			return this;
		}
		
		@Override
		public InstrumentBase.InstrumentBaseBuilder addTaxonomy(Taxonomy taxonomy, int _idx) {
		...
		public InstrumentBase.InstrumentBaseBuilder setIsExchangeListed(Boolean isExchangeListed) {
			this.isExchangeListed = isExchangeListed==null?null:isExchangeListed;
			return this;
		}
		@Override
		@RosettaAttribute("exchange")
		public InstrumentBase.InstrumentBaseBuilder setExchange(LegalEntity exchange) {
			this.exchange = exchange==null?null:exchange.toBuilder();
			return this;
		}
		@Override
		@RosettaAttribute("relatedExchange")
		public InstrumentBase.InstrumentBaseBuilder addRelatedExchange(LegalEntity relatedExchange) {
			if (relatedExchange!=null) this.relatedExchange.add(relatedExchange.toBuilder());
			return this;
		}
		
		@Override
		public InstrumentBase.InstrumentBaseBuilder addRelatedExchange(LegalEntity relatedExchange, int _idx) {
