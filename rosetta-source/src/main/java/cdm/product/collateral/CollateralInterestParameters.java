 ...
 */
@RosettaDataType(value="CollateralInterestParameters", builder=CollateralInterestParameters.CollateralInterestParametersBuilderImpl.class, version="6.0.0-dev.76")
