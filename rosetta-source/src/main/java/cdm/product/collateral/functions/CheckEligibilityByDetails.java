	...
	*/
	...
	public static class CheckEligibilityByDetailsDefault extends CheckEligibilityByDetails {
		...
		protected MapperC<? extends EligibleCollateralCriteria> matchingEligibleCriteria(EligibleCollateralSpecification specification, EligibilityQuery query) {
			final MapperC<EligibleCollateralCriteria> thenArg0 = MapperS.of(specification).<EligibleCollateralCriteria>mapC("getCriteria", eligibleCollateralSpecification -> eligibleCollateralSpecification.getCriteria())
			...
			final MapperC<EligibleCollateralCriteria> thenArg1 = thenArg0
				.filterItemNullSafe(item -> {
					final MapperC<AssetCriteria> _thenArg0 = item.<AssetCriteria>mapC("getAsset", eligibleCollateralCriteria -> eligibleCollateralCriteria.getAsset());
					final MapperC<AssetCriteria> _thenArg1 = _thenArg0
					...
					final MapperC<AssetCriteria> thenArg2 = _thenArg1
					...
					final MapperC<AssetCriteria> thenArg3 = thenArg2
					...
					final MapperC<AssetCriteria> thenArg4 = thenArg3
					...
					final MapperC<AssetCriteria> thenArg5 = thenArg4
					...
					return exists(thenArg5).asMapper().get();
				});
			return thenArg1
				.filterItemNullSafe(item -> {
					final MapperC<IssuerCriteria> _thenArg0 = item.<IssuerCriteria>mapC("getIssuer", eligibleCollateralCriteria -> eligibleCollateralCriteria.getIssuer());
					final MapperC<IssuerCriteria> _thenArg1 = _thenArg0
					...
					final MapperC<IssuerCriteria> thenArg2 = _thenArg1
					...
					return exists(thenArg2).asMapper().get();
				});
		}
	}
}
