 ...
 */
@RosettaDataType(value="CollateralValuationTreatment", builder=CollateralValuationTreatment.CollateralValuationTreatmentBuilderImpl.class, version="6.0.0-dev.76")
