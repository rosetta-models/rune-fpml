...
;
	private static Map<String, RepoTypeEnum> values;
	static {
        Map<String, RepoTypeEnum> map = new ConcurrentHashMap<>();
		for (RepoTypeEnum instance : RepoTypeEnum.values()) {
	...
	RepoTypeEnum(String rosettaName, String displayName) {
		this.rosettaName = rosettaName;
		this.displayName = displayName;
	}

	public static RepoTypeEnum fromDisplayName(String name) {
		RepoTypeEnum value = values.get(name);
		if (value == null) {
