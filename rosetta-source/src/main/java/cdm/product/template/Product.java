 ...
 */
@RosettaDataType(value="Product", builder=Product.ProductBuilderImpl.class, version="6.0.0-dev.76")
public interface Product extends RosettaModelObject {
	...
	class ProductBuilderImpl implements Product.ProductBuilder {
		...
		@Override
		@RosettaAttribute("TransferableProduct")
		public Product.ProductBuilder setTransferableProduct(TransferableProduct transferableProduct) {
			this.transferableProduct = transferableProduct==null?null:transferableProduct.toBuilder();
			return this;
		}
		@Override
		@RosettaAttribute("NonTransferableProduct")
		public Product.ProductBuilder setNonTransferableProduct(NonTransferableProduct nonTransferableProduct) {
			this.nonTransferableProduct = nonTransferableProduct==null?null:nonTransferableProduct.toBuilder();
			return this;
		}
