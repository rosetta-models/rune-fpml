 ...
 */
@RosettaDataType(value="ExtendibleProvision", builder=ExtendibleProvision.ExtendibleProvisionBuilderImpl.class, version="6.0.0-dev.76")
public interface ExtendibleProvision extends BuyerSeller {
	...
	class ExtendibleProvisionBuilderImpl extends BuyerSeller.BuyerSellerBuilderImpl  implements ExtendibleProvision.ExtendibleProvisionBuilder {
		...
		@Override
		@RosettaAttribute("exerciseTerms")
		public ExtendibleProvision.ExtendibleProvisionBuilder setExerciseTerms(ExerciseTerms exerciseTerms) {
