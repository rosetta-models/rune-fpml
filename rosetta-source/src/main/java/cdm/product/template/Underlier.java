 ...
 */
@RosettaDataType(value="Underlier", builder=Underlier.UnderlierBuilderImpl.class, version="6.0.0-dev.76")
public interface Underlier extends RosettaModelObject {
	...
	interface UnderlierBuilder extends Underlier, RosettaModelObjectBuilder {
		...
		Underlier.UnderlierBuilder setObservable(ReferenceWithMetaObservable Observable0);
		Underlier.UnderlierBuilder setObservableValue(Observable Observable1);
	...
	class UnderlierBuilderImpl implements Underlier.UnderlierBuilder {
		...
		@Override
		@RosettaAttribute("Observable")
		public Underlier.UnderlierBuilder setObservable(ReferenceWithMetaObservable observable) {
			this.observable = observable==null?null:observable.toBuilder();
			return this;
		}
		@Override
		public Underlier.UnderlierBuilder setObservableValue(Observable observable) {
			this.getOrCreateObservable().setValue(observable);
			return this;
		}
		@Override
		@RosettaAttribute("Product")
		public Underlier.UnderlierBuilder setProduct(Product product) {
