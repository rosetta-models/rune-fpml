 ...
 */
@RosettaDataType(value="OptionPayout", builder=OptionPayout.OptionPayoutBuilderImpl.class, version="6.0.0-dev.76")
public interface OptionPayout extends PayoutBase, GlobalKey {
	...
	class OptionPayoutBuilderImpl extends PayoutBase.PayoutBaseBuilderImpl  implements OptionPayout.OptionPayoutBuilder, GlobalKeyBuilder {
		...
		@Override
		@RosettaAttribute("exerciseTerms")
		public OptionPayout.OptionPayoutBuilder setExerciseTerms(ExerciseTerms exerciseTerms) {
			this.exerciseTerms = exerciseTerms==null?null:exerciseTerms.toBuilder();
			return this;
		}
		@Override
		@RosettaAttribute("strike")
		public OptionPayout.OptionPayoutBuilder setStrike(OptionStrike strike) {
