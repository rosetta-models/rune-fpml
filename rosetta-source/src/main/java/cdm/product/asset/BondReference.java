 ...
 */
@RosettaDataType(value="BondReference", builder=BondReference.BondReferenceBuilderImpl.class, version="6.0.0-dev.76")
public interface BondReference extends RosettaModelObject {
	...
	class BondReferenceBuilderImpl implements BondReference.BondReferenceBuilder {
		...
		@Override
		@RosettaAttribute("bond")
		public BondReference.BondReferenceBuilder setBond(Security bond) {
