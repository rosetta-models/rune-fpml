 ...
 */
@RosettaDataType(value="FloatingRate", builder=FloatingRate.FloatingRateBuilderImpl.class, version="6.0.0-dev.76")
public interface FloatingRate extends FloatingRateBase {
	...
	interface FloatingRateBuilder extends FloatingRate, FloatingRateBase.FloatingRateBaseBuilder {
		...
		FloatingRate.FloatingRateBuilder setRateOption(ReferenceWithMetaFloatingRateIndex rateOption0);
		FloatingRate.FloatingRateBuilder setRateOptionValue(FloatingRateIndex rateOption1);
	...
	class FloatingRateBuilderImpl extends FloatingRateBase.FloatingRateBaseBuilderImpl  implements FloatingRate.FloatingRateBuilder {
		...
		public FloatingRate.FloatingRateBuilder setRateOption(ReferenceWithMetaFloatingRateIndex rateOption) {
			this.rateOption = rateOption==null?null:rateOption.toBuilder();
			return this;
		}
		@Override
		public FloatingRate.FloatingRateBuilder setRateOptionValue(FloatingRateIndex rateOption) {
