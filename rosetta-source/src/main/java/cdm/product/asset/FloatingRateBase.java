 ...
 */
@RosettaDataType(value="FloatingRateBase", builder=FloatingRateBase.FloatingRateBaseBuilderImpl.class, version="6.0.0-dev.76")
public interface FloatingRateBase extends RosettaModelObject, GlobalKey {
	...
	/*********************** Getter Methods  ***********************/
	ReferenceWithMetaFloatingRateIndex getRateOption();
	/**
	...
	interface FloatingRateBaseBuilder extends FloatingRateBase, RosettaModelObjectBuilder {
		ReferenceWithMetaFloatingRateIndex.ReferenceWithMetaFloatingRateIndexBuilder getOrCreateRateOption();
		ReferenceWithMetaFloatingRateIndex.ReferenceWithMetaFloatingRateIndexBuilder getRateOption();
		...
		FloatingRateBase.FloatingRateBaseBuilder setRateOption(ReferenceWithMetaFloatingRateIndex rateOption0);
		FloatingRateBase.FloatingRateBaseBuilder setRateOptionValue(FloatingRateIndex rateOption1);
	...
	class FloatingRateBaseImpl implements FloatingRateBase {
		private final ReferenceWithMetaFloatingRateIndex rateOption;
		...
		public ReferenceWithMetaFloatingRateIndex getRateOption() {
			return rateOption;
		}
	...
	class FloatingRateBaseBuilderImpl implements FloatingRateBase.FloatingRateBaseBuilder, GlobalKeyBuilder {
		...
		protected ReferenceWithMetaFloatingRateIndex.ReferenceWithMetaFloatingRateIndexBuilder rateOption;
		...
		@Override
		@RosettaAttribute("rateOption")
		public ReferenceWithMetaFloatingRateIndex.ReferenceWithMetaFloatingRateIndexBuilder getRateOption() {
			return rateOption;
		}
		
		@Override
		public ReferenceWithMetaFloatingRateIndex.ReferenceWithMetaFloatingRateIndexBuilder getOrCreateRateOption() {
			ReferenceWithMetaFloatingRateIndex.ReferenceWithMetaFloatingRateIndexBuilder result;
			if (rateOption!=null) {
				result = rateOption;
			}
			else {
				result = rateOption = ReferenceWithMetaFloatingRateIndex.builder();
			}
		...
		@Override
		@RosettaAttribute("rateOption")
		public FloatingRateBase.FloatingRateBaseBuilder setRateOption(ReferenceWithMetaFloatingRateIndex rateOption) {
			this.rateOption = rateOption==null?null:rateOption.toBuilder();
			return this;
		}
		@Override
		public FloatingRateBase.FloatingRateBaseBuilder setRateOptionValue(FloatingRateIndex rateOption) {
