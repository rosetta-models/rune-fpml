 ...
 */
@RosettaDataType(value="DividendPeriod", builder=DividendPeriod.DividendPeriodBuilderImpl.class, version="6.0.0-dev.76")
public interface DividendPeriod extends RosettaModelObject {
	...
	interface DividendPeriodBuilder extends DividendPeriod, RosettaModelObjectBuilder {
		...
		DividendPeriod.DividendPeriodBuilder setBasketConstituent(ReferenceWithMetaBasketConstituent basketConstituent0);
		DividendPeriod.DividendPeriodBuilder setBasketConstituentValue(BasketConstituent basketConstituent1);
	...
	class DividendPeriodBuilderImpl implements DividendPeriod.DividendPeriodBuilder {
		...
		@Override
		@RosettaAttribute("basketConstituent")
		public DividendPeriod.DividendPeriodBuilder setBasketConstituent(ReferenceWithMetaBasketConstituent basketConstituent) {
			this.basketConstituent = basketConstituent==null?null:basketConstituent.toBuilder();
			return this;
		}
		@Override
		public DividendPeriod.DividendPeriodBuilder setBasketConstituentValue(BasketConstituent basketConstituent) {
