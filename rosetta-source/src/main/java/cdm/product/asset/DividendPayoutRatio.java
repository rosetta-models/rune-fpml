 ...
 */
@RosettaDataType(value="DividendPayoutRatio", builder=DividendPayoutRatio.DividendPayoutRatioBuilderImpl.class, version="6.0.0-dev.76")
public interface DividendPayoutRatio extends RosettaModelObject {
	...
	interface DividendPayoutRatioBuilder extends DividendPayoutRatio, RosettaModelObjectBuilder {
		...
		DividendPayoutRatio.DividendPayoutRatioBuilder setBasketConstituent(ReferenceWithMetaBasketConstituent basketConstituent0);
		DividendPayoutRatio.DividendPayoutRatioBuilder setBasketConstituentValue(BasketConstituent basketConstituent1);
	...
	class DividendPayoutRatioBuilderImpl implements DividendPayoutRatio.DividendPayoutRatioBuilder {
		...
		@Override
		@RosettaAttribute("basketConstituent")
		public DividendPayoutRatio.DividendPayoutRatioBuilder setBasketConstituent(ReferenceWithMetaBasketConstituent basketConstituent) {
			this.basketConstituent = basketConstituent==null?null:basketConstituent.toBuilder();
			return this;
		}
		@Override
		public DividendPayoutRatio.DividendPayoutRatioBuilder setBasketConstituentValue(BasketConstituent basketConstituent) {
			this.getOrCreateBasketConstituent().setValue(basketConstituent);
			return this;
		}
