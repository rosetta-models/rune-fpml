 ...
 */
@RosettaDataType(value="RateSpecification", builder=RateSpecification.RateSpecificationBuilderImpl.class, version="6.0.0-dev.76")
public interface RateSpecification extends RosettaModelObject {
	...
	class RateSpecificationBuilderImpl implements RateSpecification.RateSpecificationBuilder {
		...
		@Override
		@RosettaAttribute("FixedRateSpecification")
		public RateSpecification.RateSpecificationBuilder setFixedRateSpecification(FixedRateSpecification fixedRateSpecification) {
			this.fixedRateSpecification = fixedRateSpecification==null?null:fixedRateSpecification.toBuilder();
			return this;
		}
		@Override
		@RosettaAttribute("FloatingRateSpecification")
		public RateSpecification.RateSpecificationBuilder setFloatingRateSpecification(FloatingRateSpecification floatingRateSpecification) {
			this.floatingRateSpecification = floatingRateSpecification==null?null:floatingRateSpecification.toBuilder();
			return this;
		}
		@Override
		@RosettaAttribute("InflationRateSpecification")
		public RateSpecification.RateSpecificationBuilder setInflationRateSpecification(InflationRateSpecification inflationRateSpecification) {
			this.inflationRateSpecification = inflationRateSpecification==null?null:inflationRateSpecification.toBuilder();
			return this;
		}
