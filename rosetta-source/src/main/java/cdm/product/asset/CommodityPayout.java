 ...
 */
@RosettaDataType(value="CommodityPayout", builder=CommodityPayout.CommodityPayoutBuilderImpl.class, version="6.0.0-dev.76")
public interface CommodityPayout extends PayoutBase, GlobalKey {
	 ...
	 */
	ReferenceWithMetaCommodity getUnderlier();
	/**
	...
	default void process(RosettaPath path, Processor processor) {
		...
		processRosetta(path.newSubPath("underlier"), processor, ReferenceWithMetaCommodity.class, getUnderlier());
	...
	interface CommodityPayoutBuilder extends CommodityPayout, PayoutBase.PayoutBaseBuilder {
		...
		ReferenceWithMetaCommodity.ReferenceWithMetaCommodityBuilder getOrCreateUnderlier();
		ReferenceWithMetaCommodity.ReferenceWithMetaCommodityBuilder getUnderlier();
		...
		CommodityPayout.CommodityPayoutBuilder setUnderlier(ReferenceWithMetaCommodity underlier0);
		CommodityPayout.CommodityPayoutBuilder setUnderlierValue(Commodity underlier1);
		...
		default void process(RosettaPath path, BuilderProcessor processor) {
			...
			processRosetta(path.newSubPath("underlier"), processor, ReferenceWithMetaCommodity.ReferenceWithMetaCommodityBuilder.class, getUnderlier());
	...
	class CommodityPayoutImpl extends PayoutBase.PayoutBaseImpl implements CommodityPayout {
		...
		private final ReferenceWithMetaCommodity underlier;
		...
		public ReferenceWithMetaCommodity getUnderlier() {
			return underlier;
		}
	...
	class CommodityPayoutBuilderImpl extends PayoutBase.PayoutBaseBuilderImpl  implements CommodityPayout.CommodityPayoutBuilder, GlobalKeyBuilder {
		...
		protected ReferenceWithMetaCommodity.ReferenceWithMetaCommodityBuilder underlier;
		...
		@Override
		@RosettaAttribute("underlier")
		public ReferenceWithMetaCommodity.ReferenceWithMetaCommodityBuilder getUnderlier() {
			return underlier;
		}
		
		@Override
		public ReferenceWithMetaCommodity.ReferenceWithMetaCommodityBuilder getOrCreateUnderlier() {
			ReferenceWithMetaCommodity.ReferenceWithMetaCommodityBuilder result;
			if (underlier!=null) {
				result = underlier;
			}
			else {
				result = underlier = ReferenceWithMetaCommodity.builder();
			}
		...
		@Override
		@RosettaAttribute("underlier")
		public CommodityPayout.CommodityPayoutBuilder setUnderlier(ReferenceWithMetaCommodity underlier) {
			this.underlier = underlier==null?null:underlier.toBuilder();
			return this;
		}
		@Override
		public CommodityPayout.CommodityPayoutBuilder setUnderlierValue(Commodity underlier) {
