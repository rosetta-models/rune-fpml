 ...
 */
@RosettaDataType(value="VarianceReturnTerms", builder=VarianceReturnTerms.VarianceReturnTermsBuilderImpl.class, version="6.0.0-dev.76")
public interface VarianceReturnTerms extends ReturnTermsBase {
	...
	interface VarianceReturnTermsBuilder extends VarianceReturnTerms, ReturnTermsBase.ReturnTermsBaseBuilder {
		...
		VarianceReturnTerms.VarianceReturnTermsBuilder setExchangeTradedContractNearest(ReferenceWithMetaObservable exchangeTradedContractNearest0);
		VarianceReturnTerms.VarianceReturnTermsBuilder setExchangeTradedContractNearestValue(Observable exchangeTradedContractNearest1);
	...
	class VarianceReturnTermsBuilderImpl extends ReturnTermsBase.ReturnTermsBaseBuilderImpl  implements VarianceReturnTerms.VarianceReturnTermsBuilder {
		...
		@Override
		@RosettaAttribute("exchangeTradedContractNearest")
		public VarianceReturnTerms.VarianceReturnTermsBuilder setExchangeTradedContractNearest(ReferenceWithMetaObservable exchangeTradedContractNearest) {
			this.exchangeTradedContractNearest = exchangeTradedContractNearest==null?null:exchangeTradedContractNearest.toBuilder();
			return this;
		}
		@Override
		public VarianceReturnTerms.VarianceReturnTermsBuilder setExchangeTradedContractNearestValue(Observable exchangeTradedContractNearest) {
			this.getOrCreateExchangeTradedContractNearest().setValue(exchangeTradedContractNearest);
			return this;
		}
