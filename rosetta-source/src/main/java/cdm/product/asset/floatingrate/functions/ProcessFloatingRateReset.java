...
public class ProcessFloatingRateReset implements RosettaFunction {
	...
	public static abstract class ProcessFloatingRateResetMODULAR implements RosettaFunction {
		...
		*/
		...
		protected abstract MapperS<? extends FloatingRateIndex> fro(InterestRatePayout interestRatePayout, CalculationPeriodBase calcPeriod, FloatingRateIndexProcessingTypeEnum processingType);
		...
		public static class ProcessFloatingRateResetMODULARDefault extends ProcessFloatingRateResetMODULAR {
			...
			@Override
			protected MapperS<? extends FloatingRateIndex> fro(InterestRatePayout interestRatePayout, CalculationPeriodBase calcPeriod, FloatingRateIndexProcessingTypeEnum processingType) {
				return rateDef(interestRatePayout, calcPeriod, processingType).<ReferenceWithMetaFloatingRateIndex>map("getRateOption", floatingRateSpecification -> floatingRateSpecification.getRateOption()).<FloatingRateIndex>map("getValue", _f->_f.getValue());
			}
	...
	public static abstract class ProcessFloatingRateResetOVERNIGHT_AVG implements RosettaFunction {
		...
		*/
		...
		protected abstract MapperS<? extends FloatingRateIndex> rateOption(InterestRatePayout interestRatePayout, CalculationPeriodBase calcPeriod, FloatingRateIndexProcessingTypeEnum processingType);
		...
		public static class ProcessFloatingRateResetOVERNIGHT_AVGDefault extends ProcessFloatingRateResetOVERNIGHT_AVG {
			...
			@Override
			protected MapperS<? extends FloatingRateIndex> rateOption(InterestRatePayout interestRatePayout, CalculationPeriodBase calcPeriod, FloatingRateIndexProcessingTypeEnum processingType) {
				return rateDef(interestRatePayout, calcPeriod, processingType).<ReferenceWithMetaFloatingRateIndex>map("getRateOption", floatingRateSpecification -> floatingRateSpecification.getRateOption()).<FloatingRateIndex>map("getValue", _f->_f.getValue());
			}
