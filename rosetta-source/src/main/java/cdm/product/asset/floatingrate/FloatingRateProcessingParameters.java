 ...
 */
@RosettaDataType(value="FloatingRateProcessingParameters", builder=FloatingRateProcessingParameters.FloatingRateProcessingParametersBuilderImpl.class, version="6.0.0-dev.76")
