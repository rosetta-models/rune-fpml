 ...
 */
@RosettaDataType(value="FloatingAmountCalculationDetails", builder=FloatingAmountCalculationDetails.FloatingAmountCalculationDetailsBuilderImpl.class, version="6.0.0-dev.76")
