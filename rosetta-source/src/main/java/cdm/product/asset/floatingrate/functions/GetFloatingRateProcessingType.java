	...
	*/
	...
	public static class GetFloatingRateProcessingTypeDefault extends GetFloatingRateProcessingType {
		...
		protected MapperS<? extends FloatingRateIndexDefinition> floatingRateDefinition(FloatingRateSpecification rateDef) {
			return MapperS.of(floatingRateIndexMetadata.evaluate(MapperS.of(rateDef).<ReferenceWithMetaFloatingRateIndex>map("getRateOption", floatingRateSpecification -> floatingRateSpecification.getRateOption()).<FloatingRateIndex>map("getValue", _f->_f.getValue()).<InterestRateIndex>map("getInterestRateIndex", floatingRateIndex -> floatingRateIndex.getInterestRateIndex()).<FieldWithMetaFloatingRateIndexEnum>map("getFloatingRateIndex", interestRateIndex -> interestRateIndex.getFloatingRateIndex()).<FloatingRateIndexEnum>map("getValue", _f->_f.getValue()).get()));
		}
