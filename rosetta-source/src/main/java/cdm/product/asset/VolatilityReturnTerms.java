 ...
 */
@RosettaDataType(value="VolatilityReturnTerms", builder=VolatilityReturnTerms.VolatilityReturnTermsBuilderImpl.class, version="6.0.0-dev.76")
public interface VolatilityReturnTerms extends ReturnTermsBase {
	...
	class VolatilityReturnTermsBuilderImpl extends ReturnTermsBase.ReturnTermsBaseBuilderImpl  implements VolatilityReturnTerms.VolatilityReturnTermsBuilder {
		...
		@Override
		@RosettaAttribute("exchangeTradedContractNearest")
		public VolatilityReturnTerms.VolatilityReturnTermsBuilder setExchangeTradedContractNearest(ListedDerivative exchangeTradedContractNearest) {
