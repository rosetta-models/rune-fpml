 ...
 */
@RosettaDataType(value="FloatingRateSpecification", builder=FloatingRateSpecification.FloatingRateSpecificationBuilderImpl.class, version="6.0.0-dev.76")
public interface FloatingRateSpecification extends FloatingRate {
	...
	interface FloatingRateSpecificationBuilder extends FloatingRateSpecification, FloatingRate.FloatingRateBuilder {
		...
		FloatingRateSpecification.FloatingRateSpecificationBuilder setRateOption(ReferenceWithMetaFloatingRateIndex rateOption0);
		FloatingRateSpecification.FloatingRateSpecificationBuilder setRateOptionValue(FloatingRateIndex rateOption1);
	...
	class FloatingRateSpecificationBuilderImpl extends FloatingRate.FloatingRateBuilderImpl  implements FloatingRateSpecification.FloatingRateSpecificationBuilder {
		...
		public FloatingRateSpecification.FloatingRateSpecificationBuilder setRateOption(ReferenceWithMetaFloatingRateIndex rateOption) {
			this.rateOption = rateOption==null?null:rateOption.toBuilder();
			return this;
		}
		@Override
		public FloatingRateSpecification.FloatingRateSpecificationBuilder setRateOptionValue(FloatingRateIndex rateOption) {
