 ...
 */
@RosettaDataType(value="PCDeliverableObligationCharac", builder=PCDeliverableObligationCharac.PCDeliverableObligationCharacBuilderImpl.class, version="6.0.0-dev.76")
