 ...
 */
@RosettaDataType(value="Cashflow", builder=Cashflow.CashflowBuilderImpl.class, version="6.0.0-dev.76")
public interface Cashflow extends PayoutBase, GlobalKey {
	...
	/*********************** Builder Interface  ***********************/
	interface CashflowBuilder extends Cashflow, PayoutBase.PayoutBaseBuilder {
