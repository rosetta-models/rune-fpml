 ...
 */
@RosettaDataType(value="ObservationTerms", builder=ObservationTerms.ObservationTermsBuilderImpl.class, version="6.0.0-dev.76")
public interface ObservationTerms extends RosettaModelObject {
	...
	class ObservationTermsBuilderImpl implements ObservationTerms.ObservationTermsBuilder {
		...
		@Override
		@RosettaAttribute("observationTime")
		public ObservationTerms.ObservationTermsBuilder setObservationTime(BusinessCenterTime observationTime) {
			this.observationTime = observationTime==null?null:observationTime.toBuilder();
			return this;
		}
		@Override
		@RosettaAttribute("observationTimeType")
		public ObservationTerms.ObservationTermsBuilder setObservationTimeType(TimeTypeEnum observationTimeType) {
			this.observationTimeType = observationTimeType==null?null:observationTimeType;
			return this;
		}
		@Override
		@RosettaAttribute("informationSource")
