	...
	*/
	...
	public static class Qualify_EquityOption_ParameterReturnVolatility_SingleNameDefault extends Qualify_EquityOption_ParameterReturnVolatility_SingleName {
		...
		protected Boolean assignOutput(Boolean is_product, EconomicTerms economicTerms) {
			is_product = onlyExists(MapperS.of(economicTerms).<Payout>map("getPayout", _economicTerms -> _economicTerms.getPayout()), Arrays.asList("interestRatePayout", "creditDefaultPayout", "optionPayout", "commodityPayout", "settlementPayout", "fixedPricePayout", "cashflow", "performancePayout", "assetPayout"), Arrays.asList("optionPayout")).and(areEqual(MapperS.of(qualify_EquitySwap_ParameterReturnVolatility_SingleName.evaluate(underlierEconomicTerms(economicTerms).get())), MapperS.of(true), CardinalityOperator.All)).get();
