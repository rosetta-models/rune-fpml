...
@ImplementedBy(GetIMRequirement.GetIMRequirementDefault.class)
public abstract class GetIMRequirement implements RosettaFunction {
	...
	*/
	...
	public static class GetIMRequirementDefault extends GetIMRequirement {
		@Override
