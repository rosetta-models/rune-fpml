 ...
 */
@RosettaDataType(value="StandardizedSchedule", builder=StandardizedSchedule.StandardizedScheduleBuilderImpl.class, version="6.0.0-dev.76")
public interface StandardizedSchedule extends RosettaModelObject {
	...
	class StandardizedScheduleBuilderImpl implements StandardizedSchedule.StandardizedScheduleBuilder {
		...
		@Override
		@RosettaAttribute("assetClass")
		public StandardizedSchedule.StandardizedScheduleBuilder setAssetClass(StandardizedScheduleAssetClassEnum assetClass) {
			this.assetClass = assetClass==null?null:assetClass;
			return this;
		}
		@Override
		@RosettaAttribute("productClass")
		public StandardizedSchedule.StandardizedScheduleBuilder setProductClass(StandardizedScheduleProductClassEnum productClass) {
			this.productClass = productClass==null?null:productClass;
			return this;
		}
		@Override
		@RosettaAttribute("notional")
		public StandardizedSchedule.StandardizedScheduleBuilder setNotional(BigDecimal notional) {
			this.notional = notional==null?null:notional;
			return this;
		}
		@Override
		@RosettaAttribute("notionalCurrency")
		public StandardizedSchedule.StandardizedScheduleBuilder setNotionalCurrency(String notionalCurrency) {
			this.notionalCurrency = notionalCurrency==null?null:notionalCurrency;
			return this;
		}
		@Override
		@RosettaAttribute("durationInYears")
		public StandardizedSchedule.StandardizedScheduleBuilder setDurationInYears(BigDecimal durationInYears) {
			this.durationInYears = durationInYears==null?null:durationInYears;
			return this;
		}
