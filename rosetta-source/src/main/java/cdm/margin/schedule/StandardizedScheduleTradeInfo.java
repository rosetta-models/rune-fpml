 ...
 */
@RosettaDataType(value="StandardizedScheduleTradeInfo", builder=StandardizedScheduleTradeInfo.StandardizedScheduleTradeInfoBuilderImpl.class, version="6.0.0-dev.76")
public interface StandardizedScheduleTradeInfo extends RosettaModelObject {
	...
	Quantity getGrossInitialMargin();
	Quantity getMarkToMarketValue();
	...
	default void process(RosettaPath path, Processor processor) {
		...
		processRosetta(path.newSubPath("grossInitialMargin"), processor, Quantity.class, getGrossInitialMargin());
		processRosetta(path.newSubPath("markToMarketValue"), processor, Quantity.class, getMarkToMarketValue());
	}
	

	/*********************** Builder Interface  ***********************/
	interface StandardizedScheduleTradeInfoBuilder extends StandardizedScheduleTradeInfo, RosettaModelObjectBuilder {
		Quantity.QuantityBuilder getOrCreateGrossInitialMargin();
		Quantity.QuantityBuilder getGrossInitialMargin();
		Quantity.QuantityBuilder getOrCreateMarkToMarketValue();
		Quantity.QuantityBuilder getMarkToMarketValue();
		...
		StandardizedScheduleTradeInfo.StandardizedScheduleTradeInfoBuilder setGrossInitialMargin(Quantity grossInitialMargin);
		StandardizedScheduleTradeInfo.StandardizedScheduleTradeInfoBuilder setMarkToMarketValue(Quantity markToMarketValue);

		@Override
		default void process(RosettaPath path, BuilderProcessor processor) {
			processor.processBasic(path.newSubPath("assetClass"), StandardizedScheduleAssetClassEnum.class, getAssetClass(), this);
			processor.processBasic(path.newSubPath("productClass"), StandardizedScheduleProductClassEnum.class, getProductClass(), this);
			processRosetta(path.newSubPath("grossInitialMargin"), processor, Quantity.QuantityBuilder.class, getGrossInitialMargin());
			processRosetta(path.newSubPath("markToMarketValue"), processor, Quantity.QuantityBuilder.class, getMarkToMarketValue());
		}
	...
	class StandardizedScheduleTradeInfoImpl implements StandardizedScheduleTradeInfo {
		...
		private final Quantity grossInitialMargin;
		private final Quantity markToMarketValue;
		...
		public Quantity getGrossInitialMargin() {
			return grossInitialMargin;
		}
		
		@Override
		@RosettaAttribute("markToMarketValue")
		public Quantity getMarkToMarketValue() {
	...
	class StandardizedScheduleTradeInfoBuilderImpl implements StandardizedScheduleTradeInfo.StandardizedScheduleTradeInfoBuilder {
		...
		protected Quantity.QuantityBuilder grossInitialMargin;
		protected Quantity.QuantityBuilder markToMarketValue;
		...
		@Override
		@RosettaAttribute("grossInitialMargin")
		public Quantity.QuantityBuilder getGrossInitialMargin() {
			return grossInitialMargin;
		}
		
		@Override
		public Quantity.QuantityBuilder getOrCreateGrossInitialMargin() {
			Quantity.QuantityBuilder result;
			if (grossInitialMargin!=null) {
				result = grossInitialMargin;
			}
			else {
				result = grossInitialMargin = Quantity.builder();
			}
		...
		@Override
		@RosettaAttribute("markToMarketValue")
		public Quantity.QuantityBuilder getMarkToMarketValue() {
			return markToMarketValue;
		}
		
		@Override
		public Quantity.QuantityBuilder getOrCreateMarkToMarketValue() {
			Quantity.QuantityBuilder result;
			if (markToMarketValue!=null) {
				result = markToMarketValue;
			}
			else {
				result = markToMarketValue = Quantity.builder();
			}
		...
		@Override
		@RosettaAttribute("assetClass")
		public StandardizedScheduleTradeInfo.StandardizedScheduleTradeInfoBuilder setAssetClass(StandardizedScheduleAssetClassEnum assetClass) {
			this.assetClass = assetClass==null?null:assetClass;
			return this;
		}
		@Override
		@RosettaAttribute("productClass")
		public StandardizedScheduleTradeInfo.StandardizedScheduleTradeInfoBuilder setProductClass(StandardizedScheduleProductClassEnum productClass) {
			this.productClass = productClass==null?null:productClass;
			return this;
		}
		@Override
		@RosettaAttribute("grossInitialMargin")
		public StandardizedScheduleTradeInfo.StandardizedScheduleTradeInfoBuilder setGrossInitialMargin(Quantity grossInitialMargin) {
			this.grossInitialMargin = grossInitialMargin==null?null:grossInitialMargin.toBuilder();
			return this;
		}
		@Override
		@RosettaAttribute("markToMarketValue")
		public StandardizedScheduleTradeInfo.StandardizedScheduleTradeInfoBuilder setMarkToMarketValue(Quantity markToMarketValue) {
			this.markToMarketValue = markToMarketValue==null?null:markToMarketValue.toBuilder();
			return this;
		}
