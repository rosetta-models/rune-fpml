 ...
 */
@RosettaDataType(value="SecurityLocate", builder=SecurityLocate.SecurityLocateBuilderImpl.class, version="6.0.0-dev.76")
public interface SecurityLocate extends AvailableInventory {
	...
	class SecurityLocateBuilderImpl extends AvailableInventory.AvailableInventoryBuilderImpl  implements SecurityLocate.SecurityLocateBuilder {
		...
		public SecurityLocate.SecurityLocateBuilder setAvailableInventoryType(AvailableInventoryTypeEnum availableInventoryType) {
