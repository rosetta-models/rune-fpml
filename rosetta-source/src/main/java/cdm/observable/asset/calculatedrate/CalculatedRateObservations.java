 ...
 */
@RosettaDataType(value="CalculatedRateObservations", builder=CalculatedRateObservations.CalculatedRateObservationsBuilderImpl.class, version="6.0.0-dev.76")
public interface CalculatedRateObservations extends RosettaModelObject {
	...
	interface CalculatedRateObservationsBuilder extends CalculatedRateObservations, RosettaModelObjectBuilder {
		...
		CalculatedRateObservations.CalculatedRateObservationsBuilder addObservationDates(List<Date> observationDates2);
		CalculatedRateObservations.CalculatedRateObservationsBuilder setObservationDates(List<Date> observationDates3);
		...
		CalculatedRateObservations.CalculatedRateObservationsBuilder addWeights(List<BigDecimal> weights2);
		CalculatedRateObservations.CalculatedRateObservationsBuilder setWeights(List<BigDecimal> weights3);
		...
		CalculatedRateObservations.CalculatedRateObservationsBuilder addObservedRates(List<BigDecimal> observedRates2);
		CalculatedRateObservations.CalculatedRateObservationsBuilder setObservedRates(List<BigDecimal> observedRates3);
		...
		CalculatedRateObservations.CalculatedRateObservationsBuilder addProcessedRates(List<BigDecimal> processedRates2);
		CalculatedRateObservations.CalculatedRateObservationsBuilder setProcessedRates(List<BigDecimal> processedRates3);
