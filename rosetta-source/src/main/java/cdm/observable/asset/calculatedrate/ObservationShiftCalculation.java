 ...
 */
@RosettaDataType(value="ObservationShiftCalculation", builder=ObservationShiftCalculation.ObservationShiftCalculationBuilderImpl.class, version="6.0.0-dev.76")
