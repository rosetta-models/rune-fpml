 ...
 */
@RosettaDataType(value="FloatingRateCalculationParameters", builder=FloatingRateCalculationParameters.FloatingRateCalculationParametersBuilderImpl.class, version="6.0.0-dev.76")
