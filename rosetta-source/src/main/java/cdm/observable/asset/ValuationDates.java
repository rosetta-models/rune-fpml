 ...
 */
@RosettaDataType(value="ValuationDates", builder=ValuationDates.ValuationDatesBuilderImpl.class, version="6.0.0-dev.76")
public interface ValuationDates extends RosettaModelObject {
	...
	class ValuationDatesBuilderImpl implements ValuationDates.ValuationDatesBuilder {
		...
		@Override
		@RosettaAttribute("initialValuationDate")
		public ValuationDates.ValuationDatesBuilder setInitialValuationDate(PerformanceValuationDates initialValuationDate) {
			this.initialValuationDate = initialValuationDate==null?null:initialValuationDate.toBuilder();
			return this;
		}
		@Override
		@RosettaAttribute("interimValuationDate")
		public ValuationDates.ValuationDatesBuilder setInterimValuationDate(PerformanceValuationDates interimValuationDate) {
			this.interimValuationDate = interimValuationDate==null?null:interimValuationDate.toBuilder();
			return this;
		}
		@Override
		@RosettaAttribute("finalValuationDate")
		public ValuationDates.ValuationDatesBuilder setFinalValuationDate(PerformanceValuationDates finalValuationDate) {
			this.finalValuationDate = finalValuationDate==null?null:finalValuationDate.toBuilder();
			return this;
		}
