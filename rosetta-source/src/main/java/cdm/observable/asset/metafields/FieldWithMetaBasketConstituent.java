...
public interface FieldWithMetaBasketConstituent extends RosettaModelObject, FieldWithMeta<BasketConstituent>, GlobalKey {
	...
	/*********************** Builder Interface  ***********************/
	interface FieldWithMetaBasketConstituentBuilder extends FieldWithMetaBasketConstituent, RosettaModelObjectBuilder, GlobalKey.GlobalKeyBuilder, FieldWithMeta.FieldWithMetaBuilder<BasketConstituent> {
	...
	class FieldWithMetaBasketConstituentBuilderImpl implements FieldWithMetaBasketConstituent.FieldWithMetaBasketConstituentBuilder {
		...
		public FieldWithMetaBasketConstituentBuilderImpl() {
		}
		...
		@Override
		@RosettaAttribute("value")
		public FieldWithMetaBasketConstituent.FieldWithMetaBasketConstituentBuilder setValue(BasketConstituent value) {
			this.value = value==null?null:value.toBuilder();
			return this;
		}
		@Override
		@RosettaAttribute("meta")
		public FieldWithMetaBasketConstituent.FieldWithMetaBasketConstituentBuilder setMeta(MetaFields meta) {
