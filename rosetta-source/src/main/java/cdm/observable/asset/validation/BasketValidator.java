...
public class BasketValidator implements Validator<Basket> {
	...
	private List<ComparisonResult> getComparisonResults(Basket o) {
		return Lists.<ComparisonResult>newArrayList(
				...
				checkCardinality("basketConstituent", (List<? extends FieldWithMetaBasketConstituent>) o.getBasketConstituent() == null ? 0 : ((List<? extends FieldWithMetaBasketConstituent>) o.getBasketConstituent()).size(), 1, 0)
			);
	}
