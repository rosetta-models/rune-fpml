...
public abstract class IndexValueObservationMultiple implements RosettaFunction {
	...
	*/
	public List<BigDecimal> evaluate(List<Date> observationDate, FloatingRateIndex floatingRateOption) {
		List<BigDecimal> observedValues = doEvaluate(observationDate, floatingRateOption);
		
		return observedValues;
	}

	protected abstract List<BigDecimal> doEvaluate(List<Date> observationDate, FloatingRateIndex floatingRateOption);

	public static class IndexValueObservationMultipleDefault extends IndexValueObservationMultiple {
		@Override
		protected List<BigDecimal> doEvaluate(List<Date> observationDate, FloatingRateIndex floatingRateOption) {
		...
		protected List<BigDecimal> assignOutput(List<BigDecimal> observedValues, List<Date> observationDate, FloatingRateIndex floatingRateOption) {
