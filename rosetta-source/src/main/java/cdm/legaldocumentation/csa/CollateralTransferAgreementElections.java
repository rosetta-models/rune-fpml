 ...
 */
@RosettaDataType(value="CollateralTransferAgreementElections", builder=CollateralTransferAgreementElections.CollateralTransferAgreementElectionsBuilderImpl.class, version="6.0.0-dev.76")
